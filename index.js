(() => {
              ...
              function go2(bot, top2) {
                switch (top2 - bot) {
                  ...
                  default:
                    ...
                    return apply3(map19(concat2)(go2(bot, pivot)))(go2(pivot, top2));
                }
              }
  ...
  var foldM = function(dictMonad) {
    ...
    return function(f) {
      return function(z) {
        return _foldM(bind15)(f)(pure13(z));
      };
    };
  };
  ...
  var selectElement = function(query2) {
    return bind2(liftEffect3(bindFlipped5(composeKleisliFlipped2(function() {
  ...
  var splitAt2 = function(i2) {
    return function(s) {
      ...
      return {
        before,
        after: drop(length4(before))(s)
      };
    };
  };
  var drop2 = function(n) {
    return function(s) {
      return drop(length4(take2(n)(s)))(s);
    };
  };
            ...
            return function(component) {
              return function(input2) {
                return function(outputQuery) {
                  return widget(new ComponentSlot(componentSlot22(label5)(p2)(component)(input2)(function($11) {
  ...
  var runUI2 = function(component) {
    return function(i2) {
      return function(element3) {
        return bind14(liftEffect6(map17(toDocument)(bindFlipped8(document)(windowImpl))))(function(document2) {
  ...
  function _encodeURIComponent(fail, succeed, input2) {
    try {
  ...
  function _decodeURIComponent(fail, succeed, input2) {
    try {
  ...
  var foldHashes = function(cb) {
    return function(init2) {
      return function __do2() {
        ...
        var win = map18(toEventTarget)(windowImpl)();
        var listener = eventListener(function(v) {
          return bindFlipped9(flip(write)(ref2))(join3(apply2(map18(cb)(read(ref2)))(getHash)));
        })();
  ...
  var matchesWith = function(dictFoldable) {
    ...
    return function(parser) {
      return function(cb) {
        var go2 = function(a2) {
          var $21 = maybe(pure9(a2))(function(b2) {
  ...
  var handleQuery = function(v) {
    return discard5($$void8(modify5(function(state3) {
      var $37 = {};
  ...
  var renderStoryNames = function(v) {
    return function(items) {
      ...
      return ul([class_2("Storybook-nav-list")])(mapFlipped2(sortWith2(function(v1) {
        return v1.name;
      })(items))(function(item) {
        return li_([a([class_2(function() {
          var $44 = v.route === item.path;
          if ($44) {
            return linkActiveClass;
          }
          ;
          return "Storybook-link";
        }()), href4("#" + fromJust5($$encodeURIComponent(item.path)))])([text5(item.name)])]);
      }));
    };
  };
    ...
    return function(state3) {
      var nameObj = foldMapDefaultL2(function(v) {
        ...
        if (v1 instanceof Just) {
          ...
          return singleton2(v2.before)([{
            name: drop2(1)(v2.after),
            path: v
          }]);
        }
        ;
      ...
      var sorted = sortWith2(fst)(toUnfoldable3(nameObj));
      return div3([class_2("Storybook-nav")])(mapFlipped2(sorted)(function(v) {
        if (v.value0 === "") {
          return div3([class_2("Storybook-nav-section")])([renderStoryNames(state3)(v.value1)]);
        }
        ;
        return div3([class_2("Storybook-nav-section")])([div3([class_2("Storybook-nav-section-title")])([text5(v.value0)]), renderStoryNames(state3)(v.value1)]);
      }));
    };
  };
  ...
  var renderMain = function(stories2) {
    return function(state3) {
      var v = lookup(state3.route)(stories2);
      if (v instanceof Just) {
        return slot2(_child)(state3.route)(v.value0)(unit)(absurd);
      }
      ;
      return div_([h2_([text5("Hello world")]), p_([text5("This site is powered by "), a([href4("https://github.com/rnons/purescript-halogen-storybook")])([text5("halogen-storybook")]), text5(".")])]);
    };
  };
  var render = function(v) {
    return function(state3) {
      return div3([class_2("Storybook")])([a([class_2("Storybook-logo"), href4("#")])([function() {
        if (v.logo instanceof Nothing) {
          return text5("Halogen Storybook");
        }
        ;
      ...
      }()]), renderSidebar(v.stories)(state3), div3([class_2("Storybook-main")])([renderMain(v.stories)(state3)])]);
    };
  };
  ...
  var runStorybook = function(config) {
    return function(body2) {
      return bind6(runUI2(app(config))(unit)(body2))(function(app$prime) {
        return void1(liftEffect7(hashes(function(v) {
          return function(next) {
            return for_3($$decodeURIComponent(next))(function(next$prime) {
  ...
  var stories = /* @__PURE__ */ fromFoldable2(foldableArray)([]);
  var main2 = /* @__PURE__ */ function() {
    return runHalogenAff(bind(bindAff)(awaitBody)(runStorybook({
      stories,
      logo: Nothing.value
    })));
  }();
