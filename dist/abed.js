(() => {
  ...
  var applyFirst = function(dictApply) {
    ...
    var map59 = map(dictApply.Functor0());
    return function(a3) {
      return function(b2) {
        return apply12(map59($$const)(a3))(b2);
      };
    };
  };
  var applySecond = function(dictApply) {
    ...
    return function(a3) {
      return function(b2) {
        return apply12(map59($$const(identity2))(a3))(b2);
      };
    };
  };
  ...
  var composeKleisli = function(dictBind) {
    var bind117 = bind(dictBind);
    return function(f) {
      return function(g2) {
        return function(a3) {
          return bind117(f(a3))(g2);
        };
      };
    };
  };
            ...
            addRecord: function(v2) {
              return function(ra) {
                return function(rb) {
                  ...
                  var key2 = reflectSymbol2($$Proxy.value);
                  var insert11 = unsafeSet(key2);
                  var get4 = unsafeGet(key2);
                  return insert11(add1(get4(ra))(get4(rb)))(tail3);
                };
              };
            },
            mulRecord: function(v2) {
              return function(ra) {
                return function(rb) {
                  ...
                  var insert11 = unsafeSet(key2);
                  var get4 = unsafeGet(key2);
                  return insert11(mul1(get4(ra))(get4(rb)))(tail3);
                };
              };
            },
            oneRecord: function(v2) {
  ...
  var showTuple = function(dictShow) {
    ...
    return function(dictShow1) {
      ...
      return {
        show: function(v2) {
          return "(Tuple " + (show31(v2.value0) + (" " + (show114(v2.value1) + ")")));
        }
      };
    };
  };
  var semiringTuple = function(dictSemiring) {
    ...
    return function(dictSemiring1) {
      ...
      return {
        add: function(v2) {
          return function(v1) {
            return new Tuple(add6(v2.value0)(v1.value0), add1(v2.value1)(v1.value1));
          };
        },
  ...
  var ringTuple = function(dictRing) {
    ...
    return function(dictRing1) {
      ...
      return {
        sub: function(v2) {
          return function(v1) {
            return new Tuple(sub4(v2.value0)(v1.value0), sub1(v2.value1)(v1.value1));
          };
        },
        Semiring0: function() {
  ...
  var eqTuple = function(dictEq) {
    ...
    return function(dictEq1) {
      ...
      return {
        eq: function(x2) {
          return function(y2) {
            return eq25(x2.value0)(y2.value0) && eq110(x2.value1)(y2.value1);
          };
        }
      };
    };
  ...
  var surroundMap = function(dictFoldable) {
    ...
    return function(dictSemigroup) {
      ...
      return function(d2) {
        return function(t2) {
          return function(f) {
            var joined = function(a3) {
              return function(m2) {
                return append23(d2)(append23(t2(a3))(m2));
              };
            };
            return unwrap2(foldMap22(joined)(f))(d2);
          };
        };
      };
    };
  ...
  var surround = function(dictFoldable) {
    ...
    return function(dictSemigroup) {
      ...
      return function(d2) {
        return surroundMap2(d2)(identity6);
      };
    };
  };
  ...
  var Aff = function() {
    ...
    function runPar(util2, supervisor, par, cb) {
      ...
      function join7(result, head7, tail3) {
  ...
  var $$try = function(dictMonadError) {
    ...
    var map59 = map(Monad0.Bind1().Apply0().Functor0());
    var pure35 = pure(Monad0.Applicative0());
    return function(a3) {
      return catchError1(map59(Right.create)(a3))(function($52) {
  ...
  var asks = function(dictMonadAsk) {
    var map59 = map(dictMonadAsk.Monad0().Bind1().Apply0().Functor0());
              ...
              if (rm instanceof Left) {
                return bind36(v1)(function(rn) {
                  ...
                  if (rn instanceof Left) {
                    return pure35(new Left(append23(rm.value0)(rn.value0)));
                  }
                  ;
  ...
  var monadTransWriterT = function(dictMonoid) {
    ...
    return {
      lift: function(dictMonad) {
        ...
        return function(m2) {
          return bind36(m2)(function(a3) {
            return pure35(new Tuple(a3, mempty4));
          });
        };
      }
    };
  ...
  var functorWriterT = function(dictFunctor) {
    var map59 = map(dictFunctor);
    return {
      map: function(f) {
        return mapWriterT(map59(function(v2) {
              ...
              function go2(bot, top3) {
                switch (top3 - bot) {
                  case 0:
                    return pure35([]);
                  case 1:
                    return map59(array1)(f(array[bot]));
                  case 2:
                    return apply7(map59(array2)(f(array[bot])))(f(array[bot + 1]));
                  case 3:
                    return apply7(apply7(map59(array3)(f(array[bot])))(f(array[bot + 1])))(f(array[bot + 2]));
                  default:
                    var pivot = bot + Math.floor((top3 - bot) / 4) * 2;
                    return apply7(map59(concat2)(go2(bot, pivot)))(go2(pivot, top3));
                }
              }
  ...
  var traversableMaybe = {
    traverse: function(dictApplicative) {
      var pure35 = pure(dictApplicative);
      var map59 = map(dictApplicative.Apply0().Functor0());
      return function(v2) {
        return function(v1) {
          if (v1 instanceof Nothing) {
          ...
          ;
          if (v1 instanceof Just) {
            return map59(Just.create)(v2(v1.value0));
          }
          ;
    ...
    sequence: function(dictApplicative) {
      ...
      return function(v2) {
        ...
        ;
        if (v2 instanceof Just) {
          return map59(Just.create)(v2.value0);
        }
        ;
  ...
  var parTraverse_ = function(dictParallel) {
    ...
    var traverse_16 = traverse_(dictParallel.Applicative1());
    var parallel3 = parallel(dictParallel);
    return function(dictFoldable) {
      var traverse_17 = traverse_16(dictFoldable);
      return function(f) {
        var $48 = traverse_17(function($50) {
    ...
    return function(n) {
      return function(v2) {
        var step4 = function(i2) {
          ...
          ;
          return new Just(new Tuple(v2, i2 - 1 | 0));
        };
        return unfoldr12(step4)(n);
      };
    };
  };
  ...
  var spotlight = function(dictMonadAff) {
    ...
    var bind117 = bind(Bind1);
    var liftEffect11 = liftEffect(MonadEffect0);
    var Applicative0 = Monad0.Applicative0();
    var traverse_16 = traverse_(Applicative0)(foldableArray);
    var for_9 = for_(Applicative0)(foldableMaybe);
    var liftAff3 = liftAff(dictMonadAff);
    return function(selector2) {
      return discard112(log5("starting spotlight"))(function() {
        return bind117(liftEffect11(bind3(windowImpl)(document)))(function(htmlDocument) {
          return bind117(liftEffect11(querySelectorAll(selector2)(toParentNode(htmlDocument))))(function(nodeList) {
            return bind117(liftEffect11(toArray(nodeList)))(traverse_16(function(node) {
              return for_9(fromNode(node))(function(element4) {
                return discard112(log5("spotlighting " + (nodeName(node) + (" with local name " + localName(element4)))))(function() {
                  return bind117(liftEffect11(classList(element4)))(function(tokenList) {
  ...
  var nubBy = function(comp) {
    return function(xs) {
      ...
      ;
      if (v2 instanceof Just) {
        return map12(snd)(sortWith1(fst)(function __do5() {
      ...
      return function(message3) {
        return bind210(asks2(function(v2) {
          ...
          return bind210(liftEffect22(read(isRunningRef)))(function(isRunning) {
            ...
            ;
            return discard26(liftEffect22(log3("server is not running!")))(function() {
  ...
  var anyWithIndex = function(dictFoldableWithIndex) {
    ...
    return function(dictHeytingAlgebra) {
      var foldMapWithIndex2 = foldMapWithIndex1(monoidDisj(dictHeytingAlgebra));
      return function(t2) {
        var $317 = foldMapWithIndex2(function(i2) {
          var $319 = t2(i2);
          return function($320) {
            return Disj($319($320));
          };
  ...
  var traversableList = {
    traverse: function(dictApplicative) {
      ...
      var pure114 = pure(dictApplicative);
      return function(f) {
        var $301 = map126(foldl2(flip(Cons.create))(Nil.value));
  ...
  var range3 = function(start2) {
    return function(end3) {
      ...
      if (otherwise) {
          ...
          return function($copy_e) {
            return function($copy_step) {
              return function($copy_rest) {
                ...
                var $tco_done = false;
                var $tco_result;
                function $tco_loop(s2, e, step4, rest2) {
                  if (s2 === e) {
                    $tco_done = true;
                    return new Cons(s2, rest2);
                  }
                  ;
                  if (otherwise) {
                    $tco_var_s = s2 + step4 | 0;
                    $tco_var_e = e;
                    $tco_var_step = step4;
                    $copy_rest = new Cons(s2, rest2);
                    return;
                  }
                  ;
                  throw new Error("Failed pattern match at Data.List (line 148, column 3 - line 149, column 65): " + [s2.constructor.name, e.constructor.name, step4.constructor.name, rest2.constructor.name]);
                }
                ;
                while (!$tco_done) {
        ...
        return go2(end3)(start2)(function() {
          var $325 = start2 > end3;
          if ($325) {
            return 1;
          }
      ...
      ;
      throw new Error("Failed pattern match at Data.List (line 144, column 1 - line 144, column 32): " + [start2.constructor.name, end3.constructor.name]);
    };
  };
  ...
  var map13 = /* @__PURE__ */ map(functorLazy);
  ...
  var showMap = function(dictShow) {
    ...
    return function(dictShow1) {
      var show31 = show(showArray(showTuple2(dictShow1)));
      return {
        show: function(m2) {
          return "(fromFoldable " + (show31(toAscArray(m2)) + ")");
        }
      };
    };
  };
  ...
  var catMaybes = function(dictOrd) {
    return mapMaybe2(dictOrd)(identity11);
  };
  ...
  var fanout = function(dictCategory) {
    ...
    return function(dictStrong) {
      ...
      return function(l2) {
        return function(r2) {
          var split2 = dimap3(identity12)(function(a3) {
  ...
  var prism = function(to3) {
    return function(fro) {
      return function(dictChoice) {
        ...
        return function(pab) {
          return dimap3(fro)(either(identity14)(identity14))(right2(rmap3(to3)(pab)));
        };
      };
    };
  };
  ...
  var clampedBits = function(capacity) {
    return function(signal) {
      return map14(nthBit(signal))(range2(0)(toInt(capacity) - 1 | 0));
    };
  };
    ...
    map: function(v2) {
      return function(v1) {
        if (v1 instanceof Handler) {
          return new Handler(v1.value0, map17(map18(v2))(v1.value1));
        }
        ;
        if (v1 instanceof Ref) {
          return new Ref(map17(map18(v2))(v1.value0));
        }
        ;
        return v1;
      };
  ...
  var bifunctorHTML = {
    bimap: function(f) {
      return function(g2) {
        return function(v2) {
          return bimap3(map19(map110(map23(g2))))(f)(v2);
        };
      };
    }
  };
        ...
        var go2 = function($copy_v) {
          ...
          function $tco_loop(v2) {
            if (v2.value1.value0 instanceof Pure) {
              var v1 = goApply1(v2.value0)(v2.value1.value1)(pure35(v2.value1.value0.value0));
              if (v1 instanceof Left) {
                $tco_done = true;
                return v1.value0;
              }
  ...
  var substFree = function(k) {
    var go2 = function(f) {
      ...
      if (v2 instanceof Bind) {
        return bind7(k(v2.value0))(map20(go2)(v2.value1));
      }
      ;
  ...
  var query = function() {
    return function(dictIsSymbol) {
      ...
      return function(dictOrd) {
        var lookup26 = lookup112(dictOrd);
  ...
  var getRef = function(p2) {
    return liftF(new GetRef(p2, identity16));
  };
    ...
    return function(v2) {
      ...
      if (v2 instanceof Query) {
        return unCoyoneda(function(g2) {
          var $45 = map21(maybe(v2.value1(unit))(g2));
          return function($46) {
    ...
    map: function(f) {
      return unComponentSlot(function(slot4) {
        return mkComponentSlot({
          ...
          input: slot4.input,
          output: map111(map24(f))(slot4.output)
        });
      });
    }
  };
  ...
  var componentSlot = function() {
    return function(dictIsSymbol) {
      var lookup112 = lookup6(dictIsSymbol);
    ...
    return function(dictIsSymbol) {
      ...
      return function(dictOrd) {
        ...
        return function(slot4) {
          return function(label5) {
            return function(req2) {
              return query22(slot4)(label5)(req2(identity17));
            };
          };
        };
      };
  ...
  var traverse1Impl = function() {
    ...
    return function(apply7, map59, f) {
      var buildFrom = function(x2, ys) {
        return apply7(map59(consList)(f(x2)))(ys);
      };
      ...
      return function(array) {
        var acc = map59(finalCell)(f(array[array.length - 1]));
        var result = go2(acc, array.length - 1, array);
        while (result instanceof Cont) {
          result = result.fn();
        }
        return map59(listToArray)(result);
      };
    };
  }();
  ...
  var bitraversableTuple = {
    bitraverse: function(dictApplicative) {
      ...
      return function(f) {
        return function(g2) {
          return function(v2) {
            return apply7(map59(Tuple.create)(f(v2.value0)))(g2(v2.value1));
          };
        };
      };
    },
    bisequence: function(dictApplicative) {
      ...
      var map59 = map(Apply0.Functor0());
      return function(v2) {
        return apply7(map59(Tuple.create)(v2.value0))(v2.value1);
      };
    },
    Bifunctor0: function() {
    ...
    map: function(f) {
      return function(m2) {
        if (m2 instanceof Alt) {
          return new Alt(map26(map(functorRouteParser)(f))(m2.value0));
        }
        ;
        if (m2 instanceof Chomp) {
          return new Chomp(map112(map27(f))(m2.value0));
        }
        ;
    ...
    apply: function(fx) {
      return function(x2) {
        return new Chomp(function(state3) {
          ...
          ;
          if (v2 instanceof Success) {
            return map27(v2.value1)(runRouteParser(v2.value0)(x2));
          }
          ;
  ...
  var functorRouteDuplex = {
    map: function(f) {
      return function(m2) {
        return new RouteDuplex(m2.value0, map28(f)(m2.value1));
      };
    }
  };
  ...
  var product2 = function(dictGRouteDuplexCtr) {
    ...
    return function(v2) {
      return function(l2) {
        ...
        var dec = apply3(map29(Product.create)(map29(Argument)(v2.value1)))(v1.value1);
      ...
      return {
        gRouteDuplex: function(end$prime) {
          return function(r2) {
            ...
            var dec = alt5(map29(Inl.create)(v2.value1))(map29(Inr.create)(v1.value1));
            return new RouteDuplex(enc, dec);
          };
        }
      };
    ...
    return function() {
      return function(dictGRouteDuplexCtr) {
        ...
        return {
          gRouteDuplex: function(end$prime) {
            return function(r2) {
              var v2 = end$prime(gRouteDuplexCtr1(get4($$Proxy.value)(r2)));
              var enc = function(v1) {
                return v2.value0(v1);
              };
              var dec = map29(Constructor)(v2.value1);
              return new RouteDuplex(enc, dec);
            };
          }
        };
    ...
    return function(init4) {
      return function __do5() {
        ...
        var listener = eventListener(function(v2) {
          return bindFlipped5(flip(write)(ref4))(join3(apply4(map31(cb)(read(ref4)))(getHash)));
        })();
  ...
  var makeTitle = function(titleText) {
    return textarea([id2("title"), value13(titleText), readOnly3(true), cols2(fromMaybe(100)(map34(length8)(head(abedTitleText))) - 4 | 0), rows4(length5(abedTitleText))]);
  };
  ...
  var alignArray = {
    align: function(v2) {
      return function(v1) {
        return function(v22) {
          if (v22.length === 0) {
            return map115(function($104) {
              return v2(This.create($104));
            })(v1);
          }
          ;
          if (v1.length === 0) {
            return map115(function($105) {
          ...
          return append10(zipWith(f$prime)(v1)(v22))(align(alignArray)(v2)(xs$prime)(ys$prime));
        };
      };
    },
    Functor0: function() {
  ...
  var replicate3 = /* @__PURE__ */ replicate(unfoldableList);
  ...
  var printBoard = function(v2) {
    var printRowEdge = function(v1) {
      return function(v22) {
        if (v1 === 0) {
          return replicate3(3)("\u2503");
        }
    ...
    var printPort = function(dir2) {
      return function(port2) {
        var v1 = function() {
          var $117 = isInput(port2);
          if ($117) {
            return oppositeDirection(dir2);
          }
          ;
          return dir2;
        }();
        ...
        ;
        throw new Error("Failed pattern match at Game.Board (line 163, column 26 - line 167, column 28): " + [v1.constructor.name]);
      };
    };
    var printLocation = function(v1) {
      return show23(v1.x) + ("," + show23(v1.y));
    };
    var printPiece = function(ports) {
      return function(rot) {
        return function(loc) {
          var port2 = function(dir2) {
            var dir$prime = rotateDirection(dir2)(ginverse2(rot));
            return maybe(" ")(printPort(dir2))(lookup8(dir$prime)(ports));
          };
          return fromFoldable5(["   " + (port2(Up.value) + "   "), port2(Left2.value) + (" " + (printLocation(loc) + (" " + port2(Right2.value)))), "   " + (port2(Down.value) + "   ")]);
        };
      };
    };
    var printColEdge = function(v1) {
      return function(v22) {
        if (v22 === 0) {
          return power2("\u2501")(7);
        }
    ...
    var interleave = function(v1) {
      return function(v22) {
        if (v1 instanceof Cons && v22 instanceof Cons) {
          return new Cons(v1.value0, new Cons(v22.value0, interleave(v1.value1)(v22.value1)));
        }
        ;
        if (v1 instanceof Nil) {
          return v22;
        ...
        ;
        throw new Error("Failed pattern match at Game.Board (line 177, column 5 - line 177, column 55): " + [v1.constructor.name, v22.constructor.name]);
      };
    };
    var printRow = function(y2) {
      var pieces = mapFlipped4(range3(0)(v2.size - 1 | 0))(function(x2) {
        var loc = location2(x2)(y2);
        var v1 = lookup12(loc)(v2.pieces);
        if (v1 instanceof Just) {
          return printPiece(v1.value0.piece.ports)(v1.value0.rotation)(loc);
        }
        ;
        if (v1 instanceof Nothing) {
          return fromFoldable5(["       ", "  " + (printLocation(loc) + "  "), "       "]);
        }
        ;
        throw new Error("Failed pattern match at Game.Board (line 155, column 16 - line 157, column 99): " + [v1.constructor.name]);
      });
      var edges = mapFlipped4(range3(0)(v2.size))(function(x2) {
        return printRowEdge(x2)(y2);
      });
      return intercalate6("\n")(foldr5(zipWith2(append11))(replicate3(3)(""))(interleave(edges)(pieces)));
    };
    var rows5 = mapFlipped4(range3(0)(v2.size - 1 | 0))(function(x2) {
      return printRow(x2);
    });
    var colEdges = mapFlipped4(range3(0)(v2.size))(function(y2) {
      return surround2("+")(mapFlipped4(range3(0)(v2.size - 1 | 0))(function(x2) {
        return printColEdge(x2)(y2);
      }));
    });
    return "SHOW BOARD\n" + foldMap3(function(v1) {
      return v1 + "\n";
    })(interleave(colEdges)(rows5));
  };
  var showBoard = {
    show: printBoard
  };
  ...
  var renderCommand2Args = function(s_) {
    return function(ref4) {
      return function(a_2) {
        return function(b2) {
          return renderCommand(ref4)(s_) + (show8(a_2) + (", " + show8(b2)));
        };
      };
    };
  };
    ...
    return function(ref4) {
      return function(a_2) {
        return function(b2) {
          return function(c_) {
            return function(d_) {
              return renderCommand(ref4)(s_) + (show8(a_2) + (", " + (show8(b2) + (", " + (show8(c_) + (", " + show8(d_)))))));
            };
          };
        };
      };
  ...
  var printTransform = function(v2) {
    if (v2 instanceof Matrix) {
      return "matrix(" + (show9(v2.value0) + ("," + (show9(v2.value1) + ("," + (show9(v2.value2) + ("," + (show9(v2.value3) + ("," + (show9(v2.value4) + ("," + (show9(v2.value5) + ")")))))))))));
    }
    ;
    if (v2 instanceof Translate) {
      return "translate(" + (show9(v2.value0) + ("," + (show9(v2.value1) + ")")));
    }
    ;
    if (v2 instanceof Scale) {
      return "scale(" + (show9(v2.value0) + ("," + (show9(v2.value1) + ")")));
    }
    ;
    if (v2 instanceof Rotate) {
      return "rotate(" + (show9(v2.value0) + ("," + (show9(v2.value1) + ("," + (show9(v2.value2) + ")")))));
    }
    ;
    if (v2 instanceof SkewX) {
      return "skewX(" + (show9(v2.value0) + ")");
    }
    ;
    if (v2 instanceof SkewY) {
      return "skewY(" + (show9(v2.value0) + ")");
    }
    ;
  ...
  var viewBox = function(x_) {
    return function(y_) {
      return function(w) {
        return function(h_) {
          return attr2("viewBox")(joinWith(" ")(map36(show10)([x_, y_, w, h_])));
        };
      };
    };
  };
  ...
  var cy = /* @__PURE__ */ function() {
    var $139 = attr2("cy");
    return function($140) {
      return $139(show10($140));
    };
  }();
  var cx = /* @__PURE__ */ function() {
    var $141 = attr2("cx");
    return function($142) {
      return $141(show10($142));
    };
  }();
  ...
  var show14 = /* @__PURE__ */ show(showSignal);
  ...
  var map210 = /* @__PURE__ */ map(functorEmitter);
  ...
  var show24 = /* @__PURE__ */ show(/* @__PURE__ */ showMaybe(/* @__PURE__ */ showRecord2(/* @__PURE__ */ showRecordFieldsCons({
    reflectSymbol: function() {
      return "info";
    }
  })(/* @__PURE__ */ showRecordFieldsConsNil({
  ...
  var renderBits = function(info2) {
    return flip(map37)(aligned2(leds)(clampedBits(portCapacity(info2.port))(info2.signal)))(function(v2) {
  ...
  var renderDisplay = function(info2) {
    return pure11(text6([x(display.w + display.x), y(display.h + display.y), textAnchor(AnchorEnd.value)])([text5(show14(getClampedSignal(info2)))]));
  };
  var component5 = function(dictMonadEffect) {
    ...
    var render = function(state3) {
      return div3([id2("multimeter"), classes(function() {
        ...
        ;
        return ["hide"];
      }()), style("left: " + (show11(state3.currentPosition.x) + ("px; top: " + (show11(state3.currentPosition.y) + "px;"))))])([svg([viewBox(0)(0)(width9)(height9)])(map37(fromPlainHTML)(append13([renderMultimeterImage, renderRotarySwitch(map116(function($113) {
        return portCapacity(function(v2) {
          return v2.info.port;
        }($113));
      })(state3.focus))])(append13(foldMap4(renderDisplay)(map116(function(v2) {
        return v2.info;
      })(state3.focus)))(foldMap4(renderBits)(map116(function(v2) {
        return v2.info;
      })(state3.focus))))))]);
    };
    var initialState = function(v2) {
    ...
    var $$eval2 = mkEval({
      handleAction: function(v1) {
        if (v1 instanceof Initialise2) {
          return bind17(liftEffect11(globalMouseMoveEventEmitter))(function(mouseMoveEmitter) {
            return discard6($$void9(subscribe2(map210(GlobalMouseMove.create)(mouseMoveEmitter))))(function() {
              return bind17(liftEffect11(globalKeyDownEventEmitter))(function(keyDownEmitter) {
                return $$void9(subscribe2(map210(GlobalKeyDown.create)(keyDownEmitter)));
              });
            });
          });
        }
        ...
        if (v1 instanceof GlobalKeyDown) {
          return discard6(when4(key(v1.value0) === "s")(modify_4(function(s2) {
            var $100 = {};
            for (var $101 in s2) {
            ...
            return discard6(when4(key(v1.value0) === "=")(log5("increment")))(function() {
              return discard6(when4(key(v1.value0) === "-")(log5("dec")))(function() {
                return when4(elem3(key(v1.value0))(["1", "2", "3", "4"]))(bind17(gets3(function(v2) {
                  return v2.focus;
                }))(function(maybeFocus) {
      ...
      handleQuery: function(v1) {
        return discard6(modify_4(function(v2) {
          ...
          return discard6(log5(show24(v1.value0)))(function() {
  ...
  var add4 = /* @__PURE__ */ add(/* @__PURE__ */ semiringTuple(semiringNumber)(semiringNumber));
  var negate1 = /* @__PURE__ */ negate(/* @__PURE__ */ ringTuple(ringNumber)(ringNumber));
  ...
  var Q = /* @__PURE__ */ function() {
    ...
    Q2.create = function(value0) {
      return function(value1) {
        return new Q2(value0, value1);
      };
    };
    return Q2;
  }();
  var functorSimplifiedF = {
    map: function(f) {
      return function(m2) {
        if (m2 instanceof M) {
          return new M(f(m2.value0));
        }
        ;
        if (m2 instanceof L) {
          return new L(f(m2.value0));
        }
        ;
        if (m2 instanceof Q) {
          return new Q(f(m2.value0), f(m2.value1));
        }
        ;
        throw new Error("Failed pattern match at Component.Rendering.Path (line 0, column 0 - line 0, column 0): " + [m2.constructor.name]);
      };
    }
  };
  var map38 = /* @__PURE__ */ map(functorSimplifiedF);
  var translateBy = function(p2) {
    return map38(add4(p2));
  };
  var toPathCommand = function(v2) {
    if (v2 instanceof M) {
      return m(Abs.value)(v2.value0.value0)(v2.value0.value1);
    }
    ;
    if (v2 instanceof L) {
      return l(Rel.value)(v2.value0.value0)(v2.value0.value1);
    }
    ;
    if (v2 instanceof Q) {
      return q2(Rel.value)(v2.value0.value0)(v2.value0.value1)(v2.value1.value0)(v2.value1.value1);
    }
    ;
    throw new Error("Failed pattern match at Component.Rendering.Path (line 60, column 17 - line 63, column 49): " + [v2.constructor.name]);
  };
  var rotateBy = function(rotation2) {
    var v2 = function() {
      if (rotation2 === 0) {
    ...
    return map38(function(v1) {
      return new Tuple(v1.value0 * v2.value1 - v1.value1 * v2.value0, v1.value0 * v2.value0 + v1.value1 * v2.value1);
    });
  };
  var rotateByAround = function(v2) {
    return function(v1) {
      return function(v22) {
        if (v22 instanceof M) {
          return translateBy(v1)(rotateBy(v2)(translateBy(negate1(v1))(new M(v22.value0))));
        }
        ;
        return rotateBy(v2)(v22);
      };
    };
  };
  ...
  var shadeColor = function(percentage) {
    var f = function(x2) {
      return clamp2(0)(255)(div4(x2 * (100 + percentage | 0) | 0)(100));
    };
    return function(v2) {
      if (v2 instanceof RGB) {
  ...
  var createPortGradient = function(v2) {
    ...
    var capacityId = show15(toInt(portCapacity(v2.port))) + "bit";
  ...
  var stubPath = /* @__PURE__ */ function() {
    return map39(L.create)([new Tuple(0, -25), new Tuple(30, 0), new Tuple(0, 25)]);
  }();
  var arrowHeadPath = /* @__PURE__ */ function() {
    return map39(L.create)([new Tuple(0, -13), new Tuple(-10, 0), new Tuple(25, -12), new Tuple(25, 12), new Tuple(-10, 0), new Tuple(0, 13)]);
  }();
  var portPath = function(info2) {
    var rot = function() {
      var v2 = portType(info2.port);
      if (v2 instanceof Input) {
        return rotation(2);
      }
      ;
      ...
      ;
      throw new Error("Failed pattern match at Component.Rendering.Port (line 37, column 11 - line 39, column 32): " + [v2.constructor.name]);
    }();
    var simplifiedPath = map39(rotateByAround(rot)(new Tuple(25, 12.5)))(append14([new M(new Tuple(10, 25))])(function() {
      var v1 = portType(info2.port);
      if (v1 instanceof Input) {
        return arrowHeadPath;
      }
      ;
      if (v1 instanceof Output && info2.connected) {
        return stubPath;
      }
      ;
      if (v1 instanceof Output && !info2.connected) {
      ...
      ;
      throw new Error("Failed pattern match at Component.Rendering.Port (line 32, column 92 - line 35, column 44): " + [v1.constructor.name, info2.connected.constructor.name]);
    }()));
    return {
      path: map39(toPathCommand)(simplifiedPath),
  ...
  var anyWithIndex2 = /* @__PURE__ */ anyWithIndex(foldableWithIndexMap)(heytingAlgebraBoolean);
  var eq9 = /* @__PURE__ */ eq(eqCardinalDirection);
  var eq18 = /* @__PURE__ */ eq(eqPortType);
  ...
  var any3 = /* @__PURE__ */ any(foldableMaybe)(heytingAlgebraBoolean);
  ...
  var wirePiecePath = function(portStates) {
    var isInputDirection = function(dir2) {
      return anyWithIndex2(function(d2) {
        return function(info2) {
          return eq9(dir2)(d2) && eq18(portType(info2.port))(Input.value);
        };
      })(portStates);
    };
    var init4 = new M(new Tuple(35, 25));
    var dirs = fromFoldable6(keys2(portStates));
    var createPathBetweenPorts = function(from3) {
      return function(to3) {
        var rot = clockwiseRotation(Up.value)(from3);
        return pure14(rotateBy(rot)(function() {
          var v2 = clockwiseRotation(from3)(to3);
          if (v2 === 0) {
            return new L(new Tuple(-30, 0));
          }
          ;
          if (v2 === 1) {
            return new L(new Tuple(10, 10));
          }
          ;
          if (v2 === 2) {
            return new L(new Tuple(0, 50));
          }
          ;
          return new L(new Tuple(-40, 40));
        }()));
      };
    };
    var combineArrays = function(as2) {
      return function(bs) {
        var v2 = uncons(bs);
        var v1 = uncons(as2);
        if (v2 instanceof Nothing) {
        ...
        if (v1 instanceof Just && v2 instanceof Just) {
          return append15([v1.value0.head, v2.value0.head])(combineArrays(v1.value0.tail)(v2.value0.tail));
        }
        ;
        throw new Error("Failed pattern match at Component.Rendering.Wire (line 78, column 27 - line 81, column 72): " + [v1.constructor.name, v2.constructor.name]);
      };
    };
    var center = new Tuple(50, 50);
    var createPathForPort = function(dir2) {
      var rot = clockwiseRotation(Up.value)(dir2);
      var isConnected = any3(function(v2) {
        return v2.connected;
      })(lookup9(dir2)(portStates));
      var $27 = isInputDirection(dir2);
      if ($27) {
        return map40(rotateByAround(rot)(center))(append15([init4])(stubPath));
      }
      ;
      return map40(rotateByAround(rot)(center))(append15([init4])(function() {
        if (isConnected) {
          return stubPath;
        }
        ;
    ...
    var ports = map40(createPathForPort)(dirs);
    return bind18(uncons(dirs))(function(v2) {
      var betweenPorts = zipWith(createPathBetweenPorts)(dirs)(append15(v2.tail)([v2.head]));
      var path3 = map40(toPathCommand)(join4(combineArrays(ports)(betweenPorts)));
      return bind18(lookup9(Left2.value)(portStates))(function(info2) {
  ...
  var renderWire = function(portStates) {
    return fromMaybe(div_([text5("couldn't render wire")]))(bind18(wirePiecePath(portStates))(function(path3) {
      return pure15(renderPathWithEvents(path3)(new PortOnMouseEnter(Left2.value))(PortOnMouseLeave.value));
    }));
  };
  ...
  var insert7 = /* @__PURE__ */ insert(ordCardinalDirection);
  ...
  var notEq4 = /* @__PURE__ */ notEq(/* @__PURE__ */ eqSet(eqCardinalDirection));
  var pure16 = /* @__PURE__ */ pure(applicativeMaybe);
  var $$delete5 = /* @__PURE__ */ $$delete3(ordCardinalDirection);
  var fromFoldable7 = /* @__PURE__ */ fromFoldable4(foldableArray)(ordCardinalDirection);
  var wirePiece = function(wire) {
    return {
      name: wire.name,
      "eval": function(inputs) {
        var signal = fromMaybe(0)(lookup10(Left2.value)(inputs));
      ...
      ports: insert7(Left2.value)(inputPort(wire.capacity))(voidLeft4(toMap(wire.outputs))(outputPort(wire.capacity))),
      updatePort: function(dir2) {
        return function(portType2) {
          ...
          if (portType2 instanceof Just && portType2.value0 instanceof Input) {
            ...
            return discard7(guard4(notEq4(wire.outputs)(newOutputs)))(function() {
              return pure16(wirePiece({
                name: wire.name,
          ...
          if (portType2 instanceof Nothing) {
            var newOutputs = $$delete5(dir2)(wire.outputs);
            return discard7(guard4(notEq4(wire.outputs)(newOutputs)))(function() {
  ...
  var superPiece = /* @__PURE__ */ function() {
    return wirePiece({
      ...
      outputs: fromFoldable7([Up.value, Right2.value, Down.value])
    });
  }();
  var rightPiece = /* @__PURE__ */ function() {
    return wirePiece({
      name: "right-piece",
      capacity: OneBit.value,
      outputs: fromFoldable7([Down.value])
    });
  }();
  var leftPiece = /* @__PURE__ */ function() {
    return wirePiece({
      name: "left-piece",
      capacity: OneBit.value,
      outputs: fromFoldable7([Up.value])
    });
  }();
  var idPiece = /* @__PURE__ */ function() {
    return wirePiece({
      name: "id-piece",
      capacity: OneBit.value,
      outputs: fromFoldable7([Right2.value])
    });
  }();
  ...
  var fromFoldable8 = /* @__PURE__ */ fromFoldable(foldableMaybe);
  ...
  var renderDefaultPiece = function(state3) {
    ...
    var allPorts = bind19(allDirections)(function(dir2) {
      var v2 = clockwiseRotation(Up.value)(dir2);
      return pure17(g([transform([new Rotate(toNumber(v2) * 90, 50, 50), new Translate(25, 0)])])(bind19(fromFoldable8(lookup11(dir2)(state3.portStates)))(function(portInfo) {
        var path3 = portPath(portInfo);
        return pure17(renderPathWithEvents(path3)(new PortOnMouseEnter(dir2))(PortOnMouseLeave.value));
      })));
    });
    return g([])(append16(allPorts)([center]));
  };
  ...
  var component6 = function(dictMonadEffect) {
    ...
    var render = function(state3) {
      ...
      return div3([classes(["piece-component"]), draggable2(isDraggable), style("transform: rotate(" + (show16(currentRotation) + "rad);")), ref2("piece"), onDragEnd(OnDrop.create(state3.location)), onDrag(OnDrag.create), onMouseDown(OnMouseDown.create), onMouseMove(OnMouseMove.create), onMouseUp(OnMouseUp.create(state3.location))])([renderPiece(state3)]);
    };
    var initialState = function(v2) {
      return {
        piece: v2.piece,
    ...
    var $$eval2 = mkEval({
      ...
      handleAction: function(v2) {
        ...
        if (v2 instanceof OnMouseDown) {
          return bind110(getHTMLElementRef("piece"))(traverse_6(function(he) {
            return bind110(liftEffect11(map41(mul2(0.5))(clientWidth(toElement(he)))))(function(r2) {
              return bind110(liftEffect11(elementCenterClient(toElement(he))))(function(c2) {
                ...
                ;
                return discard8(liftEffect11(setDraggable(false)(he)))(function() {
                  return modify_5(function(v22) {
                    var $83 = {};
                    for (var $84 in v22) {
        ...
        if (v2 instanceof OnMouseMove) {
          return bind110(getRef("piece"))(traverse_6(function(e) {
            return bind110(gets4(function(v1) {
              return v1.isRotating;
            }))(traverse_6(function(v1) {
        ...
        if (v2 instanceof OnMouseUp) {
          return discard8(bind110(gets4(function(v1) {
            return v1.isRotating;
          }))(traverse_6(function(v1) {
        ...
        if (v2 instanceof PortOnMouseEnter) {
          return bind110(gets4(function(v1) {
            ...
            return bind110(gets4(function(v1) {
              ...
              return discard8(pure18(unit))(function() {
                return raise(new NewMultimeterFocus(function() {
                  var relativeEdge = relative(loc)(v2.value0);
                  return bind22(lookup13(v2.value0)(portStates))(function(info2) {
                    return pure23({
                      relativeEdge,
                      info: info2
                    });
  ...
  var affineTraversal$prime = function(to3) {
    return function(dictStrong) {
      ...
      return function(dictChoice) {
        ...
        return function(pab) {
          return dimap3(to3)(function(v2) {
            return either(identity21)(v2.value0)(v2.value1);
          })(second3(right2(pab)));
        };
      };
    };
  ...
  var functorZipper = {
    map: function(f) {
      return function(v2) {
        return new Zipper(map42(f)(v2.value0), f(v2.value1), map42(f)(v2.value2));
      };
    }
  };
    ...
    extend: function(f) {
      return function(zipper) {
        ...
        var lefts = unfoldr3(function(z2) {
          return map117(dup)(moveLeft(z2));
        })(zipper);
        var rights = unfoldr3(function(z2) {
          return map117(dup)(moveRight(z2));
        })(zipper);
        return new Zipper(map42(f)(lefts), f(zipper), map42(f)(rights));
      };
    },
    Functor0: function() {
  ...
  var map43 = /* @__PURE__ */ map(functorST);
  ...
  var compactableArray = {
    ...
    separate: function(xs) {
      return function __do5() {
        ...
        return apply5(map43(function(v2) {
          return function(v1) {
            return {
              left: v2,
              right: v1
    ...
    partitionMap: function(p2) {
      var go2 = function(acc) {
        return function(x2) {
          ...
          if (v2 instanceof Left) {
            return {
              left: append18(acc.left)([v2.value0]),
              right: acc.right
            };
          }
          ;
          if (v2 instanceof Right) {
            return {
              right: append18(acc.right)([v2.value0]),
              left: acc.left
            };
          }
          ;
  ...
  var eq10 = /* @__PURE__ */ eq(/* @__PURE__ */ eqMaybe(eqBoolean));
  ...
  var toRelativeEdge = function(dictMonadState) {
    var Monad0 = dictMonadState.Monad0();
    var bind117 = bind(Monad0.Bind1());
    var gets7 = gets(dictMonadState);
    var pure35 = pure(Monad0.Applicative0());
    return function(v2) {
      return bind117(gets7(view(function() {
        var $184 = ix2(v2.loc)(strongForget)(choiceForget2);
        return function($185) {
          return _pieces2($184(_rotation2($185)));
        };
      }())))(function(v1) {
        return pure35(relative(v2.loc)(rotateDirection(v2.dir)(ginverse3(v1))));
      });
    };
  };
  var toAbsoluteEdge = function(dictMonadState) {
    ...
    return function(v2) {
      return bind117(gets7(view(function() {
        var $186 = ix2(v2.loc)(strongForget)(choiceForget2);
        return function($187) {
          return _pieces2($186(_rotation2($187)));
        };
      }())))(function(v1) {
        return pure35(absolute(v2.loc)(rotateDirection(v2.dir)(v1)));
      });
    };
  };
  var isInsideBoard = function(dictMonadState) {
    ...
    var pure35 = pure(Monad0.Applicative0());
    return function(v2) {
      return bind117(use3(_size2))(function(n) {
        return pure35(0 <= v2.x && (v2.x < n && (0 <= v2.y && v2.y < n)));
      });
    };
  };
  var getPortOnEdge = function(dictMonadState) {
    ...
    var pure35 = pure(Monad0.Applicative0());
    return function(v2) {
      return bind117(use3(function() {
        var $188 = at2(v2.loc)(strongForget);
        return function($189) {
          return _pieces2($188($189));
        };
      }()))(function(maybePieceInfo) {
        return pure35(bind20(maybePieceInfo)(function(info2) {
  ...
  var getBoardEdgePseudoLocation = function(dictMonadState) {
    ...
    return function(dir2) {
      return bind117(use3(_size2))(function(n) {
        return pure35(function() {
          if (dir2 instanceof Up) {
            return location2(div5(n)(2))(-1 | 0);
          }
          ;
          if (dir2 instanceof Right2) {
            return location2(n)(div5(n)(2));
          }
          ;
          if (dir2 instanceof Down) {
            return location2(div5(n)(2))(n);
          }
          ;
          if (dir2 instanceof Left2) {
            return location2(-1 | 0)(div5(n)(2));
          }
          ;
  ...
  var getBoardRelEdge = function(dictMonadState) {
    var bind117 = bind(dictMonadState.Monad0().Bind1());
    ...
    return function(dir2) {
      return bind117(getBoardEdgePseudoLocation1(dir2))(function(loc) {
  ...
  var adjacentRelativeEdge = function(dictMonadState) {
    ...
    return function(relEdge) {
      return bind117(toAbsoluteEdge1(relEdge))(function(absEdge) {
  ...
  var connectedRelativeEdge = function(dictMonadState) {
    ...
    var pure35 = pure(Monad0.Applicative0());
    return function(relEdge) {
      return bind117(getPortOnEdge1(relEdge))(function(port2) {
        return bind117(adjacentRelativeEdge1(relEdge))(function(adjRelEdge) {
          return bind117(getPortOnEdge1(adjRelEdge))(function(adjPort) {
            var $170 = eq10(apply6(map44(portMatches)(port2))(adjPort))(new Just(true));
            if ($170) {
              return pure35(new Just(adjRelEdge));
            }
            ;
            return pure35(Nothing.value);
          });
    ...
    return function(capacity) {
      return function(vars) {
        ...
        if (vars.openSet instanceof Cons) {
          ...
          var closedSet = insert9(loc)(vars.closedSet);
          return bind117(map311(map44(function(v2) {
            return v2.piece;
          }))(use3(function() {
            var $190 = at2(loc)(strongForget);
            return function($191) {
              return _pieces2($190($191));
            };
          }())))(function(maybePiece) {
            var v2 = bind20(maybePiece)(function(v1) {
              return v1.updateCapacity(relativeEdgeDirection(vars.openSet.value0))(capacity);
            });
            if (v2 instanceof Just) {
              return bind117(allConnectedRelativeEdges1(loc))(function(connected2) {
                return discard112(modifying3(function() {
                  var $192 = ix2(loc)(strongFn)(choiceFn);
                  return function($193) {
                    return _pieces1($192($193));
                  };
                }())(function(v1) {
                  var $174 = {};
                  for (var $175 in v1) {
                  ...
                  if (v2.value0.shouldRipple) {
                    ...
                    var openSet = append19(fromFoldable9(filter6(notInClosedSet)(connected2)))(vars.openSet.value1);
            ...
            ;
            throw new Error("Failed pattern match at Game.Board.Query (line 181, column 5 - line 193, column 70): " + [v2.constructor.name]);
          });
        }
        ;
        throw new Error("Failed pattern match at Game.Board.Query (line 174, column 35 - line 193, column 70): " + [vars.openSet.constructor.name]);
      };
    };
  };
  ...
  var buildConnectionMapAt = function(dictMonadState) {
    ...
    var for_9 = for_(applicativeWriterT1)(foldableArray);
    var bind117 = bind(bindWriterT2(Monad0.Bind1()));
    ...
    var tell5 = tell(monadTellWriterT2(Monad0));
    var pure35 = pure(applicativeWriterT1);
    return function(loc) {
      return for_9(allDirections)(function(dir2) {
        var relEdge = relative(loc)(dir2);
        return bind117(connectedRelativeEdge1(relEdge))(traverse_16(function(adjRelEdge) {
          return bind117(getPortOnEdge1(relEdge))(function(port2) {
            var v2 = map44(portType)(port2);
            if (v2 instanceof Just && v2.value0 instanceof Input) {
              return tell5(singleton4(new Tuple(relEdge, adjRelEdge)));
            }
            ;
            if (v2 instanceof Just && v2.value0 instanceof Output) {
              return tell5(singleton4(new Tuple(adjRelEdge, relEdge)));
            }
            ;
            if (v2 instanceof Nothing) {
              return pure35(unit);
            ...
            ;
            throw new Error("Failed pattern match at Game.Board.Query (line 158, column 7 - line 163, column 29): " + [v2.constructor.name]);
          });
        }));
      });
    };
  ...
  var add5 = /* @__PURE__ */ add(semiringSignal);
  var one2 = /* @__PURE__ */ one(semiringSignal);
  var fromFoldable10 = /* @__PURE__ */ fromFoldable3(ordCardinalDirection)(foldableArray);
  var mkSuccPiece = function(capacity) {
    return {
      name: "succ",
      "eval": function(m2) {
        var s2 = fold5(lookup14(Left2.value)(m2));
        return singleton5(Right2.value)(function() {
          var $12 = eq11(s2)(maxValue(capacity));
          if ($12) {
            return zero3;
          }
          ;
      ...
      ports: fromFoldable10([new Tuple(Left2.value, inputPort(capacity)), new Tuple(Right2.value, outputPort(capacity))]),
  ...
  var evaluate = function(m2) {
    var go2 = function(v2) {
      ...
      if (v2 instanceof Ref2) {
        return fromMaybe(ff2)(lookup15(v2.value0)(m2));
      }
      ;
  ...
  var fromFoldable11 = /* @__PURE__ */ fromFoldable3(ordCardinalDirection)(foldableArray);
  ...
  var chickenPiece = /* @__PURE__ */ function() {
    return basicPiece({
      ...
      capacity: OneBit.value,
      complexity: space(2),
      ports: fromFoldable11([new Tuple(Left2.value, BasicInput.value), new Tuple(Right2.value, BasicInput.value), new Tuple(Up.value, new BasicOutput(ref3(Right2.value))), new Tuple(Down.value, new BasicOutput(ref3(Left2.value)))])
    });
  }();
  var cornerCutPiece = /* @__PURE__ */ function() {
    return basicPiece({
      ...
      capacity: OneBit.value,
      complexity: space(2),
      ports: fromFoldable11([new Tuple(Left2.value, BasicInput.value), new Tuple(Up.value, BasicInput.value), new Tuple(Right2.value, new BasicOutput(ref3(Up.value))), new Tuple(Down.value, new BasicOutput(ref3(Left2.value)))])
    });
  }();
  var crossPiece = /* @__PURE__ */ function() {
    return basicPiece({
      ...
      capacity: OneBit.value,
      complexity: space(2),
      ports: fromFoldable11([new Tuple(Left2.value, BasicInput.value), new Tuple(Up.value, BasicInput.value), new Tuple(Right2.value, new BasicOutput(ref3(Left2.value))), new Tuple(Down.value, new BasicOutput(ref3(Up.value)))])
    });
  }();
  var notPiece = /* @__PURE__ */ function() {
    return basicPiece({
      ...
      capacity: OneBit.value,
      complexity: space(2),
      ports: fromFoldable11([new Tuple(Left2.value, BasicInput.value), new Tuple(Right2.value, new BasicOutput(not(heytingAlgebraExpression)(ref3(Left2.value))))])
    });
  }();
  var orPiece = /* @__PURE__ */ function() {
    return basicPiece({
      ...
      capacity: OneBit.value,
      complexity: space(3),
      ports: fromFoldable11([new Tuple(Left2.value, BasicInput.value), new Tuple(Up.value, BasicInput.value), new Tuple(Right2.value, new BasicOutput(disj(heytingAlgebraExpression)(ref3(Left2.value))(ref3(Up.value))))])
    });
  }();
  var xorPiece = /* @__PURE__ */ function() {
    return basicPiece({
      ...
      capacity: OneBit.value,
      complexity: space(5),
      ports: fromFoldable11([new Tuple(Left2.value, BasicInput.value), new Tuple(Up.value, BasicInput.value), new Tuple(Right2.value, new BasicOutput(new Xor(ref3(Left2.value), ref3(Up.value))))])
    });
  }();
  var andPiece = /* @__PURE__ */ function() {
    return basicPiece({
      ...
      capacity: OneBit.value,
      complexity: space(3),
      ports: fromFoldable11([new Tuple(Left2.value, BasicInput.value), new Tuple(Up.value, BasicInput.value), new Tuple(Right2.value, new BasicOutput(conj(heytingAlgebraExpression)(ref3(Left2.value))(ref3(Up.value))))])
    });
  }();
  ...
  var fromFoldable12 = /* @__PURE__ */ fromFoldable3(ordCardinalDirection)(foldableArray);
  ...
  var notEq5 = /* @__PURE__ */ notEq(eqCapacity);
  ...
  var mkSeverPiece = function(v2) {
    return {
      name: "sever-piece",
      "eval": function(inputs) {
        var v1 = foldMap5(severSignal(v2.outputCapacity))(lookup16(Left2.value)(inputs));
        return fromFoldable12([new Tuple(Up.value, v1.value0), new Tuple(Down.value, v1.value1)]);
      },
      complexity: space(1),
      shouldRipple: false,
      updateCapacity: function(dir2) {
        return function(capacity) {
          ...
          ;
          if (dir2 instanceof Left2) {
            return bind21(halveCapacity(capacity))(function(outputCapacity$prime) {
              return discard10(guard5(notEq5(v2.outputCapacity)(outputCapacity$prime)))(function() {
                return pure20(mkSeverPiece({
          ...
          ;
          return discard10(guard5(notEq5(capacity)(v2.outputCapacity)))(function() {
            return pure20(mkSeverPiece({
      ...
      ports: fromMaybe(empty2)(bind21(doubleCapacity(v2.outputCapacity))(function(inputCapacity) {
        return pure20(fromFoldable12([new Tuple(Left2.value, inputPort(inputCapacity)), new Tuple(Up.value, outputPort(v2.outputCapacity)), new Tuple(Down.value, outputPort(v2.outputCapacity))]));
      })),
  ...
  var mkFusePiece = function(v2) {
    return {
      name: "fuse-piece",
      "eval": function(inputs) {
        var low2 = fold6(lookup16(Down.value)(inputs));
        var high2 = fold6(lookup16(Up.value)(inputs));
      ...
      updateCapacity: function(dir2) {
        return function(capacity) {
          ...
          ;
          if (dir2 instanceof Right2) {
            return bind21(halveCapacity(capacity))(function(inputCapacity$prime) {
              return discard10(guard5(notEq5(inputCapacity$prime)(v2.inputCapacity)))(function() {
                return pure20(mkFusePiece({
          ...
          ;
          return discard10(guard5(notEq5(capacity)(v2.inputCapacity)))(function() {
            return bind21(doubleCapacity(capacity))(function() {
              return pure20(mkFusePiece({
      ...
      ports: fromMaybe(empty2)(bind21(doubleCapacity(v2.inputCapacity))(function(outputCapacity) {
        return pure20(fromFoldable12([new Tuple(Up.value, inputPort(v2.inputCapacity)), new Tuple(Down.value, inputPort(v2.inputCapacity)), new Tuple(Right2.value, outputPort(outputCapacity))]));
      })),
      updatePort: function(v1) {
        return function(v22) {
          return Nothing.value;
  ...
  var twoBitCrossOver = /* @__PURE__ */ function() {
    return {
      ...
      "eval": function(m2) {
        var s2 = fold7(lookup17(Left2.value)(m2));
  ...
  var show17 = /* @__PURE__ */ show(showPieceId);
  var lookup18 = /* @__PURE__ */ lookup(ordPieceId);
  var allPieces = /* @__PURE__ */ append20(allBasicPieces)(/* @__PURE__ */ append20(allCommutativePieces)(/* @__PURE__ */ append20(allWirePieces)(allFusePieces)));
  ...
  var pieceLookup = function(pieceId) {
    var message3 = "piece lookup crash on " + (show17(pieceId) + "... WITH NO SURVIVORS");
    return fromMaybe$prime(function(v2) {
      return unsafeCrashWith(message3);
    })(lookup18(pieceId)(pieceVault));
  };

  // output/Game.Board.Operation/index.js
  var show18 = /* @__PURE__ */ show(showLocation);
  ...
  var show25 = /* @__PURE__ */ show(showRelativeEdge);
  var show32 = /* @__PURE__ */ show(/* @__PURE__ */ showMaybe(showPortType));
  ...
  var showBoardError = {
    show: function(v2) {
      if (v2 instanceof LocationOccupied) {
        return "Location Occupied: " + show18(v2.value0);
      }
      ;
      if (v2 instanceof LocationNotOccupied) {
        return "Location Not Occupied: " + show18(v2.value0);
      }
      ;
      if (v2 instanceof InvalidLocation) {
        return "Location " + (show18(v2.value0) + " is outside range of the board");
      }
      ;
      if (v2 instanceof InvalidBoardInitialisation) {
        return "Invalid Board Initialisation: " + (show19(v2.value0) + " is not a valid board size");
      }
      ;
      if (v2 instanceof BadBoardSize) {
        return "Boards of size " + (show19(v2.value0) + " are not valid");
      }
      ;
      ...
      ;
      throw new Error("Failed pattern match at Game.Board.Operation (line 50, column 10 - line 56, column 50): " + [v2.constructor.name]);
    }
  };
  ...
  var validBoardSize = function(dictMonadThrow) {
    var throwError3 = throwError(dictMonadThrow);
    var pure35 = pure(dictMonadThrow.Monad0().Applicative0());
    return function(n) {
      var $338 = even(n) || (n < 3 || n > 9);
      if ($338) {
  ...
  var updateRelEdge = function(dictMonadState) {
    ...
    return function(v2) {
      return function(portType2) {
        return bind36(use3(function() {
          var $375 = at3(v2.loc)(strongForget);
          return function($376) {
            return _pieces3($375($376));
          };
        }()))(traverse_16(function(info2) {
          return for_9(updatePort(v2.dir)(portType2)(info2.piece))(function(piece) {
            return assign4(function() {
              var $377 = ix3(v2.loc)(strongFn)(choiceFn);
              var $378 = prop6($$Proxy.value)(strongFn);
              return function($379) {
                return _pieces12($377($378($379)));
              };
            }())(piece);
          });
        }));
  ...
  var updatePortsAround = function(dictMonadState) {
    var Monad0 = dictMonadState.Monad0();
    var for_9 = for_(Monad0.Applicative0())(foldableArray);
    var bind36 = bind(Monad0.Bind1());
    ...
    return function(loc) {
      return for_9(allDirections)(function(dir2) {
        var relEdge = relative(loc)(dir2);
        return bind36(getPortOnEdge2(relEdge))(function(maybePort) {
          return bind36(adjacentRelativeEdge2(relEdge))(function(relEdge$prime) {
            return trace2("update reledge: " + (show25(relEdge$prime) + (" with adj port " + show32(map45(portType)(maybePort)))))(function(v2) {
              return updateRelEdge1(relEdge$prime)(map45(portType)(maybePort));
            });
          });
        });
      });
  ...
  var runBoardT = function(dictMonad) {
    return function(boardM) {
      return function(b2) {
        return runExceptT(runStateT(unwrap11(boardM))(b2));
      };
    };
  };
  ...
  var movePiece = function(dictMonadError) {
    ...
    var Bind1 = Monad0.Bind1();
    var bind36 = bind(Bind1);
    var discard112 = discard11(Bind1);
    var when13 = when(Monad0.Applicative0());
    ...
    return function(dictMonadState) {
      ...
      return function(src9) {
        return function(dst) {
          return bind36(use3(function() {
            var $380 = at3(src9)(strongForget);
            return function($381) {
              return _pieces3($380($381));
            };
          }()))(function(pieceInfoSrc) {
            return discard112(when13(isNothing(pieceInfoSrc))(throwError3(new LocationNotOccupied(src9))))(function() {
              return discard112(whenM3(map214(isJust)(use3(function() {
                var $382 = at3(dst)(strongForget);
                return function($383) {
                  return _pieces3($382($383));
                };
              }())))(throwError3(new LocationOccupied(dst))))(function() {
                return discard112(assign4(function() {
                  var $384 = at3(src9)(strongFn);
                  return function($385) {
                    return _pieces12($384($385));
                  };
                }())(Nothing.value))(function() {
                  return discard112(assign4(function() {
                    var $386 = at3(dst)(strongFn);
                    return function($387) {
                      return _pieces12($386($387));
                    };
                  }())(pieceInfoSrc))(function() {
                    return discard112(updatePortsAround1(src9))(function() {
                      return updatePortsAround1(dst);
                    });
                  });
                });
              });
  ...
  var increaseSize = function(dictMonadState) {
    ...
    return function(dictMonadError) {
      ...
      return bind36(get4)(function(v2) {
  ...
  var getPieceInfo = function(dictMonadState) {
    ...
    return function(dictMonadError) {
      ...
      return function(loc) {
        return bind36(use3(function() {
          var $388 = at3(loc)(strongForget);
          return function($389) {
            return _pieces3($388($389));
          };
        }()))(maybe(throwError3(new LocationNotOccupied(loc)))(pure35));
      };
    };
  };
  var getPiece = function(dictMonadState) {
    ...
    return function(dictMonadError) {
      var map214 = map(dictMonadError.MonadThrow0().Monad0().Bind1().Apply0().Functor0());
      var getPieceInfo22 = getPieceInfo1(dictMonadError);
      return function(loc) {
        return map214(function(v2) {
          return v2.piece;
        })(getPieceInfo22(loc));
      };
    };
  ...
  var evalBoardT = function(dictMonad) {
    var map214 = map(dictMonad.Bind1().Apply0().Functor0());
    var runBoardT2 = runBoardT(dictMonad);
    return function(boardM) {
      return function(b2) {
        return map214(map119(fst))(runBoardT2(boardM)(b2));
      };
    };
  };
    ...
    return function(dictMonadError) {
      ...
      return bind36(get4)(function(v2) {
        return bind36(validBoardSize1(v2.size - 2 | 0))(function(newSize) {
          ...
          var firstPieceOusideSquare = find3(function($390) {
            return !insideSquare($390);
          })(keys2(v2.pieces));
          ...
          ;
          throw new Error("Failed pattern match at Game.Board.Operation (line 212, column 3 - line 216, column 83): " + [firstPieceOusideSquare.constructor.name]);
        });
      });
    };
  };
  var checkInsideBoard = function(dictMonadError) {
    ...
    return function(dictMonadState) {
      ...
      return function(loc) {
        return whenM3(map214(not4)(isInsideBoard2(loc)))(throwError3(new InvalidLocation(loc)));
      };
    };
  };
    ...
    return function(dictMonadState) {
      ...
      return function(loc) {
        return discard112(checkInsideBoard2(loc))(function() {
          return bind36(use3(function() {
            var $391 = at3(loc)(strongForget);
            return function($392) {
              return _pieces3($391($392));
            };
          }()))(function(maybePieceInfo) {
            ...
            if (maybePieceInfo instanceof Just) {
              return discard112(assign4(function() {
                var $393 = at3(loc)(strongFn);
                return function($394) {
                  return _pieces12($393($394));
                };
              }())(Nothing.value))(function() {
                return pure35(maybePieceInfo.value0.piece);
              });
            }
            ;
            throw new Error("Failed pattern match at Game.Board.Operation (line 161, column 3 - line 165, column 27): " + [maybePieceInfo.constructor.name]);
          });
        });
      };
    };
          ...
          return discard112(checkInsideBoard2(loc))(function() {
            return bind36(getPiece1(loc))(function() {
              return discard112(appendModifying4(function() {
                var $395 = ix3(loc)(strongFn)(choiceFn);
                return function($396) {
                  return _pieces12($395(_rotation3($396)));
                };
              }())(rot))(function() {
      ...
      return function(loc) {
        return function(piece) {
          return function(rotation2) {
            return discard112(checkInsideBoard2(loc))(function() {
              return bind36(use3(function() {
                var $397 = at3(loc)(strongForget);
                return function($398) {
                  return _pieces3($397($398));
                };
              }()))(function(pieceInfo) {
                if (pieceInfo instanceof Nothing) {
                  return assign4(function() {
                    var $399 = at3(loc)(strongFn);
                    return function($400) {
                      return _pieces12($399($400));
                    };
                  }())(new Just({
                    piece,
                    rotation: rotation2
                ...
                ;
                throw new Error("Failed pattern match at Game.Board.Operation (line 148, column 3 - line 150, column 48): " + [pieceInfo.constructor.name]);
              });
            });
          };
        };
  ...
  var addPiece = function(dictMonadError) {
    var discard112 = discard11(dictMonadError.MonadThrow0().Monad0().Bind1());
  ...
  var psuedoPiece = function(port2) {
    return {
      name: function() {
        ...
        ;
        throw new Error("Failed pattern match at Game.Board.PseudoPiece (line 27, column 21 - line 29, column 37): " + [v2.constructor.name]);
      }(),
      "eval": function(v2) {
        return empty2;
      },
      ...
      ports: singleton5(Right2.value)(port2),
      updatePort: function(v2) {
        return function(v1) {
          return Nothing.value;
        };
  ...
  var foldMap6 = /* @__PURE__ */ foldMap(foldableMaybe)(monoidSignal);
  var at4 = /* @__PURE__ */ at(/* @__PURE__ */ atMap(ordRelativeEdge));
  var lookup110 = /* @__PURE__ */ lookup(ordRelativeEdge);
  var traverse3 = /* @__PURE__ */ traverse(traversableMaybe);
  var discard12 = /* @__PURE__ */ discard(discardUnit);
  var fromFoldable13 = /* @__PURE__ */ fromFoldable3(ordCardinalDirection);
  var fromFoldable14 = /* @__PURE__ */ fromFoldable13(foldableMap);
  var filter7 = /* @__PURE__ */ filter3(ordCardinalDirection);
  var join5 = /* @__PURE__ */ join(bindMaybe);
  var lookup22 = /* @__PURE__ */ lookup(ordLocation);
  var discard13 = /* @__PURE__ */ discard12(/* @__PURE__ */ bindStateT(monadIdentity));
  ...
  var fromFoldable32 = /* @__PURE__ */ fromFoldable13(foldableList);
  ...
  var fromFoldable42 = /* @__PURE__ */ fromFoldable2(foldableSet);
  ...
  var topologicalSort = function(v2) {
    return function(v1) {
      ...
      return bind23(find4(doesntAcceptOutput)(v2))(function(r2) {
  ...
  var injectInputs = function(dictMonadState) {
    var Applicative0 = dictMonadState.Monad0().Applicative0();
    var forWithIndex_2 = forWithIndex_(Applicative0)(foldableWithIndexMap);
    var when13 = when(Applicative0);
    var for_9 = for_(Applicative0)(foldableMaybe);
    var assign4 = assign2(dictMonadState);
    return function(v2) {
      return function(inputs) {
        return forWithIndex_2(v2.ports)(function(dir2) {
          return function(port2) {
            return when13(isInput(port2))(for_9(lookup19(dir2)(v2.portLocations))(function(relEdge) {
              var signal = foldMap6(clampSignal(portCapacity(port2)))(lookup19(dir2)(inputs));
              return assign4(at4(relEdge)(strongFn))(new Just({
                port: matchingPort(port2),
                connected: false,
                signal
              }));
            }));
  ...
  var injectInputs1 = /* @__PURE__ */ injectInputs(monadStateStateT2);
  var getInputOnEdge = function(dictMonadState) {
    var Monad0 = dictMonadState.Monad0();
    var Bind1 = Monad0.Bind1();
    var bind117 = bind(Bind1);
    var use3 = use(dictMonadState);
    ...
    var discard26 = discard12(Bind1);
    var assign4 = assign2(dictMonadState);
    var pure35 = pure(Applicative0);
    return function(v2) {
      return function(inRelEdge) {
        return function(capacity) {
          var v1 = lookup110(inRelEdge)(v2.connections);
          if (v1 instanceof Just) {
            return bind117(bind117(use3(at4(v1.value0)(strongForget)))(traverse12(function(info2) {
              var signal = getClampedSignal(info2);
              return discard26(assign4(at4(inRelEdge)(strongFn))(new Just({
                connected: true,
                signal,
                port: inputPort(capacity)
              })))(function() {
                return discard26(assign4(at4(v1.value0)(strongFn))(new Just({
                  connected: true,
                  signal,
                  port: outputPort(capacity)
                })))(function() {
                  return pure35(signal);
                });
              });
            })))(function(maybeSignal) {
              return pure35(fromMaybe(0)(maybeSignal));
            });
          }
          ;
          if (v1 instanceof Nothing) {
          ...
          ;
          throw new Error("Failed pattern match at Game.Board.EvaluableBoard (line 150, column 3 - line 160, column 22): " + [v1.constructor.name]);
        };
      };
    };
  };
  var extractOutputs = function(dictMonadState) {
    var Monad0 = dictMonadState.Monad0();
    var Bind1 = Monad0.Bind1();
    var map214 = map(Bind1.Apply0().Functor0());
    var Applicative0 = Monad0.Applicative0();
    ...
    var bind117 = bind(Bind1);
    var $$for2 = $$for(Applicative0)(traversableMaybe);
    var use3 = use(dictMonadState);
    var pure35 = pure(Applicative0);
    return function(v2) {
      return map214(fromFoldable14)(function() {
        var outputPorts = filter7(isOutput)(v2.ports);
        return forWithIndex2(outputPorts)(function(dir2) {
          return function(port2) {
            return bind117(map214(join5)($$for2(lookup19(dir2)(v2.portLocations))(function(relEdge) {
              return map214(map46(function(v1) {
                return v1.signal;
              }))(use3(at4(relEdge)(strongForget)));
            })))(function(maybeSignal) {
              return pure35(new Tuple(dir2, fromMaybe(0)(maybeSignal)));
            });
          };
        });
      }());
  ...
  var extractOuterPortInfo = function(dictMonadState) {
    var Monad0 = dictMonadState.Monad0();
    var Applicative0 = Monad0.Applicative0();
    var forWithIndex2 = forWithIndex(Applicative0)(traversableWithIndexMap);
    var bind117 = bind(Monad0.Bind1());
    ...
    return function(v2) {
      var defaultPortInfo = {
        connected: false,
        port: outputPort(EightBit.value),
        signal: 0
      };
      return forWithIndex2(v2.portLocations)(function(dir2) {
        return function(relEdge) {
          return bind117(use3(at4(relEdge)(strongForget)))(function(maybePortInfo) {
            return pure35(fromMaybe(defaultPortInfo)(maybePortInfo));
          });
        };
      });
    };
  };
  var evalWithPortInfoAt = function(dictMonadState) {
    var Monad0 = dictMonadState.Monad0();
    var Applicative0 = Monad0.Applicative0();
    var for_9 = for_(Applicative0)(foldableMaybe);
    var Bind1 = Monad0.Bind1();
    ...
    var map214 = map(Bind1.Apply0().Functor0());
    var forWithIndex2 = forWithIndex(Applicative0)(traversableWithIndexMap);
    var getInputOnEdge1 = getInputOnEdge(dictMonadState);
    var unless4 = unless(Applicative0);
    var forWithIndex_2 = forWithIndex_(Applicative0)(foldableWithIndexMap);
    var assign4 = assign2(dictMonadState);
    return function(v2) {
      return function(loc) {
        return for_9(lookup22(loc)(v2.pieces))(function(v1) {
          var inputPorts = filter7(isInput)(v1.ports);
          return bind117(map214(fromFoldable14)(forWithIndex2(inputPorts)(function(dir2) {
            return function(port2) {
              return map214(Tuple.create(dir2))(getInputOnEdge1(v2)(relative(loc)(dir2))(portCapacity(port2)));
            };
          })))(function(inputs) {
            return unless4(isPseudoPiece(v1))(function() {
              var outputs = v1["eval"](inputs);
              var outputPorts = filter7(isOutput)(v1.ports);
              return forWithIndex_2(outputPorts)(function(dir2) {
                return function(port2) {
                  var signal = foldMap6(clampSignal(portCapacity(port2)))(lookup19(dir2)(outputs));
  ...
  var evalWithPortInfo = function(dictMonadState) {
    var Monad0 = dictMonadState.Monad0();
    var discard26 = discard12(Monad0.Bind1());
    var injectInputs2 = injectInputs(dictMonadState);
    var traverse_16 = traverse_(Monad0.Applicative0())(foldableList);
    var evalWithPortInfoAt1 = evalWithPortInfoAt(dictMonadState);
    var extractOutputs1 = extractOutputs(dictMonadState);
    return function(v2) {
      return function(inputs) {
        return discard26(injectInputs2(v2)(inputs))(function() {
          return discard26(traverse_16(evalWithPortInfoAt1(v2))(v2.evalOrder))(function() {
            return extractOutputs1(v2);
          });
        });
      };
    };
  };
  var evalWithPortInfo1 = /* @__PURE__ */ evalWithPortInfo(monadStateStateT2);
  var evaluableBoardPiece = function(v2) {
    return {
      name: "evaluable",
      "eval": function(inputs) {
        return flip(evalState)(empty2)(discard13(injectInputs1(v2)(inputs))(function() {
          return evalWithPortInfo1(v2)(inputs);
        }));
      },
      complexity: space(0),
      shouldRipple: false,
  ...
  var buildEvaluableBoard = function(dictMonadState) {
    var getBoardEdgePseudoLocation2 = getBoardEdgePseudoLocation(dictMonadState);
    var toRelativeEdge2 = toRelativeEdge(dictMonadState);
    var adjacentRelativeEdge2 = adjacentRelativeEdge(dictMonadState);
    var getPortOnEdge2 = getPortOnEdge(dictMonadState);
    var assign4 = assign2(dictMonadState);
    var buildConnectionMap2 = buildConnectionMap(dictMonadState);
    var use3 = use(dictMonadState);
    return function(dictMonadError) {
      var MonadThrow0 = dictMonadError.MonadThrow0();
      var Monad0 = MonadThrow0.Monad0();
      ...
      var map214 = map(Bind1.Apply0().Functor0());
      var Applicative0 = Monad0.Applicative0();
      var $$for2 = $$for(Applicative0);
      var for1 = $$for2(traversableArray);
      var pure35 = pure(Applicative0);
      var for2 = $$for2(traversableList);
      var discard26 = discard12(Bind1);
      var forWithIndex_2 = forWithIndex_(Applicative0)(foldableWithIndexMap);
      var throwError3 = throwError(MonadThrow0);
      return function(maybePorts) {
        return bind117(function() {
          if (maybePorts instanceof Nothing) {
            return map214(function($231) {
              return catMaybes4(fromFoldable23($231));
            })(for1(allDirections)(function(dir2) {
              return bind117(getBoardEdgePseudoLocation2(dir2))(function(loc) {
                return bind117(bind117(toRelativeEdge2(absolute(loc)(oppositeDirection(dir2))))(adjacentRelativeEdge2))(function(relEdge) {
                  return bind117(getPortOnEdge2(relEdge))(function(maybePort) {
                    return pure35(new Tuple(dir2, maybePort));
                  });
                });
              });
            }));
          ...
          ;
          if (maybePorts instanceof Just) {
            return pure35(maybePorts.value0);
          }
          ;
          throw new Error("Failed pattern match at Game.Board.EvaluableBoard (line 70, column 5 - line 78, column 23): " + [maybePorts.constructor.name]);
        }())(function(ports) {
          return bind117(map214(fromFoldable32)(for2(toUnfoldable5(ports))(function(v2) {
            return bind117(getBoardEdgePseudoLocation2(v2.value0))(function(loc) {
              return pure35(new Tuple(v2.value0, relative(loc)(Right2.value)));
            });
          })))(function(portLocations) {
            return discard26(forWithIndex_2(ports)(function(dir2) {
              return function(port2) {
                return bind117(getBoardEdgePseudoLocation2(dir2))(function(loc) {
                  var rotation2 = clockwiseRotation(Left2.value)(dir2);
                  return assign4(function() {
                    var $232 = at1(loc)(strongFn);
                    return function($233) {
                      return _pieces4($232($233));
                    };
                  }())(new Just({
                    piece: psuedoPiece(matchingPort(port2)),
                    rotation: rotation2
                  }));
                });
              };
            }))(function() {
              return bind117(buildConnectionMap2)(function(connections) {
                return bind117(map214(map120(function(v2) {
                  return v2.piece;
                }))(use3(_pieces13)))(function(pieces) {
                  return bind117(map214(function($234) {
                    return fromFoldable42(keys2($234));
                  })(use3(_pieces13)))(function(locations) {
                    return bind117(maybe(throwError3(Cyclic.value))(pure35)(topologicalSort(locations)(connections)))(function(evalOrder) {
                      return pure35({
                        pieces,
                        connections,
                        evalOrder,
  ...
  var buildEvaluableBoard1 = /* @__PURE__ */ buildEvaluableBoard(/* @__PURE__ */ monadStateStateT(monadEither))(/* @__PURE__ */ monadErrorStateT(monadErrorEither));
  var toEvaluableBoard = function(board) {
    return evalStateT2(buildEvaluableBoard1(Nothing.value))(board);
  };
  ...
  var show33 = /* @__PURE__ */ show(showRotation);
  var eq52 = /* @__PURE__ */ eq(/* @__PURE__ */ eqSet(eqCardinalDirection));
  var fromFoldable15 = /* @__PURE__ */ fromFoldable4(foldableArray)(ordCardinalDirection);
  ...
  var discard15 = /* @__PURE__ */ discard14(bindEither);
  ...
  var overlayWires = function(dictMonadState) {
    ...
    var discard26 = discard14(bindExceptT2);
    ...
    return function(v2) {
      return function(v1) {
        ...
        if (v1 instanceof Just) {
          ...
          var isChicken = discard26(unless4(eq43(wireRotation)(extantRotation))(throwError3(new Other("not a chicken"))))(function() {
            var rot = clockwiseRotation(v2.inputDirection)(Left2.value);
            return withExceptT2(BoardError.create)(bind117(removePieceNoUpdate2(v1.value0.location))(function() {
              return addPieceNoUpdate2(v1.value0.location)(chickenPiece)(rot);
            }));
          });
          var isCornerCut = discard26(unless4(eq43(append110(wireRotation)(extantRotation))(rotation(0)))(throwError3(new Other("not a cornercut" + show33(append110(wireRotation)(extantRotation))))))(function() {
            return bind117(function() {
          ...
          var isCrossOver = discard26(unless4(eq43(wireRotation)(rotation(2)) && eq43(extantRotation)(rotation(2)))(throwError3(new Other("not a cross over"))))(function() {
            return bind117(function() {
              var v22 = clockwiseRotation(v2.inputDirection)(v1.value0.inputDirection);
              if (v22 === 1) {
                return pure114(clockwiseRotation(Left2.value)(v2.inputDirection));
          ...
          var ensureAllPortsFilled = unless4(eq52(fromFoldable15([v2.inputDirection, v2.outputDirection, v1.value0.inputDirection, v1.value0.outputDirection]))(fromFoldable15(allDirections)))(throwError3(new Other("all ports not filled")));
          return discard26(ensureAllPortsFilled)(function() {
  ...
  var getWireAt = function(dictMonadState) {
    var Monad0 = dictMonadState.Monad0();
    var bind117 = bind(bindExceptT(Monad0));
    var use3 = use(monadStateExceptT(dictMonadState));
    var applicativeExceptT2 = applicativeExceptT(Monad0);
    var $$for2 = $$for(applicativeExceptT2)(traversableMaybe);
    var pure114 = pure(applicativeExceptT2);
    var throwError3 = throwError(monadThrowExceptT(Monad0));
    return function(location4) {
      return bind117(use3(function() {
      ...
      return function(v2) {
        return function(r2) {
          return liftEither2(bind24(note(new LocationsAreNotAdjacent(v2, l2))(directionTo(v2)(l2)))(function(inputDirection) {
            return bind24(note(new LocationsAreNotAdjacent(v2, r2))(directionTo(v2)(r2)))(function(outputDirection) {
              return discard15(when5(eq19(inputDirection)(outputDirection))(new Left(new WireInputEqualsOutput(inputDirection, outputDirection))))(function() {
                return pure21({
                  inputDirection,
                  outputDirection,
                  location: v2
  ...
  var singleWirePiece = function(dictMonadState) {
    ...
    return function(l2) {
      return function(v2) {
        return function(r2) {
          return bind117(createWire1(l2)(v2)(r2))(function(wire) {
            return bind117(getWireAt1(v2))(function(maybeExtant) {
    ...
    return function(initialDir) {
      return function(path3) {
        return function(terminalDir) {
          return runExceptT(bind117(liftEither2(note(PathIsEmpty.value)(head(path3))))(function(h7) {
            return bind117(liftEither2(note(PathIsEmpty.value)(last(path3))))(function(l2) {
              var initial = followDirection(h7)(initialDir);
              var terminal = followDirection(l2)(terminalDir);
              var locations = fromFoldable16(append22([initial])(append22(path3)([terminal])));
              return foldr6(applySecond2)(pure114(unit))(map47(uncurry3(singleWirePiece1))(triples(locations)));
            });
          }));
        };
      };
  ...
  var addBoardPath = function(dictMonadState) {
    ...
    return function(initialDir) {
      return function(path3) {
        return function(terminalDir) {
          return bind117(map126(blush)(boardPathWithError1(initialDir)(path3)(terminalDir)))(function(maybePathError) {
            return discard26(when1(isNothing(maybePathError))(discard26(for_9(head(path3))(updatePortsAround2))(function() {
              return for_9(last(path3))(updatePortsAround2);
            })))(function() {
  ...
  var buildEvaluableBoard2 = /* @__PURE__ */ buildEvaluableBoard(monadStateBoardBoardT2)(monadErrorBoardErrorBoard2);
  var map121 = /* @__PURE__ */ map(functorMap);
  var pure24 = /* @__PURE__ */ pure(applicativeHalogenM);
  var monadStateStateT3 = /* @__PURE__ */ monadStateStateT(monadIdentity);
  var evalWithPortInfo2 = /* @__PURE__ */ evalWithPortInfo(monadStateStateT3);
  var extractOuterPortInfo2 = /* @__PURE__ */ extractOuterPortInfo(monadStateStateT3);
  ...
  var tell1 = /* @__PURE__ */ tell3(pieceIsSymbol)(ordLocation);
  var trace3 = /* @__PURE__ */ trace();
  var show20 = /* @__PURE__ */ show(showBoard);
  ...
  var foldMap7 = /* @__PURE__ */ foldMap(foldableEither)(monoidRotation);
  ...
  var traverse_7 = /* @__PURE__ */ traverse_(applicativeHalogenM);
  var traverse_12 = /* @__PURE__ */ traverse_7(foldableEither);
  var gets5 = /* @__PURE__ */ gets(monadStateHalogenM);
  var movePiece2 = /* @__PURE__ */ movePiece(monadErrorBoardErrorBoard2)(monadStateBoardBoardT2);
  var removePiece2 = /* @__PURE__ */ removePiece(monadErrorBoardErrorBoard2)(monadStateBoardBoardT2);
  var tell22 = /* @__PURE__ */ tell3(multimeterIsSymbol)(ordUnit);
  var capacityRipple2 = /* @__PURE__ */ capacityRipple(monadStateBoardBoardT2);
  var bind26 = /* @__PURE__ */ bind(bindMaybe);
  var lookup20 = /* @__PURE__ */ lookup(ordRelativeEdge);
  var pure25 = /* @__PURE__ */ pure(applicativeMaybe);
  var for_5 = /* @__PURE__ */ for_(applicativeHalogenM);
  var for_1 = /* @__PURE__ */ for_5(foldableMaybe);
  ...
  var not5 = /* @__PURE__ */ not(heytingAlgebraSignal);
  var show34 = /* @__PURE__ */ show(showCardinalDirection);
  var traverse_22 = /* @__PURE__ */ traverse_7(foldableMaybe);
  ...
  var for_22 = /* @__PURE__ */ for_5(foldableArray);
  ...
  var getDirectionClicked = function(me) {
    return function(bb) {
      ...
      ;
      throw new Error("Failed pattern match at Component.Board (line 431, column 29 - line 435, column 31): " + [isTopOrRight.constructor.name, isTopOrLeft.constructor.name]);
    };
  };
  var _wireLocations = function(dictWander) {
    var Strong0 = dictWander.Strong0();
    var $320 = prop7($$Proxy.value)(Strong0);
    var $321 = _Just(dictWander.Choice1());
    var $322 = prop14($$Proxy.value)(Strong0);
    return function($323) {
      return $320($321($322($323)));
    };
  };
  var _wireLocations1 = /* @__PURE__ */ _wireLocations(wanderFunction);
  ...
  var _goalPorts = /* @__PURE__ */ function() {
    return prop({
      reflectSymbol: function() {
        return "goalPorts";
      }
  ...
  var _goalPorts1 = /* @__PURE__ */ _goalPorts(strongFn);
  var _board = function(dictStrong) {
    var $324 = prop24($$Proxy.value)(dictStrong);
    var $325 = _head2(dictStrong);
    return function($326) {
      return $324($325($326));
    };
  };
  var _board1 = /* @__PURE__ */ _board(strongForget);
  var evaluateBoard = /* @__PURE__ */ bind25(/* @__PURE__ */ use2(/* @__PURE__ */ _goalPorts(strongForget)))(function(goalPorts) {
    var inputs = mapMaybe5(function(info2) {
      var $199 = isInput(info2.port);
      if ($199) {
        return new Just(info2.signal);
      }
      ;
      return Nothing.value;
    })(goalPorts);
    return bind25(map48(evalBoardM(buildEvaluableBoard2(new Just(map121(function(v2) {
      return v2.port;
    })(goalPorts)))))(use2(_board1)))(function(eitherEvaluable) {
      if (eitherEvaluable instanceof Left) {
        return pure24(unit);
      }
      ;
      if (eitherEvaluable instanceof Right) {
        var v2 = runState(evalWithPortInfo2(eitherEvaluable.value0)(inputs))(empty2);
        var goalPorts$prime = evalState(extractOuterPortInfo2(eitherEvaluable.value0))(v2.value1);
        return discard16(modify_6(function(v1) {
          var $203 = {};
          for (var $204 in v1) {
          ...
          ;
          $203.lastEvalWithPortInfo = v2.value1;
          $203.goalPorts = goalPorts$prime;
          return $203;
        }))(function() {
          return bind25(use2(function($327) {
            return _board1(_pieces6($327));
          }))(traverseWithIndex_2(function(loc) {
            return function(info2) {
              return discard16(tell1(_piece)(loc)(function(v1) {
                return new SetPiece(info2.piece);
              }))(function() {
                var portStates = toLocalInputs(loc)(v2.value1);
                return tell1(_piece)(loc)(function(v1) {
      ...
      ;
      throw new Error("Failed pattern match at Component.Board (line 461, column 3 - line 491, column 65): " + [eitherEvaluable.constructor.name]);
    });
  });
  var liftBoardM = function(boardM) {
    return map48(runBoardM(boardM))(use2(_board1));
  };
  var updateBoard = function(board) {
    return discard16(modify_6(function(s2) {
      var $209 = {};
      for (var $210 in s2) {
        if ({}.hasOwnProperty.call(s2, $210)) {
          $209[$210] = s2[$210];
        }
        ;
      }
      ;
      $209.boardHistory = append17(board)(s2.boardHistory);
      return $209;
    }))(function() {
      return bind25(use2(function($328) {
        return _board1(_pieces6($328));
      }))(function(pieces) {
        return discard16(evaluateBoard)(function() {
          return bind25(use2(_board1))(function(b2) {
            return discard16(trace3(show20(board))(function(v2) {
              return pure24(unit);
            }))(function() {
    ...
    return function(dictMonadEffect) {
      ...
      var render = function(state3) {
        ...
        var emptyPieceHTML = function(location4) {
          return text5(show110(location4));
        };
        var board = head6(state3.boardHistory);
        var n = viewOn(board)(_size3);
        var gridTemplate = "25fr repeat(" + (show26(n) + ", 100fr) 25fr");
        var renderBoardPort = function(dir2) {
          return function(portInfo) {
            ...
            var v2 = function() {
              ...
              ;
              throw new Error("Failed pattern match at Component.Board (line 230, column 23 - line 234, column 55): " + [dir2.constructor.name]);
            }();
            var viewBox2 = function() {
              var $214 = elem6(dir2)([Up.value, Down.value]);
              if ($214) {
            ...
            }), attr3(direction)(dir2), style(intercalate8("; ")(["grid-area: " + (show26(v2.value0) + (" / " + show26(v2.value1)))]))])([svg([viewBox2])([g([transform([new Rotate(toNumber(fromEnum4(dir2) + 2 | 0) * 90, 25, 12.5)])])([renderPathWithEvents(path3)(new BoardPortOnMouseEnter(dir2))(BoardPortOnMouseLeave.value)])])]);
          };
        };
        var boardPorts = bind111(toUnfoldable6(state3.goalPorts))(function(v2) {
          return pure110(renderBoardPort(v2.value0)(v2.value1));
        });
        var renderPieceSlot = function(i2) {
          return function(j) {
            var loc = location2(i2)(j);
            var eitherPieceInfo = evalBoardM(getPieceInfo2(loc))(board);
            var maybePiece = map212(function(v3) {
              return v3.piece;
            })(hush(eitherPieceInfo));
            var v2 = foldMap7(function(v1) {
              return v1.rotation;
            })(eitherPieceInfo);
            return div3([attr3(location3)(loc), class_("piece"), style(intercalate8("; ")(["transform: rotate(" + (show26(v2 * 90 | 0) + "deg)"), "grid-area: " + (show26(j + 2 | 0) + (" / " + show26(i2 + 2 | 0)))])), onMouseDown(LocationOnMouseDown.create(loc)), onMouseOver(LocationOnMouseOver.create(loc)), onMouseUp(LocationOnMouseUp.create(loc)), onDragEnter(LocationOnDragEnter.create(loc)), onDragOver(LocationOnDragOver.create(loc)), onDragLeave(LocationOnDragLeave.create), onDrop(LocationOnDrop.create(loc))])([maybe(emptyPieceHTML)(pieceHTML)(maybePiece)(loc)]);
          };
        };
        var pieces = bind111(range2(0)(n - 1 | 0))(function(i2) {
          return bind111(range2(0)(n - 1 | 0))(function(j) {
            return pure110(renderPieceSlot(i2)(j));
          });
        });
        return div3([id2("board-component"), onDragExit(BoardOnDragExit.create), style(intercalate8("; ")(["grid-template-columns: " + gridTemplate, "grid-template-rows:    " + gridTemplate]))])(append111(pieces)(append111(boardPorts)([multimeter])));
      };
      ...
      var handleAction = function(v2) {
        if (v2 instanceof Initialise4) {
          return bind25(liftEffect11(globalKeyDownEventEmitter))(function(emitter) {
            return discard16($$void11(subscribe2(map310(GlobalOnKeyDown.create)(emitter))))(function() {
              return bindFlipped7(raise)(map48(NewBoardState.create)(use2(_board1)));
            });
          });
        }
        ;
        if (v2 instanceof PieceOutput && v2.value0 instanceof Rotated) {
          return bind25(liftBoardM(rotatePieceBy2(v2.value0.value0)(v2.value0.value1)))(traverse_12(function(v1) {
            return discard16(updateStore2(new BoardEvent(new RotatedPiece(v2.value0.value0, v2.value0.value1))))(function() {
        ...
        if (v2 instanceof PieceOutput && v2.value0 instanceof Dropped) {
          return bind25(gets5(function(v1) {
            ...
            if (maybeDst instanceof Just) {
              return bind25(liftBoardM(movePiece2(v2.value0.value0)(maybeDst.value0)))(traverse_12(function(v1) {
                return discard16(updateStore2(new BoardEvent(new MovedPiece(v2.value0.value0, maybeDst.value0))))(function() {
                  return updateBoard(v1.value1);
                });
              }));
            }
            ...
            if (maybeDst instanceof Nothing) {
              return bind25(liftBoardM(removePiece2(v2.value0.value0)))(traverse_12(function(v1) {
                return discard16(updateStore2(new BoardEvent(new RemovedPiece(v2.value0.value0, name15(v1.value0)))))(function() {
                  return updateBoard(v1.value1);
                });
              }));
            }
            ;
            throw new Error("Failed pattern match at Component.Board (line 312, column 7 - line 322, column 30): " + [maybeDst.constructor.name]);
          });
        }
        ;
        ...
        if (v2 instanceof MultimeterOutput) {
          return bind25(liftBoardM(capacityRipple2(v2.value0.value0)(v2.value0.value1)))(traverse_12(function(v1) {
            return discard16(updateBoard(v1.value1))(function() {
              return bind25(gets5(function(v22) {
                return v22.lastEvalWithPortInfo;
              }))(function(signals) {
                var focus3 = bind26(lookup20(v2.value0.value0)(signals))(function(info2) {
                  return pure25({
                    info: info2,
                    relativeEdge: v2.value0.value0
                  });
                });
                return tell22(_multimeter)(unit)(function(v22) {
        ...
        if (v2 instanceof Undo) {
          return bind25(map48(moveLeft)(gets5(function(v1) {
            return v1.boardHistory;
          })))(function(maybeZipper) {
            return for_1(maybeZipper)(function(t2) {
              return discard16(modify_6(function(v1) {
                var $246 = {};
                for (var $247 in v1) {
                ...
                return discard16(updateStore2(new BoardEvent(UndoBoardEvent.value)))(function() {
        ...
        if (v2 instanceof Redo) {
          return bind25(map48(moveRight)(gets5(function(v1) {
            return v1.boardHistory;
          })))(function(maybeZipper) {
            return for_1(maybeZipper)(function(t2) {
              return discard16(modify_6(function(v1) {
        ...
        if (v2 instanceof ToggleInput) {
          return discard16(modifying2(function() {
            var $329 = ix4(v2.value0)(strongFn)(choiceFn);
            var $330 = prop33($$Proxy.value)(strongFn);
            return function($331) {
              return _goalPorts1($329($330($331)));
            };
          }())(not5))(function() {
            return bind25(evaluateBoard)(function() {
              return pure24(unit);
            });
          });
        }
        ...
        if (v2 instanceof BoardOnDragExit) {
          return discard16(modify_6(function(v1) {
            var $253 = {};
            for (var $254 in v1) {
              if ({}.hasOwnProperty.call(v1, $254)) {
                $253[$254] = v1[$254];
              }
              ;
            }
            ;
            $253.isCreatingWire = Nothing.value;
            return $253;
          }))(function() {
        ...
        if (v2 instanceof LocationOnMouseDown) {
          return for_1(target5(toEvent(v2.value1)))(function(eventTarget) {
            return for_1(fromEventTarget(eventTarget))(function(element4) {
              return bind25(liftEffect11(getBoundingClientRect(element4)))(function(bb) {
                var initialDirection = getDirectionClicked(v2.value1)(bb);
                return discard16(log5(show34(initialDirection)))(function() {
        ...
        if (v2 instanceof LocationOnMouseOver) {
          return bind25(gets5(function(v1) {
            ...
            return when6(notEq7(last(creatingWire.locations))(new Just(v2.value0)))(discard16(log5("modifying state of board"))(function() {
              return appendModifying2(_wireLocations1)([v2.value0]);
            }));
          }));
        }
        ;
        if (v2 instanceof LocationOnMouseUp) {
          return bind25(gets5(function(v1) {
            return v1.isCreatingWire;
          }))(function(isCreatingWire) {
            return for_1(isCreatingWire)(function(creatingWire) {
              return for_1(target5(toEvent(v2.value1)))(function(eventTarget) {
                return for_1(fromEventTarget(eventTarget))(function(element4) {
                  return bind25(liftEffect11(getBoundingClientRect(element4)))(function(bb) {
                    var terminalDirection = getDirectionClicked(v2.value1)(bb);
                    return bind25(map48(runState(addBoardPath2(creatingWire.initialDirection)(creatingWire.locations)(terminalDirection)))(use2(_board1)))(function(v1) {
                      return discard16(when6(v1.value0)(updateBoard(v1.value1)))(function() {
                        return modify_6(function(s2) {
                          var $265 = {};
                          for (var $266 in s2) {
                            if ({}.hasOwnProperty.call(s2, $266)) {
                              $265[$266] = s2[$266];
                            }
                            ;
                          }
                          ;
                          $265.isCreatingWire = Nothing.value;
                          return $265;
                        });
                      });
                    });
        ...
        if (v2 instanceof LocationOnDragEnter) {
          return discard16(liftEffect11(preventDefault(toEvent2(v2.value1))))(function() {
            return modify_6(function(v1) {
              var $272 = {};
              for (var $273 in v1) {
              ...
              ;
              $272.mouseOverLocation = new Just(v2.value0);
              return $272;
            });
          });
        }
        ...
        if (v2 instanceof LocationOnDrop) {
          return discard16(modify_6(function(v1) {
            var $279 = {};
            for (var $280 in v1) {
              if ({}.hasOwnProperty.call(v1, $280)) {
                $279[$280] = v1[$280];
              }
              ;
            }
            ;
            $279.mouseOverLocation = new Just(v2.value0);
            return $279;
          }))(function() {
            return liftEffect11(preventDefault(toEvent2(v2.value1)));
          });
        ...
        if (v2 instanceof LocationOnDragLeave) {
          return modify_6(function(v1) {
            ...
            ;
            $284.mouseOverLocation = Nothing.value;
            return $284;
          });
        }
        ;
        if (v2 instanceof GlobalOnKeyDown) {
          return discard16(when6(key(v2.value0) === "z" && ctrlKey(v2.value0))(handleAction(Undo.value)))(function() {
            return when6(key(v2.value0) === "y" && ctrlKey(v2.value0))(handleAction(Redo.value));
          });
        }
        ;
        if (v2 instanceof BoardPortOnMouseEnter) {
          return bind25(map48(evalState(getBoardRelEdge2(v2.value0)))(use2(_board1)))(function(relativeEdge) {
            return bind25(gets5(function(v1) {
              return v1.lastEvalWithPortInfo;
            }))(function(signals) {
              var focus3 = map212(function(v1) {
                return {
                  info: v1,
                  relativeEdge
                };
        ...
        ;
        throw new Error("Failed pattern match at Component.Board (line 300, column 18 - line 427, column 27): " + [v2.constructor.name]);
      };
      var $$eval2 = mkEval({
        finalize: Nothing.value,
        handleAction,
        handleQuery: function(v2) {
          if (v2 instanceof GetBoard) {
            return bind25(use2(_board1))(function(board) {
              return pure24(new Just(v2.value0(board)));
            });
          }
          ;
          if (v2 instanceof AddPiece) {
            return discard16(bind25(liftBoardM(addPiece2(v2.value0)(v2.value1)))(traverse_12(function(v1) {
              return bind25(updateBoard(v1.value1))(function() {
                return updateStore2(new BoardEvent(new AddedPiece(v2.value0, name15(v2.value1))));
              });
            })))(function() {
          ...
          if (v2 instanceof RemovePiece) {
            return discard16(bind25(liftBoardM(removePiece2(v2.value0)))(traverse_12(function(v1) {
              return bind25(updateBoard(v1.value1))(function() {
          ...
          if (v2 instanceof GetMouseOverLocation) {
            return bind25(gets5(function(v1) {
              ...
              return pure24(map212(v2.value0)(maybeDst));
            });
          }
          ;
          if (v2 instanceof SetInputs) {
            return discard16(for_22(toUnfoldable6(v2.value0))(function(v1) {
              return assign3(function() {
                var $332 = ix4(v1.value0)(strongFn)(choiceFn);
                var $333 = prop33($$Proxy.value)(strongFn);
                return function($334) {
                  return _goalPorts1($332($333($334)));
                };
              }())(v1.value1);
            }))(function() {
              return bind25(evaluateBoard)(function() {
                return bind25(map48(mapMaybe5(function(info2) {
                  var $305 = !isInput(info2.port);
                  if ($305) {
                    return new Just(info2.signal);
                  }
                  ;
                  ...
                  return pure24(Just.create(v2.value1(outputs)));
                });
              });
            });
          }
          ...
          if (v2 instanceof SetGoalPorts) {
            return discard16(for_22(toUnfoldable6(v2.value0))(function(v1) {
              return assign3(function() {
                var $335 = at6(v1.value0)(strongFn);
                return function($336) {
                  return _goalPorts1($335($336));
                };
              }())(new Just({
                port: v1.value1,
                signal: 0,
          ...
          if (v2 instanceof IncrementBoardSize) {
            return discard16(bind25(liftBoardM(increaseSize2))(traverse_12(function(v1) {
              return bind25(updateBoard(v1.value1))(function() {
                return updateStore2(new BoardEvent(IncrementSize.value));
              });
            })))(function() {
              return pure24(Nothing.value);
            });
          ...
          if (v2 instanceof DecrementBoardSize) {
            return discard16(bind25(liftBoardM(decreaseSize2))(traverse_12(function(v1) {
              return bind25(updateBoard(v1.value1))(function() {
                return updateStore2(new BoardEvent(DecrementSize.value));
              });
            })))(function() {
              return pure24(Nothing.value);
            });
          ...
          ;
          throw new Error("Failed pattern match at Component.Board (line 254, column 20 - line 293, column 23): " + [v2.constructor.name]);
        },
  ...
  var nowTime = /* @__PURE__ */ map49(function($2) {
  ...
  var component8 = function(dictMonadAsk) {
    ...
    return function(dictMonadAff) {
      ...
      var showTime2 = function(time4) {
        var pad2 = function(dictBoundedEnum) {
          ...
          return function(n) {
            ...
            return power3("0")(2 - length8(s2) | 0) + s2;
          };
        };
        return intercalate9(":")([pad2(boundedEnumHour)(hour(time4)), pad2(boundedEnumMinute)(minute(time4)), pad2(boundedEnumSecond)(second2(time4))]);
      };
      ...
      var render = function(state3) {
        return div3([id2("chat-component"), ref2("chat-component"), onScroll(OnScroll.create)])([table_(map50(renderMessage)(state3.messages)), div3([id2("anchor")])([text5(show111(state3.scrollToBottom))])]);
      };
      var initialState = function(v2) {
        return {
          messages: [],
      ...
      var handleAction = function(v2) {
        if (v2 instanceof Initialise5) {
          return bind27(asks2(function(v1) {
            ...
            return discard17($$void12(subscribe2(map122(NewMessage.create)(messageEmitter))))(function() {
              return bind27(getHTMLElementRef("chat-component"))(traverse_8(function(element4) {
        ...
        if (v2 instanceof NewMessage) {
          return bind27(liftEffect11(nowTime))(function(timestamp) {
  ...
  var for_6 = /* @__PURE__ */ for_(applicativeEither)(foldableArray);
  ...
  var discard18 = /* @__PURE__ */ discard(discardUnit)(bindEither);
  ...
  var runSingleTest = function(dictMonad) {
    var bind117 = bind(dictMonad.Bind1());
    var pure35 = pure(dictMonad.Applicative0());
    return function(piece) {
      return function(inputs) {
        return function(testEval) {
          var expected = $$eval(piece)(inputs);
          return bind117(testEval(inputs))(function(recieved) {
            var $45 = eq44(expected)(recieved);
            if ($45) {
              return pure35(new Right(unit));
            }
            ;
            return pure35(new Left({
              inputs,
              expected,
              recieved
            }));
  ...
  var checkPortMismatch = function(problem) {
    return function(evaluable) {
      return for_6(allDirections)(function(dir2) {
  ...
  var checkOtherRestrictions = function(problem) {
    return function(board) {
      return for_6(problem.otherRestrictions)(function(r2) {
  ...
  var isReadyForTesting = function(problem) {
    return function(board) {
      return fromLeft(ReadyForTesting.value)(bind28(checkEvaluable(board))(function(evaluable) {
        return discard18(lmap3(PortMismatch.create)(checkPortMismatch(problem)(evaluableBoardPiece(evaluable))))(function() {
  ...
  var map51 = /* @__PURE__ */ map(functorComponentSlot);
  var mapActionOverHTML = function(f) {
    return bimap5(map51(f))(f);
  };

  // output/Component.Sidebar/index.js
  var member5 = /* @__PURE__ */ member(ordPieceId);
  var map52 = /* @__PURE__ */ map(functorList);
  var eq20 = /* @__PURE__ */ eq(eqPortType);
  var show27 = /* @__PURE__ */ show(showInt);
  var show112 = /* @__PURE__ */ show(showBoardError);
  var show28 = /* @__PURE__ */ show(showCardinalDirection);
  ...
  var renderCompletionStatus = /* @__PURE__ */ function() {
    var renderMaybePort = function(v2) {
      ...
      if (v2 instanceof Just) {
        return "an " + function() {
          var $64 = eq20(v2.value0.portType)(Input.value);
          if ($64) {
            return "input";
          }
          ;
          return "output" + (" of capacity " + show27(toInt(v2.value0.capacity)));
        }();
      }
      ;
    ...
    return function(v2) {
      ...
      if (v2 instanceof PortMismatch) {
        return div_([b_([text5("Port mismatch:")]), text5("Expected " + (renderMaybePort(v2.value0.expected) + (" on the " + (show28(v2.value0.dir) + (", but found " + renderMaybePort(v2.value0.received))))))]);
      }
      ;
    ...
    var render = function(state3) {
      var renderAvailablePiece = function(piece) {
        ...
        return div3([attr3(availablePiece)(piece), draggable2(true), classes(["available-piece"]), onDragEnd(PieceOnDrop.create(pieceId)), onClick(PieceOnClick.create(pieceId))])([mapActionOverHTML(function(v2) {
          return DoNothing2.value;
        })(renderPiece(defaultState(piece))), text5(show35(pieceId))]);
      };
      ...
      })])([text5("-")]), text5(show27(state3.boardSize)), button([onClick(function(v2) {
    ...
    var $$eval2 = mkEval({
      ...
      handleAction: function(v2) {
        if (v2 instanceof PieceOnDrop) {
          return discard19(log5("piece dropped!"))(function() {
      ...
      handleQuery: function(v2) {
        if (v2 instanceof SetCompletionStatus) {
          return discard19(modify_7(function(v1) {
            var $82 = {};
            for (var $83 in v1) {
  ...
  var showPlainHTML = /* @__PURE__ */ function() {
    var showVDom = function(v2) {
      ...
      ;
      if (v2 instanceof Elem) {
        return intercalate10(" ")(map53(showVDom)(v2.value3));
      }
      ;
      if (v2 instanceof Keyed) {
        return intercalate10(" ")(map53(function($55) {
  ...
  var _delayBy = function(dictStrong) {
    ...
    var $64 = prop25($$Proxy.value)(dictStrong);
    return function($65) {
      return $63($64($65));
    };
  };
  ...
  var eq21 = /* @__PURE__ */ eq(/* @__PURE__ */ eqMaybe(eqSignal));
  ...
  var show36 = /* @__PURE__ */ show(/* @__PURE__ */ showMap(showCardinalDirection)(showSignal));
  ...
  var tell12 = /* @__PURE__ */ tell4(boardIsSymbol)(ordUnit);
  var bind29 = /* @__PURE__ */ bind(bindHalogenM);
  var gets6 = /* @__PURE__ */ gets(monadStateHalogenM);
  var discard110 = /* @__PURE__ */ discard20(bindHalogenM);
  var tell23 = /* @__PURE__ */ tell4(sidebarIsSymbol)(ordUnit);
  ...
  var fromFoldable17 = /* @__PURE__ */ fromFoldable2(foldableArray);
  ...
  var renderTestSuccess = function(i2) {
    return function(n) {
      return span_([green(show29(i2) + ("/" + show29(n))), text5(" Sucessful")]);
    };
  };
  var renderTestError = function(v2) {
    return function(i2) {
      return function(n) {
        ...
        var printReceivedOutputs = span_(intersperse(text5(", "))(mapFlipped6(toUnfoldable7(v2.recieved))(function(tuple) {
          var $109 = eq21(lookup21(fst(tuple))(v2.expected))(new Just(snd(tuple)));
          if ($109) {
        ...
        var printPorts = function(m2) {
          return text5(intercalate11(", ")(map54(showTuple2)(toUnfoldable7(m2))));
        };
        return div_([div_([red(show29(i2) + ("/" + show29(n))), text5(" Failed:")]), div_([text5("  - inputs: "), printPorts(v2.inputs)]), div_([text5("  - expected outputs: "), printPorts(v2.expected)]), div_([text5("  - recieved outputs: "), printReceivedOutputs])]);
      };
    };
  };
          ...
          return function(testEval) {
            ...
            var runTestsAcc = function(i2) {
              return function(v2) {
                ...
                ;
                if (v2 instanceof Cons) {
                  return discard26(log5(show36(v2.value0)))(function() {
                    return bind117(runSingleTest2(piece)(v2.value0)(testEval))(function(result) {
                      return discard26(liftAff3(delay(delayDuration)))(function() {
                        if (result instanceof Left) {
                          return discard26(sendMessage2(htmlMessage("/test")(renderTestError(result.value0)(i2)(n))))(function() {
                            return pure114(new Left(result.value0));
                          });
                        }
                        ;
                        if (result instanceof Right) {
                          return discard26(sendMessage2(htmlMessage("/test")(renderTestSuccess(i2)(n))))(function() {
    ...
    return function(dictMonadAsk) {
      ...
      return function(dictMonadStore) {
        ...
        var render = function(v2) {
          return div3([id2("puzzle-component")])([slot12(_board2)(unit)(component32)(Nothing.value)(BoardOutput.create), slot_3(_chat)(unit)(component22)(unit), slot23(_sidebar)(unit)(component1)({
        ...
        var addPieceToComponent = function(pieceId) {
          return function(loc) {
            return tell12(_board2)(unit)(function(v2) {
        ...
        var handleAction = function(v2) {
            ...
            return bind29(gets6(function(v1) {
              ...
              return discard110(putQueuedMessages2(initialConversation))(function() {
                return bind29(gets6(function(v1) {
                  ...
                  return tell12(_board2)(unit)(function(v22) {
          ...
          if (v2 instanceof SidebarOutput && v2.value0 instanceof PieceDropped) {
            return bind29(request2(_board2)(unit)(GetMouseOverLocation.create))(function(maybeLocation) {
              return for_7(maybeLocation)(addPieceToComponent(v2.value0.value0));
            });
          }
          ;
          if (v2 instanceof SidebarOutput && v2.value0 instanceof PieceAdded) {
            return bind29(request2(_board2)(unit)(GetBoard.create))(traverse_9(function(board) {
              return for_7(firstEmptyLocation(board))(addPieceToComponent(v2.value0.value0));
            }));
          }
          ;
          if (v2 instanceof SidebarOutput && v2.value0 instanceof BoardSizeIncremented) {
            return $$void13(request2(_board2)(unit)(IncrementBoardSize.create));
          }
          ;
          if (v2 instanceof SidebarOutput && v2.value0 instanceof BoardSizeDecremented) {
            return $$void13(request2(_board2)(unit)(DecrementBoardSize.create));
          }
          ;
          if (v2 instanceof SidebarOutput && v2.value0 instanceof TestsTriggered) {
            return discard110(sendMessage2(htmlMessage("/test")(b_([text5("Verifying board: running tests...")]))))(function() {
              var eval1 = function(inputs) {
                return map124(fromMaybe(empty2))(request2(_board2)(unit)(SetInputs.create(inputs)));
              };
              return bind29(gets6(function(v1) {
                return v1.level.problem;
              }))(function(problem) {
                return bind29(runAllTests2(problem.goal)(fromFoldable17(problem.testCases))(eval1))(function(res) {
  ...
  var binaryTestInputs = function(directions) {
    return bind30(traverse4(function(v2) {
      ...
      return pure29(fromFoldable18(zip(directions)(inputs)));
    });
  };
  ...
  var getAllLevelProgress = function(dictMonadEffect) {
    var Monad0 = dictMonadEffect.Monad0();
    var map59 = map(Monad0.Bind1().Apply0().Functor0());
    var $$for2 = $$for(Monad0.Applicative0())(traversableArray);
    var getLevelProgress2 = getLevelProgress(dictMonadEffect);
    return map59(function($37) {
      return catMaybes5(fromFoldable19(join6($37)));
    })($$for2(toUnfoldable8(allLevels))(function(v2) {
      return $$for2(toUnfoldable8(v2.value1))(function(v1) {
        return map59(Tuple.create({
          suiteName: v2.value0,
          levelName: v1.value0
        }))(getLevelProgress2({
          suiteName: v2.value0,
  ...
  var show30 = /* @__PURE__ */ show(/* @__PURE__ */ showMap(/* @__PURE__ */ showRecord()()(/* @__PURE__ */ showRecordFieldsCons(levelNameIsSymbol)(/* @__PURE__ */ showRecordFieldsConsNil(suiteNameIsSymbol)(showString))(showString)))(showLevelProgress));
  ...
  var component11 = function(dictMonadAff) {
    ...
    var render = function(state3) {
      ...
      return defaultLayout(div3([id2("puzzle-select-component")])([h1_([text5("Level Select")]), div_(bind31(toUnfoldable9(allLevels))(function(v2) {
        return [h2_([text5(v2.value0)]), ul_(bind31(toUnfoldable9(v2.value1))(function(v1) {
    ...
    var $$eval2 = mkEval({
      handleAction: function(v1) {
        if (v1 instanceof Initialise7) {
          return bind112(liftEffect11(getAllLevelProgress2))(function(progress3) {
            return discard21(log5(show30(progress3)))(function() {
        ...
        if (v1 instanceof NavigateTo2) {
          return discard21(saveLevelProgress3(v1.value0)(Incomplete.value))(function() {
    ...
    return function(dictMonadAsk) {
      ...
      return function(dictMonadStore) {
        ...
        var render = function(v2) {
          if (v2.route instanceof Just) {
            ...
            if (v2.route.value0 instanceof Level) {
              return fromMaybe(text5("coublent find tht roblem"))(bind32(lookup4(v2.route.value0.value0)(allLevels))(function(levelSuite) {
                return bind32(lookup4(v2.route.value0.value1)(levelSuite))(function(level) {
                  return pure30(slot_5($$Proxy.value)(unit)(component72)({
                    levelId: {
        ...
        var $$eval2 = mkEval({
          ...
          handleQuery: function(v2) {
            return bind113(get3)(function(v1) {
              return discard22(when9(notEq9(v1.route)(new Just(v2.value0)))(discard22(log5("navigate"))(function() {
  ...
  var selectElement = function(query3) {
    return bind33(liftEffect6(bindFlipped8(composeKleisliFlipped2(function() {
      ...
      return pure31(bindFlipped1(fromElement)(mel));
    });
  };
  ...
  var awaitLoad = /* @__PURE__ */ makeAff(function(callback) {
    return function __do5() {
      ...
      if (rs instanceof Loading) {
        var et = map55(toEventTarget2)(windowImpl)();
        var listener = eventListener(function(v2) {
  ...
  var discard111 = /* @__PURE__ */ discard23(bindAff);
  ...
  var map56 = /* @__PURE__ */ map(functorCoyoneda);
  ...
  var unsubscribe3 = function(sid) {
    return function(ref4) {
      return function __do5() {
        ...
        return traverse_10(unsubscribe)(bindFlipped9(lookup24(sid))(subs))();
      };
    };
  };
  var queueOrRun = function(ref4) {
    return function(au) {
      return bind114(liftEffect7(read(ref4)))(function(v2) {
        if (v2 instanceof Nothing) {
          return au;
        }
        ;
  ...
  var handleLifecycle = function(lchs) {
    return function(f) {
      return discard111(liftEffect7(write({
        ...
        return bind114(liftEffect7(f))(function(result) {
          return bind114(liftEffect7(read(lchs)))(function(v2) {
  ...
  var evalQ = function(render) {
    return function(ref4) {
      return function(q3) {
        return bind114(liftEffect7(read(ref4)))(function(v2) {
          return evalM(render)(ref4)(v2["component"]["eval"](new Query(map56(Just.create)(liftCoyoneda(q3)), $$const(Nothing.value))));
        });
      };
    };
  };
    ...
    return function(initRef) {
      return function(v2) {
        var evalChildQuery = function(ref4) {
          return function(cqb) {
            return bind114(liftEffect7(read(ref4)))(function(v1) {
              return unChildQueryBox(function(v22) {
                var evalChild = function(v3) {
                  return parallel2(bind114(liftEffect7(read(v3)))(function(dsx) {
        ...
        var go2 = function(ref4) {
          return function(v1) {
            if (v1 instanceof State) {
              return bind114(liftEffect7(read(ref4)))(function(v22) {
            ...
            ;
            if (v1 instanceof Subscribe) {
              return bind114(fresh(SubscriptionId)(ref4))(function(sid) {
                return bind114(liftEffect7(subscribe(v1.value0(sid))(function(act) {
                  return handleAff(evalF(render)(ref4)(new Action(act)));
                })))(function(finalize) {
                  return bind114(liftEffect7(read(ref4)))(function(v22) {
                    return discard111(liftEffect7(modify_(map213(insert10(sid)(finalize)))(v22.subscriptions)))(function() {
            ...
            if (v1 instanceof Raise) {
              return bind114(liftEffect7(read(ref4)))(function(v22) {
                return bind114(liftEffect7(read(v22.handlerRef)))(function(handler3) {
            ...
            ;
            if (v1 instanceof Fork) {
              return bind114(fresh(ForkId)(ref4))(function(fid) {
                return bind114(liftEffect7(read(ref4)))(function(v22) {
                  return bind114(liftEffect7($$new(false)))(function(doneRef) {
                    return bind114(fork3($$finally(liftEffect7(function __do5() {
            ...
            if (v1 instanceof Join) {
              return bind114(liftEffect7(read(ref4)))(function(v22) {
                return bind114(liftEffect7(read(v22.forks)))(function(forkMap) {
                  return discard111(traverse_32(joinFiber)(lookup111(v1.value0)(forkMap)))(function() {
                    return pure32(v1.value1);
                  });
                });
              });
            ...
            if (v1 instanceof Kill) {
              return bind114(liftEffect7(read(ref4)))(function(v22) {
                return bind114(liftEffect7(read(v22.forks)))(function(forkMap) {
                  return discard111(traverse_32(killFiber(error("Cancelled")))(lookup111(v1.value0)(forkMap)))(function() {
                    return pure32(v1.value1);
                  });
                });
              });
            ...
            if (v1 instanceof GetRef) {
              return bind114(liftEffect7(read(ref4)))(function(v22) {
                return pure32(v1.value1(lookup25(v1.value0)(v22.refs)));
              });
            }
            ;
      ...
      return function(i2) {
          ...
          return function(handler3) {
            return function(childrenInRef) {
              return function(childrenOutRef) {
                return unComponentSlot(function(slot4) {
                  return function __do5() {
                    var childrenIn = map57(slot4.pop)(read(childrenInRef))();
                    var $$var2 = function() {
                    ...
                    var isDuplicate = map57(function($68) {
                    ...
                    return bind34(read($$var2))(renderStateX2(function(v2) {
                      ...
                      ;
                      if (v2 instanceof Just) {
                        return pure33(renderSpec2.renderChild(v2.value0));
                      }
                      ;
        ...
        var render = function(lchs) {
          return function($$var2) {
            return function __do5() {
              var v2 = read($$var2)();
              var shouldProcessHandlers = map57(isNothing)(read(v2.pendingHandlers))();
        ...
        var evalDriver = function(disposed) {
          return function(ref4) {
            return function(q3) {
              return bind115(liftEffect8(read(disposed)))(function(v2) {
                if (v2) {
              ...
              return handleLifecycle(lchs)(function __do5() {
                ...
                return unDriverStateX(function(v1) {
                  return function __do6() {
                    ...
                    return for_8(v22.rendering)(renderSpec2.dispose)();
                  };
                })(dsx)();
              });
            };
        ...
        return bind115(liftEffect8(newLifecycleHandlers))(function(lchs) {
          return bind115(liftEffect8($$new(false)))(function(disposed) {
            return handleLifecycle(lchs)(function __do5() {
              var sio = create3();
  ...
  var traverse_15 = /* @__PURE__ */ traverse_(applicativeEffect)(foldableMaybe);
  var unwrap13 = /* @__PURE__ */ unwrap();
  var when11 = /* @__PURE__ */ when(applicativeEffect);
  var not6 = /* @__PURE__ */ not(/* @__PURE__ */ heytingAlgebraFunction(/* @__PURE__ */ heytingAlgebraFunction(heytingAlgebraBoolean)));
  ...
  var removeChild3 = function(v2) {
    return function __do5() {
      ...
      return traverse_15(function(pn) {
            ...
            return function(v1) {
              ...
              if (v1 instanceof Just) {
                return function __do5() {
                  ...
                  when11(not6(unsafeRefEq)(v1.value0.node)(newNode))(substInParent(newNode)(nextSib)(parent2))();
                  return {
  ...
  var runUI2 = function(component14) {
    return function(i2) {
      return function(element4) {
        return bind116(liftEffect9(map58(toDocument)(bindFlipped11(document)(windowImpl))))(function(document2) {
