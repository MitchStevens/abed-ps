(() => {
  ...
  var component = function(dictMonadAff) {
    ...
    var render = function(state3) {
      return table([class_("chat-component")])(map16(renderMessage)(state3.messages));
    };
    var messageServer = bind5(liftEffect12(create))(function(v) {
      return bind5(fork(forever2(bind5(gets2(function(v1) {
        ...
        ;
        throw new Error("Failed pattern match at Component.Chat (line 104, column 7 - line 109, column 62): " + [v1.constructor.name]);
      }))))(function() {
    ...
    var handleAction = function(v) {
      ...
      ;
      throw new Error("Failed pattern match at Component.Chat (line 87, column 18 - line 93, column 73): " + [v.constructor.name]);
    };
    var $$eval4 = mkEval({
      handleQuery: function(v) {
        ...
        ;
        throw new Error("Failed pattern match at Component.Chat (line 72, column 20 - line 79, column 60): " + [v.constructor.name]);
      },
      handleAction,
  ...
  var bind7 = /* @__PURE__ */ bind(bindList);
  ...
  var showBoardError = {
    show: function(v) {
      ...
      ;
      throw new Error("Failed pattern match at Game.Board (line 49, column 10 - line 52, column 111): " + [v.constructor.name]);
    }
  };
  var showBoard = {
    show: function(v) {
  ...
  var unsafeMapKey = function(f) {
    var go2 = function(v) {
      ...
      ;
      throw new Error("Failed pattern match at Game.Board (line 186, column 10 - line 189, column 88): " + [v.constructor.name]);
    };
    return go2;
  };
  var standardBoard = {
  ...
  var toLocalInputs = function(loc) {
    var $182 = unsafeMapKey(relativeEdgeDirection);
    var $183 = submap2(new Just(relative(loc)(Up.value)))(new Just(relative(loc)(Left2.value)));
    return function($184) {
      return $182($183($184));
    };
  };
  ...
  var portEdges = function(v) {
    return function(dir2) {
      ...
      ;
      throw new Error("Failed pattern match at Game.Board (line 134, column 6 - line 138, column 67): " + [dir2.constructor.name]);
    };
  };
  var _size = function(dictStrong) {
    var $185 = _Newtype2(dictStrong.Profunctor0());
    var $186 = prop4($$Proxy.value)(dictStrong);
    return function($187) {
      return $185($186($187));
    };
  };
  ...
  var _pieces = function(dictStrong) {
    ...
    var $189 = prop23($$Proxy.value)(dictStrong);
    return function($190) {
      return $188($189($190));
    };
  };
    ...
    return function(loc) {
      return function(piece) {
        return function(board) {
          var $156 = has2(function() {
            var $191 = ix2(loc)(strongForget)(choiceForget2);
            return function($192) {
              return _pieces1($191($192));
            };
          }())(board);
          if ($156) {
          ...
          return new Right(set2(function() {
            var $193 = at2(loc)(strongFn);
            return function($194) {
              return _pieces2($193($194));
            };
          }())(new Just({
  ...
  var getPieceInfo = function(board) {
    return function(loc) {
      return note(new LocationNotOccupied(loc))(preview(function() {
        var $195 = ix2(loc)(strongForget)(choiceForget1);
        return function($196) {
          return _pieces1($195($196));
        };
      }())(board));
    };
  };
  var toAbsoluteEdge = function(board) {
    return function(v) {
      ...
      ;
      throw new Error("Failed pattern match at Game.Board (line 121, column 55 - line 123, column 29): " + [v1.constructor.name]);
    };
  };
  var toRelativeEdge = function(board) {
    return function(v) {
      ...
      ;
      throw new Error("Failed pattern match at Game.Board (line 127, column 44 - line 129, column 29): " + [v1.constructor.name]);
    };
  };
  ...
  var buildBoardGraph = function(v) {
    return unfoldGraph2(toUnfoldable5(keys3(v.pieces)))(function(v1) {
      ...
      return bind7(toListOf(function() {
        var $197 = ix2(loc)(strongForget)(choiceForget22);
        return function($198) {
          return _pieces1($197($198));
        };
      }())(v))(function(p2) {
        return bind7(fromFoldable7(getOutputDirs2(p2.piece)))(function(dir2) {
  ...
  var evalLocation = function(board) {
    return function(acc) {
      return function(loc) {
        var outputs = fromFoldable42(bind12(fromFoldable12(getPieceInfo(board)(loc)))(function(p2) {
          return bind12(toUnfoldable12(toGlobalInputs(loc)($$eval2(p2.piece)(toLocalInputs(loc)(acc)))))(function(v) {
  ...
  var getPortOnEdge = function(board) {
    return function(v) {
      return previewOn(board)(function() {
        var $199 = ix2(v.loc)(strongForget)(choiceForget1);
        var $200 = to(function(p2) {
          return getPort3(p2.piece)(v.dir);
        });
        return function($201) {
          return _pieces1($199($200(_Just2($201))));
        };
      }());
    };
  };
      ...
      var extractOutputs = function(signals) {
        ...
        return fromFoldable22(catMaybes(mapFlipped3(absEdgePorts)(function(absEdge) {
          ...
          return bind22(getPortOnEdge(v)(relEdge))(function(port2) {
            return discard4(guard3(!isInput(port2)))(function() {
  ...
  var portsBoard = function(board) {
    return fromFoldable22(bind12(allDirections)(function(dir2) {
      return bind12(fromFoldable32(getPortOnEdge(board)(toRelativeEdge(board)(portEdges(board)(dir2)))))(function(port2) {
  ...
  var removePiece = function(loc) {
    return function(board) {
      var $181 = has2(function() {
        var $202 = ix2(loc)(strongForget)(choiceForget2);
        return function($203) {
          return _pieces1($202($203));
        };
      }())(board);
      if ($181) {
        return new Right(set2(function() {
          var $204 = at2(loc)(strongFn);
          return function($205) {
            return _pieces2($204($205));
          };
        }())(Nothing.value)(board));
      }
      ;
    ...
    return function(rot) {
      return function(board) {
        return new Right(appendOver2(function() {
          var $206 = ix2(loc)(strongFn)(choiceFn);
          return function($207) {
            return _pieces2($206(_rotation1($207)));
          };
        }())(rot)(board));
      };
    };
  ...
  var show6 = /* @__PURE__ */ show(/* @__PURE__ */ showMaybe(showLocation));
  ...
  var show23 = /* @__PURE__ */ show(/* @__PURE__ */ showEither(showBoardError)(showBoard));
  ...
  var LocationOnDrop = /* @__PURE__ */ function() {
    function LocationOnDrop2(value0) {
      this.value0 = value0;
    }
    ;
    LocationOnDrop2.create = function(value0) {
      return new LocationOnDrop2(value0);
    };
    return LocationOnDrop2;
  }();
  var LocationOnMouseLeave = /* @__PURE__ */ function() {
    function LocationOnMouseLeave2(value0) {
      this.value0 = value0;
    }
    ;
    LocationOnMouseLeave2.create = function(value0) {
      return new LocationOnMouseLeave2(value0);
    };
    return LocationOnMouseLeave2;
  }();
  ...
  var component3 = function(dictMonadEffect) {
    ...
    var render = function(state3) {
      ...
      var emptyPieceHTML = text(show6(state3.mouseOverLocation));
      return div3([id2("board-component"), style(intercalate5(";")(["grid-template-columns: " + power3("1fr ")(n), "grid-template-rows: " + power3("1fr ")(n)])), onKeyDown(OnKeyDown.create)])(bind8(range2(0)(n - 1 | 0))(function(j) {
        return bind8(range2(0)(n - 1 | 0))(function(i2) {
          ...
          return pure8(div3([class_("piece"), style("transform: rotate(" + (show1(v * 90 | 0) + "deg)")), onDragEnter(LocationOnDragEnter.create(loc)), onDragOver(LocationOnDragOver.create(loc)), onDragLeave(LocationOnDragLeave.create), onDrop(LocationOnDrop.create), onMouseLeave(LocationOnMouseLeave.create)])(either(function(v1) {
            return [emptyPieceHTML];
          })(function() {
            var $115 = pieceHTML(loc);
            return function($116) {
              return pure8($115(function(v1) {
                return v1.piece;
              }($116)));
            };
          }())(eitherPieceInfo)));
    ...
    var handleAction = function(v) {
      if (v instanceof PieceOutput && v.value0 instanceof Rotated) {
        return appendModifying2(function() {
          var $117 = prop5($$Proxy.value)(strongFn);
          var $118 = ix3(v.value0.value0)(strongFn)(choiceFn);
          var $119 = prop13($$Proxy.value)(strongFn);
          return function($120) {
            return $117(_pieces3($118($119($120))));
          };
        }())(v.value0.value1);
      }
      ;
        ...
        return discard5(log4("BOARD: received drop"))(function() {
          return bind13(gets4(function(v1) {
            ...
            return bind13(gets4(function(v1) {
              ...
              return discard5(log4("BOARD: loction " + show6(maybeDestination)))(function() {
                return discard5(log4("BOARD: board " + show23(board$prime)))(function() {
      ...
      if (v instanceof SetBoard) {
        return discard5(log4("set ne board"))(function() {
          return discard5(modify_4(function(s) {
            ...
            ;
            $82.board = v.value0;
            $82.previousBoards = new Cons(v.value0, s.previousBoards);
            return $82;
          }))(function() {
      ...
      if (v instanceof OnKeyDown) {
        var $92 = code2(v.value0) === "90" && ctrlKey(v.value0);
        if ($92) {
          return log4("undo");
        }
        ;
      ...
      if (v instanceof LocationOnDragEnter) {
        return discard5(log4("dragenter"))(function() {
          return modify_4(function(v1) {
            ...
            ;
            $94.mouseOverLocation = new Just(v.value0);
            return $94;
          });
        });
      }
      ...
      if (v instanceof LocationOnDragOver) {
        return modify_4(function(v1) {
          ...
          ;
          $99.mouseOverLocation = new Just(v.value0);
          return $99;
        });
      }
      ;
      if (v instanceof LocationOnDrop) {
        return liftEffect9(preventDefault(toEvent(v.value0)));
      }
      ;
      if (v instanceof LocationOnDragLeave) {
        return log4("drag leave");
      }
      ;
      if (v instanceof LocationOnMouseLeave) {
        return log4("mouse leave");
      }
      ;
      throw new Error("Failed pattern match at Component.Board (line 135, column 18 - line 183, column 24): " + [v.constructor.name]);
    };
    var $$eval4 = mkEval({
      finalize: Nothing.value,
      handleAction,
      handleQuery: function(v) {
        ...
        ;
        throw new Error("Failed pattern match at Component.Board (line 113, column 20 - line 129, column 32): " + [v.constructor.name]);
      },
  ...
  var solvedBy = function(problem) {
    return function(board) {
      var checkTestCases = for_3(problem.testCases)(function(inputs) {
        ...
        var $60 = notEq2(received)(expected);
        if ($60) {
      ...
      var checkSamePorts = for_3(allDirections)(function(dir2) {
        ...
        if (v1 instanceof Just && v instanceof Just) {
          var $65 = notEq1(v1.value0)(v.value0);
          if ($65) {
        ...
        ;
        throw new Error("Failed pattern match at Game.ProblemDescription (line 65, column 7 - line 72, column 27): " + [v1.constructor.name, v.constructor.name]);
      });
  ...
  var GetSelectedPiece = /* @__PURE__ */ function() {
    function GetSelectedPiece2(value0) {
      this.value0 = value0;
    }
    ;
    GetSelectedPiece2.create = function(value0) {
      return new GetSelectedPiece2(value0);
    };
    return GetSelectedPiece2;
  }();
  ...
  var PieceOnDragLeave = /* @__PURE__ */ function() {
    function PieceOnDragLeave2(value0) {
      this.value0 = value0;
    }
    ;
    PieceOnDragLeave2.create = function(value0) {
      return new PieceOnDragLeave2(value0);
    };
    return PieceOnDragLeave2;
  }();
  var component4 = function(dictMonadAff) {
    ...
    var renderError = function($54) {
      return div_(function(v) {
        if (v instanceof DifferentPortConfiguration) {
          if (v.value0.received instanceof Just && v.value0.expected instanceof Nothing) {
            return [text("Remove the "), renderPort(v.value0.received.value0), text(" in the "), renderDirection(v.value0.dir), text(" direction.")];
          }
          ;
          if (v.value0.received instanceof Nothing && v.value0.expected instanceof Just) {
            return [text("You need an "), renderPort(v.value0.expected.value0), text(" in the "), renderDirection(v.value0.dir), text(" direction")];
          }
          ;
          return [text("ERROR")];
        }
        ;
        if (v instanceof DifferentPort) {
          return [text("You need an "), renderPort(v.value0.expected), text(" in the "), renderDirection(v.value0.dir), text(" direction.")];
        }
        ;
        if (v instanceof FailedTestCase) {
          return [text("For the inputs "), renderSignals(v.value0.inputs), text(" your solution should output "), renderSignals(v.value0.expected), text(", not "), renderSignals(v.value0.received), text(".")];
        }
        ;
        if (v instanceof FailedRestriction) {
          return [text("Failed predicate " + v.value0)];
        }
        ;
        throw new Error("Failed pattern match at Component.Sidebar (line 76, column 29 - line 86, column 70): " + [v.constructor.name]);
      }($54));
    };
    var render = function(v) {
      return div3([class_("sidebar-component")])([h2_([text(v.problem.title)]), h3_([text(v.problem.description)]), maybe(text("problem complete"))(renderError)(v.error), h3_([text("Available pieces:")]), div3([class_("pieces")])(mapFlipped5(fromFoldable8(v.problem.pieceSet))(function(piece) {
        return div3([draggable(true), onDragEnd(PieceOnDrop.create(piece)), onDragLeave(PieceOnDragLeave.create)])([text(name5(piece))]);
      }))]);
    };
    ...
    var $$eval4 = mkEval({
      ...
      handleAction: function(v) {
        ...
        ;
        if (v instanceof PieceOnDragLeave) {
          return log4("LEFT TARGT!");
        }
        ;
        throw new Error("Failed pattern match at Component.Sidebar (line 101, column 21 - line 105, column 28): " + [v.constructor.name]);
      },
      handleQuery: function(v) {
        if (v instanceof IsProblemSolved) {
        ...
        ;
        if (v instanceof GetSelectedPiece) {
          return bind9(gets5(function(v1) {
            return v1.selectedPiece;
          }))(function(maybePiece) {
            return pure10(map21(v.value0)(maybePiece));
          });
        }
        ;
        throw new Error("Failed pattern match at Component.Sidebar (line 106, column 20 - line 114, column 34): " + [v.constructor.name]);
      },
      initialize: Nothing.value,
      receive: $$const(Nothing.value)
    });
  ...
  var component5 = function(dictMonadAff) {
    ...
    var $$eval4 = mkEval({
      ...
      handleAction: function(v) {
        ...
        ;
        throw new Error("Failed pattern match at Component.Puzzle (line 61, column 21 - line 74, column 59): " + [v.constructor.name]);
      },
      handleQuery: function(v) {
  ...
  var runUI2 = function(component6) {
    return function(i2) {
      return function(element3) {
        return bind17(liftEffect7(map28(toDocument)(bindFlipped8(document)(windowImpl))))(function(document2) {
    ...
    return function(component6) {
      return discard11(awaitLoad)(function() {
        return bind18(bind18(selectElement("#abed"))(function() {
          var $26 = maybe($$throw("Could not find element #abed"))(pure19);
          return function($27) {
            return liftEffect8($26($27));
          };
        }()))(function(v) {
