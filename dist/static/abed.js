...
(() => {
  ...
  var foreach = function(as3) {
    return function(f) {
      return function() {
        for (var i2 = 0, l2 = as3.length; i2 < l2; i2++) {
          f(as3[i2])();
        }
      };
    };
  ...
  var negate = function(dictRing) {
    ...
    var zero11 = zero(dictRing.Semiring0());
    return function(a3) {
      return sub14(zero11)(a3);
    };
  };
  ...
  var semiringTuple = function(dictSemiring) {
    ...
    var one6 = one(dictSemiring);
    var mul4 = mul(dictSemiring);
    var zero11 = zero(dictSemiring);
    return function(dictSemiring1) {
      ...
      return {
        ...
        one: new Tuple(one6, one(dictSemiring1)),
        mul: function(v2) {
          return function(v1) {
            return new Tuple(mul4(v2.value0)(v1.value0), mul1(v2.value1)(v1.value1));
          };
        },
        zero: new Tuple(zero11, zero(dictSemiring1))
      };
    };
  };
  var semigroupTuple = function(dictSemigroup) {
    ...
    return function(dictSemigroup1) {
      ...
      return {
        append: function(v2) {
          return function(v1) {
            return new Tuple(append112(v2.value0)(v1.value0), append22(v2.value1)(v1.value1));
          };
        }
      };
    };
  ...
  var eqTuple = function(dictEq) {
    ...
    return function(dictEq1) {
      ...
      return {
        eq: function(x2) {
          return function(y2) {
            return eq26(x2.value0)(y2.value0) && eq113(x2.value1)(y2.value1);
          };
        }
      };
    };
  ...
  var foldableNonEmpty = function(dictFoldable) {
    ...
    return {
      foldMap: function(dictMonoid) {
        ...
        return function(f) {
          return function(v2) {
            return append112(f(v2.value0))(foldMap12(f)(v2.value1));
          };
        };
      },
      foldl: function(f) {
          ...
          var go2 = function($copy_v) {
            return function($copy_v1) {
              ...
              function $tco_loop(v2, v1) {
                ...
                ;
                if (v2 instanceof Cons && v1 instanceof Cons) {
                  var v22 = compare9(v2.value0)(v1.value0);
          ...
          return function($copy_e) {
            return function($copy_step) {
              return function($copy_rest) {
                ...
                var $tco_done = false;
                var $tco_result;
                function $tco_loop(s2, e, step5, rest3) {
                  if (s2 === e) {
                    $tco_done = true;
                    return new Cons(s2, rest3);
                  }
                  ;
                  if (otherwise) {
                    $tco_var_s = s2 + step5 | 0;
                    $tco_var_e = e;
                    $tco_var_step = step5;
                    $copy_rest = new Cons(s2, rest3);
                    return;
                  }
                  ;
                  throw new Error("Failed pattern match at Data.List (line 148, column 3 - line 149, column 65): " + [s2.constructor.name, e.constructor.name, step5.constructor.name, rest3.constructor.name]);
                }
                ;
                while (!$tco_done) {
  ...
  var $lazy_unsafeDifference = /* @__PURE__ */ $runtime_lazy4("unsafeDifference", "Data.Map.Internal", function() {
    return function(comp, l2, r) {
      ...
      if (r instanceof Node) {
        ...
        var l$prime = $lazy_unsafeDifference(841)(comp, v2.value1, r.value4);
        var r$prime = $lazy_unsafeDifference(842)(comp, v2.value2, r.value5);
        return unsafeJoinNodes(l$prime, r$prime);
      }
      ;
      throw new Error("Failed pattern match at Data.Map.Internal (line 836, column 39 - line 843, column 33): " + [l2.constructor.name, r.constructor.name]);
    };
  });
  ...
  var pop = function(dictOrd) {
    ...
    return function(k) {
      return function(m2) {
        var v2 = unsafeSplit(compare9, k, m2);
            ...
            return function($copy_b) {
              ...
              function $tco_loop(a3, b2) {
                ...
                if (v2 instanceof IterNext) {
                  var v22 = stepAsc(b2);
                  if (v22 instanceof IterNext && (eq113(v2.value0)(v22.value0) && eq26(v2.value1)(v22.value1))) {
                    $tco_var_a = v2.value2;
                    $copy_b = v22.value2;
                    return;
                  }
            ...
            return function($copy_b) {
              ...
              function $tco_loop(a3, b2) {
                ...
                if (v1 instanceof IterNext && v2 instanceof IterNext) {
                  var v3 = compare9(v1.value0)(v2.value0);
                  if (v3 instanceof EQ) {
  ...
  var ordMap = function(dictOrd) {
    ...
    return function(dictOrd1) {
      var compare9 = compare(ordMapIter1(dictOrd1));
      ...
      return {
        compare: function(xs) {
          return function(ys) {
            ...
            ;
            return compare9(toMapIter(xs))(toMapIter(ys));
          };
        },
        Eq0: function() {
          return eqMap22;
  ...
  var Aff = function() {
    ...
    function runPar(util, supervisor, par, cb) {
      ...
      function join8(result, head6, tail3) {
                  ...
                  kills[kid] = kill3(early, fail3 === lhs ? head6._2 : head6._1, function() {
                    return function() {
                      ...
                      if (tmp) {
                        ...
                        join8(fail3, null, null);
                      } else {
                        join8(fail3, tail3._1, tail3._2);
                      }
                    };
                  });
                  if (tmp) {
                  ...
                  kills[kid] = kill3(early, step5 === lhs ? head6._2 : head6._1, function() {
                    return function() {
                      ...
                      if (tmp) {
                        ...
                        join8(step5, null, null);
                      } else {
                        join8(step5, tail3._1, tail3._2);
                      }
                    };
                  });
                  if (tmp) {
  ...
  var parTraverse_ = function(dictParallel) {
    ...
    return function(dictApplicative) {
      var traverse_15 = traverse_(dictApplicative);
      return function(dictFoldable) {
        var traverse_16 = traverse_15(dictFoldable);
        return function(f) {
          var $51 = traverse_16(function($53) {
  ...
  var sortByImpl = function() {
    function mergeFromTo(compare9, fromOrdering, xs1, xs2, from4, to2) {
      var mid;
      var i2;
      var j;
      var k;
      ...
      if (mid - from4 > 1)
        mergeFromTo(compare9, fromOrdering, xs2, xs1, from4, mid);
      if (to2 - mid > 1)
      ...
      while (i2 < mid && j < to2) {
        x2 = xs2[i2];
        y2 = xs2[j];
        c2 = fromOrdering(compare9(x2)(y2));
        if (c2 > 0) {
          xs1[k++] = y2;
          ++j;
        } else {
  ...
  var range3 = /* @__PURE__ */ runFn2(rangeImpl);
  ...
  var fromFoldable4 = function(dictFoldable) {
    var $119 = fromFoldable3(dictFoldable);
    return function($120) {
  ...
  var foldl13 = /* @__PURE__ */ foldl(foldableSet);
  var findMin2 = function(v2) {
  ...
  var ordSet = function(dictOrd) {
    var compare9 = compare(ordList(dictOrd));
    var eqSet1 = eqSet(dictOrd.Eq0());
    return {
      compare: function(s1) {
        return function(s2) {
          return compare9(toList(s1))(toList(s2));
        };
      },
      Eq0: function() {
        return eqSet1;
  ...
  var prism = function(to2) {
    return function(fro) {
      return function(dictChoice) {
        ...
        return function(pab) {
          return dimap3(fro)(either(identity12)(identity12))(right2(rmap3(to2)(pab)));
        };
      };
    };
  };
  ...
  // output/Text.Printf/foreign.js
  var formatString = (controls3) => (value14) => {
    const [, , left2, fill2, width9] = /^(\+)?(-)?('.|0)?(\d+)?(?:\.(\d*))?$/.exec(controls3) || [];
    const maxWidth = Number(width9) || 0;
    const padding = fill2?.replace("'", "") || " ";
    return left2 ? value14.padEnd(maxWidth, padding) : value14.padStart(maxWidth, padding);
  };

  // output/Text.Printf/index.js
  var identity13 = /* @__PURE__ */ identity(categoryFn);
  var SProxy = /* @__PURE__ */ function() {
    function SProxy2() {
    }
    ;
  ...
  var formatSNilString = {
    format: function(v2) {
      return identity13;
    }
  };
  var printf = function(dict) {
    return dict.printf;
  };
  var format = function(dict) {
    return dict.format;
  };
  var formatSConsCommon = function(dictIsSymbol) {
    var reflectSymbol2 = reflectSymbol(dictIsSymbol);
    return function(dictFormat) {
      var format1 = format(dictFormat);
      return {
        format: function(v2) {
          return function(str) {
            return format1(SProxy.value)(str + reflectSymbol2($$Proxy.value));
          };
        }
      };
    };
  };
  var formatSConsSStringFunctio = function(dictIsSymbol) {
    var reflectSymbol2 = reflectSymbol(dictIsSymbol);
    return function(dictFormat) {
      var format1 = format(dictFormat);
      return {
        format: function(v2) {
          return function(str) {
            return function(s2) {
              return format1(SProxy.value)(str + formatString(reflectSymbol2($$Proxy.value))(s2));
            };
          };
        }
      };
  ...
  var printf1 = function() {
    return function(dictFormat) {
      var format1 = format(dictFormat);
      return {
        printf: function(v2) {
          return format1(SProxy.value)("");
        }
      };
    };
  };
  ...
  var foldMapWithIndex2 = /* @__PURE__ */ foldMapWithIndex(foldableWithIndexMap)(monoidString);
  var printf12 = /* @__PURE__ */ printf1();
  var IsSymbol = {
    reflectSymbol: function() {
      return "";
    }
  };
  var formatSConsSStringFunctio2 = /* @__PURE__ */ formatSConsSStringFunctio(IsSymbol);
  var printf2 = /* @__PURE__ */ printf(/* @__PURE__ */ printf12(/* @__PURE__ */ formatSConsCommon(IsSymbol)(/* @__PURE__ */ formatSConsSStringFunctio2(/* @__PURE__ */ formatSConsCommon({
    reflectSymbol: function() {
      return " => ";
    }
  })(/* @__PURE__ */ formatSConsSStringFunctio2(/* @__PURE__ */ formatSConsCommon({
    reflectSymbol: function() {
      return ", ";
    }
  })(formatSNilString)))))));
  var show6 = /* @__PURE__ */ show(showCardinalDirection);
  var show12 = /* @__PURE__ */ show(showPort);
  var printf22 = /* @__PURE__ */ printf(/* @__PURE__ */ printf12(/* @__PURE__ */ formatSConsCommon({
    reflectSymbol: function() {
      return "(Piece ";
    }
  })(/* @__PURE__ */ formatSConsSStringFunctio2(/* @__PURE__ */ formatSConsCommon({
  ...
  var show22 = /* @__PURE__ */ show(showPieceId);
  var eqPieceId = {
    eq: function(x2) {
      return function(y2) {
        return x2 === y2;
  ...
  var showPiece = {
    show: function(piece) {
      var showPorts = foldMapWithIndex2(function(dir2) {
        return function(port2) {
          return printf2($$Proxy.value)(show6(dir2))(show12(port2));
        };
      })(getPorts(piece));
      return printf22($$Proxy.value)(show22(name2(piece)))(showPorts);
    }
  };
  ...
  var foreachSlot = function(dictApplicative) {
    var traverse_15 = traverse_(dictApplicative)(foldableMap);
    return function(v2) {
      return function(k) {
        return traverse_15(function($54) {
          return k($54);
        })(v2);
      };
    };
  ...
  var fromFoldable6 = function(dictFoldable) {
    var fromFoldable113 = fromFoldable3(dictFoldable);
    return function(l2) {
      return runST(function __do5() {
        var s2 = newImpl();
        foreach(fromFoldable113(l2))(function(v2) {
          return $$void5(poke2(v2.value0)(v2.value1)(s2));
        })();
        return s2;
      });
    };
  ...
  var bifunctorHTML = {
    bimap: function(f) {
      return function(g2) {
        return function(v2) {
          return bimap3(map20(map111(map22(g2))))(f)(v2);
        };
      };
    }
  };
  ...
  var foldFree = function(dictMonadRec) {
    ...
    return function(k) {
      var go2 = function(f) {
        var v2 = toView(f);
        if (v2 instanceof Return) {
          return map124(Done.create)(pure117(v2.value0));
        }
        ;
        if (v2 instanceof Bind) {
    ...
    return function(nat) {
      return function(v2) {
        if (v2 instanceof ComponentSlot) {
          return unComponentSlot(function(slot14) {
            return new ComponentSlot(mkComponentSlot({
              get: slot14.get,
              pop: slot14.pop,
              set: slot14.set,
              input: slot14.input,
              output: slot14.output,
              component: hoist3(dictFunctor)(nat)(slot14.component)
            }));
          })(v2.value0);
        }
        ;
    ...
    map: function(f) {
      return unComponentSlot(function(slot14) {
        return mkComponentSlot({
          ...
          pop: slot14.pop,
          set: slot14.set,
          component: slot14.component,
          input: slot14.input,
          output: map112(map24(f))(slot14.output)
        });
      });
    }
  };
  ...
  var tell2 = function() {
    return function(dictIsSymbol) {
      ...
      return function(dictOrd) {
        ...
        return function(slot14) {
          return function(label5) {
            return function(req) {
              return $$void7(query22(slot14)(label5)(req(unit)));
            };
          };
        };
      };
    ...
    return function(dictIsSymbol) {
      ...
      return function(dictOrd) {
        ...
        return function(slot14) {
          return function(label5) {
            return function(req) {
              return query22(slot14)(label5)(req(identity16));
            };
          };
        };
      };
  ...
  var showBasic = function(dictApplicative) {
    ...
    return function(value14) {
      return function(label5) {
        return pure117(singleton7(label5 + value14));
      };
    };
  };
  ...
  var showTag = function(dictMonadEffect) {
    ...
    return function(v2) {
      ...
      if (v2 instanceof NumberTag) {
        return showSpecial2(show13(v2.value0));
      }
      ;
      if (v2 instanceof BooleanTag) {
        return showSpecial2(show23(v2.value0));
      }
      ;
  ...
  var showSubTags = function(dictMonadEffect) {
    ...
    return function(value14) {
      return function(label5) {
        return map214(cons2(label5))(fromMaybe(pure117([]))(tagLines(dictMonadEffect)(value14)));
      };
    };
  };
  ...
  var applyRouteDuplex = {
    apply: function(v2) {
      return function(v1) {
        return new RouteDuplex(apply1(map115(append10)(v2.value0))(v1.value0), apply3(v2.value1)(v1.value1));
      };
    },
    Functor0: function() {
  ...
  var affineTraversal$prime = function(to2) {
    return function(dictStrong) {
      ...
      return function(dictChoice) {
        ...
        return function(pab) {
          return dimap3(to2)(function(v2) {
            return either(identity19)(v2.value0)(v2.value1);
          })(second3(right2(pab)));
        };
      };
    };
  ...
  var showRelativeEdge = {
    show: function(v2) {
      return "(RelEdge " + (show11(v2.loc) + (" " + (show14(v2.dir) + ")")));
    }
  };
  var eqRelativeEdge = {
    eq: function(x2) {
  ...
  var show15 = /* @__PURE__ */ show(showLocation);
  ...
  var difference4 = /* @__PURE__ */ difference3(ordLocation);
  var fromFoldable1 = /* @__PURE__ */ fromFoldable5(foldableList)(ordLocation);
  ...
  var showBoardError = {
    show: function(v2) {
      if (v2 instanceof LocationOccupied) {
        return "Location Occupied: " + show15(v2.value0);
      }
      ;
      if (v2 instanceof LocationNotOccupied) {
        return "Location Not Occupied: " + show15(v2.value0);
      }
      ;
      if (v2 instanceof InvalidLocation) {
        return "Location " + (show15(v2.value0) + " is outside range of the board");
      }
      ;
      if (v2 instanceof InvalidBoardInitialisation) {
        return "Invalid Board Initialisation: " + (show16(v2.value0) + " is not a valid board size");
      }
      ;
      if (v2 instanceof BadBoardSize) {
        return "Boards of size " + (show16(v2.value0) + " are not valid");
      }
      ;
  ...
  var toLocalInputs = function(loc) {
    var $186 = unsafeMapKey(relativeEdgeDirection);
    var $187 = submap2(new Just(relative(loc)(Up.value)))(new Just(relative(loc)(Left2.value)));
    return function($188) {
      return $186($187($188));
    };
  };
  ...
  var allLocations = function(v2) {
    return bind11(range2(0)(v2.size - 1 | 0))(function(j) {
      return bind11(range2(0)(v2.size - 1 | 0))(function(i2) {
        return pure13(location(i2)(j));
      });
    });
  };
  var allEmptyLocations = function(v2) {
    return difference4(fromFoldable1(allLocations(v2)))(keys2(v2.pieces));
  };
  var firstEmptyLocation = function($189) {
    return findMin2(allEmptyLocations($189));
  };
  var _size = function(dictStrong) {
    var $190 = _Newtype3(dictStrong.Profunctor0());
    var $191 = prop7($$Proxy.value)(dictStrong);
    return function($192) {
      return $190($191($192));
    };
  };
  var _pieces = function(dictStrong) {
    var $193 = _Newtype3(dictStrong.Profunctor0());
    var $194 = prop13($$Proxy.value)(dictStrong);
    return function($195) {
      return $193($194($195));
    };
  };
  ...
  var fromFoldable12 = /* @__PURE__ */ fromFoldable2(ordRelativeEdge)(foldableList);
  ...
  var getPortOnEdge = function(dictMonadState) {
    ...
    return function(v2) {
      return bind118(use3(function() {
        ...
        return pure41(bind13(maybePieceInfo)(function(info3) {
    ...
    return function(dir2) {
      return bind118(use3(_size2))(function(n) {
        return pure41(function() {
          ...
          ;
          throw new Error("Failed pattern match at Game.Board.Query (line 123, column 10 - line 127, column 52): " + [dir2.constructor.name]);
        }());
      });
    };
  };
      ...
      return function(vars) {
        ...
        if (vars.openSet instanceof Cons) {
          ...
          return bind118(map311(map38(function(v2) {
                ...
                return discard111(modifying4(function() {
                  ...
                  if ($190) {
                    var notInClosedSet = function(r) {
                      return !member3(relativeEdgeLocation(r))(vars.closedSet);
                    };
                    var openSet = append14(fromFoldable7(filter6(notInClosedSet)(connected)))(vars.openSet.value1);
            ...
            ;
            throw new Error("Failed pattern match at Game.Board.Query (line 184, column 5 - line 196, column 70): " + [v2.constructor.name]);
          });
        }
        ;
        throw new Error("Failed pattern match at Game.Board.Query (line 177, column 35 - line 196, column 70): " + [vars.openSet.constructor.name]);
      };
    };
  };
  ...
  var buildConnectionMapAt = function(dictMonadState) {
    ...
    var traverse_15 = traverse_(applicativeWriterT1)(foldableMaybe);
    ...
    return function(loc) {
      return for_8(allDirections)(function(dir2) {
        ...
        return bind118(connectedRelativeEdge1(relEdge))(traverse_15(function(adjRelEdge) {
          return bind118(getPortOnEdge1(relEdge))(function(port2) {
            ...
            ;
            throw new Error("Failed pattern match at Game.Board.Query (line 161, column 7 - line 166, column 29): " + [v2.constructor.name]);
          });
        }));
      });
    };
  ...
  var buildConnectionMap = function(dictMonadState) {
    ...
    var traverse_15 = traverse_(applicativeWriterT2(Monad0.Applicative0()))(foldableList);
    ...
    return bind(Bind1)(use(dictMonadState)(_pieces2))(function(pieceInfos) {
      return map211(map311(fromFoldable12))(execWriterT2)(traverse_15(buildConnectionMapAt1)(fromFoldable22(keys2(pieceInfos))));
    });
  };
  ...
  var fromFoldable8 = /* @__PURE__ */ fromFoldable2(ordCardinalDirection)(foldableMap);
  ...
  var setOuterPort = function(dictMonadReader) {
    ...
    return function(dictMonadState) {
      ...
      return function(dir2) {
        return function(signal) {
          return $$void13(runMaybeT(bind118(asks2(function() {
            ...
            return bind118(asks2(function() {
              ...
              return when13(isPseudoInput(v2))(bind118(pure41(getPsuedoPiecePort(v2)))(function(port2) {
      ...
      return function(inRelEdge) {
        return function(capacity) {
          return bind118(asks2(function($297) {
            ...
            ;
            throw new Error("Failed pattern match at Game.Board.EvaluableBoard (line 204, column 3 - line 215, column 18): " + [v2.constructor.name]);
          });
        };
      };
    };
      ...
      return function(loc) {
        return bind118(asks2(function($298) {
          ...
          return for_8(lookup12(loc)(pieces))(function(v2) {
            ...
            return bind118(map214(fromFoldable8)(forWithIndex2(inputPorts)(function(dir2) {
              return function(port2) {
  ...
  var evalWithPortInfo = function(dictMonadReader) {
    ...
    var traverse_15 = traverse_(Monad0.Applicative0())(foldableList);
      ...
      return function(inputs) {
        return bind118(asks2(function($299) {
          ...
          return discard111(injectInputs2(inputs))(function() {
            return discard111(traverse_15(evalWithPortInfoAt2)(evalOrder))(function() {
  ...
  var buildEvaluableBoard = function(dictMonadError) {
    ...
    var throwError4 = throwError(monadThrowStateT(MonadThrow0));
    ...
    return function(psuedoPiecePorts) {
      return evalStateT2(discard111(forWithIndex_3(psuedoPiecePorts)(function(dir2) {
        ...
        return bind118(map214(map118(function(v2) {
          return v2.piece;
          ...
          return bind118(buildConnectionMap2)(function(connections) {
            return bind118(forWithIndex2(psuedoPiecePorts)(function(dir2) {
              ...
              var locations = fromFoldable13(keys2(pieces));
              return bind118(maybe(throwError4(Cyclic.value))(pure41)(topologicalSort(locations)(connections)))(function(evalOrder) {
                return pure41({
                  pieces,
                  connections,
                  evalOrder,
  ...
  var FailedValidation = /* @__PURE__ */ function() {
    function FailedValidation2(value0) {
      this.value0 = value0;
    }
    ;
    FailedValidation2.create = function(value0) {
      return new FailedValidation2(value0);
    };
    return FailedValidation2;
  }();
  ...
  var isPortMismatch = function(direction2) {
    return function(maybeExpected) {
      return function(maybeRecieved) {
        ...
        ;
        throw new Error("Failed pattern match at Game.Level.Completion (line 84, column 56 - line 94, column 14): " + [maybeExpected.constructor.name, maybeRecieved.constructor.name]);
      };
    };
  };
  var checkPortMismatch = function(level2) {
    return function(evaluable) {
      return for_2(allDirections)(function(dir2) {
        var expected = getPort(level2.goal)(dir2);
  ...
  var isReadyForTesting = function(level2) {
    return function(board) {
      return fromLeft(ReadyForTesting.value)(bind16(checkEvaluable(board))(function(evaluable) {
        return discard6(lmap3(PortMismatch.create)(checkPortMismatch(level2)(evaluableBoardPiece(evaluable))))(function() {
          return lmap3(FailedValidation.create)(level2.validate(board));
        });
      }));
    };
  };
  ...
  var fromFoldable9 = /* @__PURE__ */ fromFoldable3(foldableList);
  var many2 = function(p2) {
    return bind17(flip(tailRecM3)(Nil.value)(function(xs) {
      ...
      return pure14(reverse2(fromFoldable9(rlist)));
    });
  };
  ...
  var show24 = /* @__PURE__ */ show(showChar);
  ...
  var string = function(str) {
    return consumeWith(function(input3) {
      ...
      ;
      return new Left("Expected " + show17(str));
    });
  };
      ...
      return function(da) {
        return {
          ...
          attrPrint: function($61) {
            return da.attrPrint(unwrap12($61));
          },
  ...
  var RemoveThis = /* @__PURE__ */ function() {
    function RemoveThis2(value0) {
      this.value0 = value0;
    }
    ;
    RemoveThis2.create = function(value0) {
      return new RemoveThis2(value0);
    };
    return RemoveThis2;
  }();
  ...
  var printColor = function(v2) {
    if (v2 instanceof RGB) {
      return "rgb(" + (show19(v2.value0) + ("," + (show19(v2.value1) + ("," + (show19(v2.value2) + ")")))));
    }
    ;
    if (v2 instanceof RGBA) {
      return "rgba(" + (show19(v2.value0) + ("," + (show19(v2.value1) + ("," + (show19(v2.value2) + ("," + (show110(v2.value3) + ")")))))));
    }
    ;
  ...
  var betweenPath = function(to2) {
    return function(from4) {
      var v2 = sub1(initialLocation(from4))(terminalLocation(to2));
      var v1 = function() {
  ...
  var wirePath = function(ports) {
    ...
    var attrs = attr3(isConnected)(info3.connected);
    return {
      path: path3,
      gradient,
      attrs
  ...
  var portPath = function(info3) {
    var v2 = function() {
      var $5 = eq11(portType(info3.port))(Input.value);
      if ($5) {
    ...
    var headPath = function() {
      ...
      ;
      throw new Error("Failed pattern match at Component.Rendering.Port (line 35, column 16 - line 38, column 53): " + [v22.constructor.name, info3.connected.constructor.name]);
    }();
    ...
    return {
      ...
      attrs: attr3(isConnected)(info3.connected)
    };
  };
  ...
  var fromFoldable10 = /* @__PURE__ */ fromFoldable2(ordCardinalDirection);
  var fromFoldable14 = /* @__PURE__ */ fromFoldable10(foldableSet);
  var map45 = /* @__PURE__ */ map14(/* @__PURE__ */ ordTuple(ordCardinalDirection)(ordCardinalDirection));
  var fromFoldable23 = /* @__PURE__ */ fromFoldable5(foldableArray)(ordCardinalDirection);
  var elem1 = /* @__PURE__ */ elem(foldableMap)(eqPieceId);
  var fromFoldable33 = /* @__PURE__ */ fromFoldable10(foldableArray);
  var wirePieceNames = /* @__PURE__ */ function() {
    ...
    return fromFoldable2(ordSet2)(foldableArray)([new Tuple(up, "left-piece"), new Tuple(right2, "straight-piece"), new Tuple(down, "right-piece"), new Tuple(append17(up)(right2), "intersection-left-piece"), new Tuple(append17(up)(down), "intersection-junction-piece"), new Tuple(append17(right2)(down), "intersection-right-piece"), new Tuple(append17(up)(append17(right2)(down)), "super-piece")]);
  }();
  var mkWirePiece = /* @__PURE__ */ function() {
    var go2 = function(v2) {
      return function(unglob2) {
        var nameErr = function(v1) {
          return unsafeCrashWith("Can't find wire piece with outputs: " + show28(v2.outputs));
        };
          ...
          return {
            ...
            glob: function(dir2) {
              return function(portType2) {
                ...
                ;
                throw new Error("Failed pattern match at Game.Piece.WirePiece (line 77, column 32 - line 90, column 27): " + [dir2.constructor.name, portType2.constructor.name]);
              };
            },
            unglob: unglob2,
            isSimplifiable: function() {
              var connections = fromFoldable14(map45(function(out) {
  ...
  var fromFoldable11 = /* @__PURE__ */ fromFoldable3(foldableMaybe);
  ...
  var renderDefaultPiece = function(state3) {
    ...
    var allPorts = bind18(allDirections)(function(dir2) {
      ...
      return pure17(g([transform([new Rotate(toNumber(v2) * 90, 50, 50), new Translate(25, 0)])])(bind18(fromFoldable11(lookup15(dir2)(state3.portStates)))(function(portInfo) {
  ...
  var renderPiece = function(state3) {
    ...
    var animations = [];
    return svg([viewBox(0)(0)(100)(100)])([g(attributes)(append18([render5])(animations))]);
  };
  ...
  var map119 = /* @__PURE__ */ map(functorEffect);
  ...
  var component4 = function(dictMonadEffect) {
    ...
    var render5 = memoized(eq20)(function(state3) {
      ...
      handleAction: function(v1) {
        ...
        if (v1 instanceof OnMouseDown) {
          return bind19(getHTMLElementRef("piece"))(traverse_6(function(he) {
            return bind19(liftEffect11(map119(mul3(0.5))(clientWidth(toElement(he)))))(function(r) {
          ...
          return bind19(gets2(function(v2) {
            ...
            return bind19(gets2(function(v2) {
              ...
              return raise(new NewMultimeterFocus(function() {
                ...
                return bind23(lookup16(v1.value0)(portStates))(function(info3) {
                  return pure23({
                    relativeEdge,
                    info: info3
                  });
  ...
  var render = function(state3) {
    ...
    var pieces = bind110(range3(0)(n - 1 | 0))(function(i2) {
      return bind110(range3(0)(n - 1 | 0))(function(j) {
  ...
  var validBoardSize = function(dictMonadThrow) {
    ...
    return function(n) {
      ...
      if ($202) {
        return throwError4(new BadBoardSize(n));
      }
      ;
      return pure41(n);
    };
  ...
  var setBoardSize = function(dictMonadState) {
    ...
    return function(dictMonadError) {
      ...
      var throwError4 = throwError(MonadThrow0);
      return function(n) {
        return bind40(get4)(function(v2) {
          return bind40(validBoardSize1(n))(function(newSize) {
            ...
            if (firstPieceOusideSquare instanceof Just) {
              return throwError4(new LocationOccupied(firstPieceOusideSquare.value0));
            }
            ;
  ...
  var globRelEdge = function(dictMonadState) {
    ...
    var use3 = use(dictMonadState);
    var traverse_15 = traverse_(Monad0.Applicative0())(foldableMaybe);
    var assign4 = assign(dictMonadState);
    return function(v2) {
      return function(portType2) {
        return bind40(use3(function() {
          ...
          }())(glob(v2.dir)(portType2)(info3.piece));
        }));
      };
    };
  };
        ...
        return function(dst) {
          return bind40(use3(function() {
            ...
            if (v2 instanceof Just) {
              ...
              }())))(throwError4(new LocationOccupied(dst))))(function() {
            ...
            ;
            if (v2 instanceof Nothing) {
              return throwError4(new LocationNotOccupied(src10));
            }
            ;
  ...
  var getPieceInfo = function(dictMonadState) {
    ...
    return function(dictMonadError) {
      ...
      return function(loc) {
        ...
        }()))(maybe(throwError4(new LocationNotOccupied(loc)))(pure41));
      };
    };
  };
  ...
  var checkInsideBoard = function(dictMonadError) {
    ...
    return function(dictMonadState) {
      ...
      return function(loc) {
        return whenM3(map124(not3)(isInsideBoard2(loc)))(throwError4(new InvalidLocation(loc)));
      };
    };
  };
        ...
        return discard111(checkInsideBoard2(loc))(function() {
          return bind40(use3(function() {
            ...
            if (maybePieceInfo instanceof Nothing) {
              return throwError4(new LocationNotOccupied(loc));
            }
            ;
            ...
            return discard111(checkInsideBoard2(loc))(function() {
              return bind40(use3(function() {
                ...
                if (pieceInfo instanceof Just) {
                  return throwError4(new LocationOccupied(loc));
                }
                ;
  ...
  var fromFoldable16 = /* @__PURE__ */ fromFoldable5(foldableList)(ordCardinalDirection);
  ...
  var pathSegment = function(connections) {
    var $138 = size2(append20(keys2(connections))(fromFoldable16(values(connections)))) === (size(connections) * 2 | 0);
    if ($138) {
      return pure20(connections);
    }
    ;
    return throwError3(new InvalidPathSegment(connections));
  };
  var singlePath = function(from4) {
    return function(to2) {
      return pathSegment(singleton6(from4)(to2));
    };
  };
  var fromPiece = function(v2) {
    ...
    if (v1 instanceof Just && v1.value0 instanceof Connection) {
      return pathSegment(fromFoldable17(map48(f)(toUnfoldable8(v1.value0.value0))));
    }
    ;
    return throwError3(new NoSimplificationForPiece(v2.piece));
  };
  var combine = function(v2) {
    return function(v1) {
      var conn3 = union5(v2)(v1);
      return discard11(when4(isSubmap3(conn3)(v2) || isSubmap3(conn3)(v1))(throwError3(new CantCombinePathSegments(v2, v1))))(function() {
  ...
  var show30 = /* @__PURE__ */ show(showPathError);
  ...
  var liftBoardError = function(dictMonadError) {
    ...
    var $161 = lmap4(function($163) {
      return Other.create(show30($163));
    });
    return function($162) {
      return $160($161($162));
    };
            ...
            return function(segment2) {
              return bind118(use3(function() {
                ...
                return bind118(liftBoardError1(lmap4(PathSegmentError.create)(combineSegmentWithExtant(segment2)(extant))))(function(v2) {
                  return discard111(catchError2($$void13(removePieceNoUpdate2(loc)))(function(v1) {
                    return pure117(unit);
                  }))(function() {
  ...
  var button4 = function(me) {
    ...
    ;
    return unsafeCrashWith("No such button " + show31(v2));
  };
  ...
  var show32 = /* @__PURE__ */ show(/* @__PURE__ */ showMap2(showPort));
  ...
  var show33 = /* @__PURE__ */ show(showBoardError);
        ...
        function $tco_loop(v2) {
          ...
          if (v2 instanceof RemovePiece) {
            ...
            return bind111(liftBoardM(removePiece2(v2.value0)))(function(result) {
              return discard13(for_1(result)(function(info3) {
                return raise(new BoardEvent2(new RemovePieceEvent(v2.value0, info3)));
              }))(function() {
          ...
          if (v2 instanceof SetGoalPorts) {
            $tco_done = true;
            return discard13(lift9(debug3(tag("boardPorts")(show32(v2.value0)))("Set goal ports on board")))(function() {
      ...
      var handleAction = function(v2) {
        if (v2 instanceof Initialise) {
          return bind111(liftEffect4(globalKeyDownEventEmitter))(function(emitter) {
            return discard13($$void9(subscribe2(map310(GlobalOnKeyDown.create)(emitter))))(function() {
        ...
        if (v2 instanceof MultimeterOutput) {
          return discard13($$void9(liftBoardM(capacityRipple2(v2.value0.value0)(v2.value0.value1))))(function() {
            return bind111(gets3(function(v12) {
              return v12.lastEvalWithPortInfo;
            }))(function(signals) {
              var focus3 = bind25(lookup17(v2.value0.value0)(signals))(function(info3) {
                return pure111({
                  info: info3,
            ...
            return bind111(gets3(function(v12) {
              ...
              return bind111(map51(buildEvaluableBoard2(boardPorts))(use2(_board2)))(function(eitherEvaluable) {
                if (eitherEvaluable instanceof Left) {
                  return lift9(warn3(empty2)("Unable to build EvaluableBoard, BoardError: " + show33(eitherEvaluable.value0)));
                }
                ;
                if (eitherEvaluable instanceof Right) {
                  ...
                  return discard13(lift9(debug3(union6(tag("inputs")(show42(inputs)))(tag("outputs")(show42(v12.value0))))("Evaluating board")))(function() {
                    return discard13(lift9(debug3(foldrWithIndex2(function(relEdge) {
                      return function(info3) {
                        return insert13(show52(relEdge))(new StringTag(show62(info3)));
                      };
        ...
        if (v2 instanceof GlobalOnKeyDown) {
          ...
          if (v1 === "z") {
            return when5(ctrlKey(v2.value0))($$void9(handleQuery(new Undo(unit))));
          }
          ;
          if (v1 === "y") {
            return when5(ctrlKey(v2.value0))($$void9(handleQuery(new Redo(unit))));
          }
          ;
          if (v1 === "e") {
  ...
  var component7 = function(dictMonadAff) {
    var render5 = function(state3) {
      if (state3.isShowing) {
        return div5([id2("demonstration-component")])([div_(join5([[h2_([text(state3.demonstration.title)])], map52(fromPlainHTML)(state3.demonstration.html), [button2([onClick(function(v2) {
  ...
  var render2 = function(v2) {
    var renderAvailablePiece = function(piece) {
      ...
      })(renderPiece(pieceState)), text(show34(pieceId2))]);
    };
    ...
    ;
    return div5([id2("selector-component")])([span4([class_("pieces")])(map54(renderAvailablePiece)(fromFoldable18(v2.availablePieces))), h2_([text("Available pieces")])]);
  };
  ...
  var Initialise2 = /* @__PURE__ */ function() {
    function Initialise5(value0) {
      this.value0 = value0;
    }
    ;
    Initialise5.create = function(value0) {
      return new Initialise5(value0);
    };
    return Initialise5;
  }();
  ...
  var component9 = function(dictMonadAff) {
    ...
    var render5 = function(state3) {
      var title4 = text("Board size: " + show35(state3.boardSize));
      var html2 = span_([input([type_19(InputRange.value), list("values"), min5(3), max6(9), step3(new Step(2)), value13(show35(state3.boardSize)), onInput($$const(InputRangeChange.value)), onMouseUp($$const(InputRangeMouseUp.value))]), datalist([id2("values")])([option([value13("3")])([]), option([value13("5")])([]), option([value13("7")])([]), option([value13("9")])([])])]);
  ...
  var fromFoldable19 = /* @__PURE__ */ fromFoldable3(foldableNonEmptyArray);
  ...
  var initialState4 = function(v2) {
    var testCases = fromFoldable19(flip(map122)(v2.inputs)(function(i2) {
      return {
        data: {
          inputs: i2,
  ...
  var fromFoldable20 = /* @__PURE__ */ fromFoldable3(foldableMap);
  ...
  var render3 = function(state3) {
    var renderRunCurrentTestButton = function() {
      if (state3.testSuiteFailed) {
        ...
        })])([text("Rerun test " + show36(state3.currentIndex + 1 | 0))]);
      }
      ;
      return text("");
    }();
    ...
    var renderRow = function(testIndex) {
      return function(testCase) {
        ...
        var renderSignals = function(signals) {
          return fromFoldable20(flip(mapWithIndex4)(signals)(function(dir2) {
            return function(signal) {
        ...
        return tr([class_("test-case"), attr3(testCaseStatus)(testCase.status)])(join6([[td_([text(show36(testIndex + 1 | 0))])], renderInputs, renderExpected, renderReceived, [renderStatus]]));
      };
    };
    var renderRows = function() {
      ...
      var relevantTestCases = slice2(start2)(end3)(fromFoldable110(state3.testCases));
    ...
    var headers = function() {
      var subheaders = mapFlipped6(append111([""])(map56(show112)(append111(inputDirs)(append111(outputDirs)(outputDirs)))))(function(s2) {
    ...
    var footers = function() {
      ...
      return tfoot_([tr_([td([colSpan2((1 + numInputs | 0) + (2 * numOutputs | 0) | 0)])([text("Tests Complete:")]), td_([text(show36(testsPassed) + ("/" + show36(length4(state3.testCases))))])])]);
    }();
    var colgroup2 = colgroup_(join6([replicate(1)(col([class_("test-case-index")])), replicate(numInputs)(col([class_("test-case-input")])), replicate(numOutputs)(col([class_("test-case-expected")])), replicate(numOutputs)(col([class_("test-case-recieved")])), replicate(1)(col([class_("test-case-status")]))]));
  ...
  var component10 = function(dictMonadAff) {
    ...
    var $$eval3 = mkEval({
      ...
      handleQuery,
      receive: function($51) {
        return Just.create(Receive4.create($51));
      }
    });
    return mkComponent({
      "eval": $$eval3,
  ...
  // output/Game.Piece.BinaryAssociativePiece/index.js
  var zero8 = /* @__PURE__ */ zero(semiringSignal);
  var map57 = /* @__PURE__ */ map(functorNonEmptyArray);
  var lookup20 = /* @__PURE__ */ lookup2(ordCardinalDirection);
  var fromFoldable21 = /* @__PURE__ */ fromFoldable4(foldableSet);
  var union7 = /* @__PURE__ */ union2(ordCardinalDirection);
  var voidLeft6 = /* @__PURE__ */ voidLeft(functorMap);
  var eq24 = /* @__PURE__ */ eq(eqCardinalDirection);
  var member4 = /* @__PURE__ */ member2(ordCardinalDirection);
  var insert14 = /* @__PURE__ */ insert3(ordCardinalDirection);
  ...
  var $$delete8 = /* @__PURE__ */ $$delete4(ordCardinalDirection);
  var fromFoldable111 = /* @__PURE__ */ fromFoldable5(foldableArray)(ordCardinalDirection);
  var mkBinaryAssociativePiece = /* @__PURE__ */ function() {
    var go2 = function(v2) {
      return function(unglob2) {
        return defer2(function(v1) {
          return {
            name: v2.name,
            "eval": function(m2) {
              var inputSignals = maybe(singleton8(zero8))(map57(function(d2) {
                return fromMaybe(zero8)(lookup20(d2)(m2));
              }))(fromFoldable21(v2.inputs));
              return singleton6(Right2.value)(foldl12(v2.op)(inputSignals));
            },
            ports: union7(singleton6(Right2.value)(outputPort(v2.capacity)))(voidLeft6(toMap(v2.inputs))(inputPort(v2.capacity))),
            complexity: space(1),
            shouldRipple: true,
            updateCapacity: function(dir2) {
              return function(capacity$prime) {
                var $29 = eq24(dir2)(Right2.value) || member4(dir2)(v2.inputs);
                if ($29) {
                  return new Just(force(go2({
                    name: v2.name,
                    op: v2.op,
            ...
            glob: function(dir2) {
              return function(portType2) {
                ...
                ;
                if (portType2 instanceof Just && portType2.value0 instanceof Output) {
                  var newInputs = insert14(dir2)(v2.inputs);
                  return discard17(guard6(!member4(dir2)(v2.inputs)))(function() {
                    return pure31(force(go2({
                      name: v2.name,
                      op: v2.op,
                      capacity: v2.capacity,
                      inputs: newInputs
                ...
                ;
                if (portType2 instanceof Nothing) {
                  var newInputs = $$delete8(dir2)(v2.inputs);
                  return discard17(guard6(!member4(dir2)(getInputDirs(force(unglob2)))))(function() {
                    return pure31(force(go2({
                      name: v2.name,
                      op: v2.op,
                      capacity: v2.capacity,
                ...
                ;
                throw new Error("Failed pattern match at Game.Piece.BinaryAssociativePiece (line 48, column 32 - line 58, column 72): " + [dir2.constructor.name, portType2.constructor.name]);
              };
            },
            unglob: unglob2,
            isSimplifiable: Nothing.value
    ...
    var $38 = fix(lazyLazy);
    return function($39) {
      return force($38(go2($39)));
    };
  }();
  var orPiece = /* @__PURE__ */ function() {
    return mkBinaryAssociativePiece({
      name: "or-piece",
      op: disj(heytingAlgebraSignal),
      inputs: fromFoldable111([Left2.value, Up.value]),
      capacity: OneBit.value
    });
  }();
  ...
  var andPiece = /* @__PURE__ */ function() {
    return mkBinaryAssociativePiece({
      name: "and-piece",
      op: conj(heytingAlgebraSignal),
      inputs: fromFoldable111([Left2.value, Up.value]),
      capacity: OneBit.value
    });
  }();
  var allBinaryAssociativePieces = [orPiece, andPiece, xorPiece];
  ...
  var mkSeverPiece = function(v2) {
    return mkPieceNoGlob({
      ...
      "eval": function(inputs) {
        ...
        return fromFoldable25([new Tuple(Up.value, v1.value0), new Tuple(Down.value, v1.value1)]);
      },
      ports: fromMaybe(empty2)(bind31(doubleCapacity(v2.outputCapacity))(function(inputCapacity) {
        return pure32(fromFoldable25([new Tuple(Left2.value, inputPort(inputCapacity)), new Tuple(Up.value, outputPort(v2.outputCapacity)), new Tuple(Down.value, outputPort(v2.outputCapacity))]));
      })),
      complexity: space(1),
      shouldRipple: true,
      updateCapacity: function(dir2) {
  ...
  var mkFusePiece = function(v2) {
    return mkPieceNoGlob({
      ...
      ports: fromMaybe(empty2)(bind31(doubleCapacity(v2.inputCapacity))(function(outputCapacity) {
        return pure32(fromFoldable25([new Tuple(Up.value, inputPort(v2.inputCapacity)), new Tuple(Down.value, inputPort(v2.inputCapacity)), new Tuple(Right2.value, outputPort(outputCapacity))]));
      })),
      complexity: space(1),
      shouldRipple: true,
      updateCapacity: function(dir2) {
  ...
  var fromFoldable26 = /* @__PURE__ */ fromFoldable2(ordCardinalDirection)(foldableArray);
  var greaterThan2 = /* @__PURE__ */ greaterThan(uintOrd);
  var zero1 = /* @__PURE__ */ zero(uintSemiring);
  var one4 = /* @__PURE__ */ one(uintSemiring);
  var add3 = /* @__PURE__ */ add(uintSemiring);
  var mkUnaryOperation = function(v2) {
    return mkPieceNoGlob({
      name: v2.name,
      "eval": function(inputs) {
        var signal = fromMaybe(zero9)(lookup23(Left2.value)(inputs));
        return singleton6(Right2.value)(overSignal(v2.operation)(signal));
      },
      ports: fromFoldable26([new Tuple(Left2.value, inputPort(v2.capacity)), new Tuple(Right2.value, outputPort(v2.capacity))]),
      complexity: space(1),
      shouldRipple: false,
      updateCapacity: function(v1) {
        return function(v22) {
  ...
  var twoBitCrossOverPiece = /* @__PURE__ */ function() {
    return mkUnaryOperation({
      ...
      operation: function(n) {
        ...
        return add3(shl(b1)(one4))(b0);
      },
      shouldRipple: false
    });
  }();
  var constPiece = function(value14) {
    return mkUnaryOperation({
      name: "not-piece",
      capacity: OneBit.value,
      operation: $$const(value14),
      shouldRipple: false
    });
  };
  var allUnaryOperationPieces = [notPiece, twoBitCrossOverPiece];

  // output/Game.Piece/index.js
  var append21 = /* @__PURE__ */ append(semigroupArray);
  var show37 = /* @__PURE__ */ show(showPieceId);
  var lookup24 = /* @__PURE__ */ lookup2(ordPieceId);
  var allPieces = /* @__PURE__ */ append21(allWirePieces)(/* @__PURE__ */ append21(allFusePieces)(/* @__PURE__ */ append21(allBinaryAssociativePieces)(allUnaryOperationPieces)));
  ...
  var pieceLookup = function(pieceId2) {
    var message2 = "piece lookup crash on " + (show37(pieceId2) + "... WITH NO SURVIVORS");
  ...
  var eq25 = /* @__PURE__ */ eq(eqBase);
  var member5 = /* @__PURE__ */ member(ordPieceId);
  var fromFoldable27 = /* @__PURE__ */ fromFoldable3(foldableList);
  var map58 = /* @__PURE__ */ map(functorList);
  ...
  var show39 = /* @__PURE__ */ show(showPortType);
  var slot11 = /* @__PURE__ */ slot3();
  var slot1 = /* @__PURE__ */ slot11({
    reflectSymbol: function() {
      return "testRunner";
    }
  })(ordUnit);
  var slot22 = /* @__PURE__ */ slot11({
    reflectSymbol: function() {
  ...
  var render4 = function(dictMonadAff) {
    ...
    return function(state3) {
      ...
      var renderTitle = h1([class_("title")])([text(state3.level.title)]);
      var renderSubtitle = function() {
        if (state3.level.subtitle instanceof Just) {
          return h3([class_("subtitle")])([text(state3.level.subtitle.value0)]);
        }
        ;
        if (state3.level.subtitle instanceof Nothing) {
          return text("");
        }
        ;
        throw new Error("Failed pattern match at Component.Sidebar.Render (line 62, column 22 - line 67, column 28): " + [state3.level.subtitle.constructor.name]);
      }();
        ...
        var signalRepresentationOption = function(base2) {
          return function(text7) {
            return span4([onClick(ButtonClicked.create(new Base(base2)))])(function() {
              var $28 = eq25(state3.level.options.base)(base2);
              if ($28) {
      ...
      var renderRunDemonstration = function() {
        ...
        var $29 = isJust(state3.level.demonstration);
        if ($29) {
      ...
      var renderDescription = function() {
        ...
        var $82 = span4([class_("description")]);
        var $83 = map58(asHTML);
        var $84 = map58(filterPieceNames);
        var $85 = split(" ");
        return function($86) {
          return $82(fromFoldable27($83(reduceStrings($84(fromFoldable112($85($86)))))));
        };
      }();
      var renderCompletionStatus = function() {
        var renderTestSuccess = function(i2) {
          return function(n) {
            return span_([green2(show38(i2) + ("/" + show38(n))), text(" Sucessful")]);
          };
        };
        var describePort = function(v2) {
          return "an " + function() {
            var $55 = eq112(v2.portType)(Input.value);
            if ($55) {
              return "input";
            }
            ;
            return "output" + (" of capacity " + show38(toInt(v2.capacity)));
          }();
        };
        return div5([class_("completion-status")])(function() {
          ...
          ;
          if (state3.completionStatus instanceof FailedValidation) {
            return [h2_([text("Restriction!")]), h3_([text(state3.completionStatus.value0.description)])];
          }
          ;
          ...
          if (state3.completionStatus instanceof PortMismatch) {
            return [h2_([text("Port mismatch")]), function() {
              ...
              if (state3.completionStatus.value0 instanceof IncorrectPortType) {
                return text("Port in the " + (show211(state3.completionStatus.value0.value0.direction) + (" direction should be an " + show39(state3.completionStatus.value0.value0.expected))));
              }
              ;
              if (state3.completionStatus.value0 instanceof IncorrectCapacity) {
                return text("Port in the " + (show211(state3.completionStatus.value0.value0.direction) + (" direction should have capacity " + show38(toInt(state3.completionStatus.value0.value0.expected)))));
              }
              ;
              throw new Error("Failed pattern match at Component.Sidebar.Render (line 99, column 15 - line 103, column 187): " + [state3.completionStatus.value0.constructor.name]);
            }()];
          }
          ;
          if (state3.completionStatus instanceof ReadyForTesting) {
            return [h2_([text("Testing")]), slot1(slot10)(unit)(component16)({
              base: state3.level.options.base,
              inputs: state3.level.testCases,
              model: state3.level.goal
            })(TestRunnerAction.create)];
          }
          ;
          if (state3.completionStatus instanceof Completed2) {
            return [h2_([text("Level Complete!")]), slot1(slot10)(unit)(component16)({
              base: state3.level.options.base,
              inputs: state3.level.testCases,
              model: state3.level.goal
          ...
          ;
          throw new Error("Failed pattern match at Component.Sidebar.Render (line 88, column 9 - line 120, column 14): " + [state3.completionStatus.constructor.name]);
        }());
      }();
      ...
      return div5([id2("sidebar-component")])([div_([renderTitle, renderSubtitle, renderDescription(state3.level.description)]), renderCompletionStatus, renderRunDemonstration, function() {
        if (state3.level.options.enableBoardSizeChange) {
          return slot22(slot8)(unit)(component17)({
            boardSize: state3.boardSize
          })(BoardSizeSliderAction.create);
        }
        ;
        return text("");
      }(), renderUndoRedo, renderClear, renderSignalRepresentation, renderGiveUp]);
    };
  };
  ...
  var for_5 = /* @__PURE__ */ for_(applicativeHalogenM)(foldableArray);
      ...
      handleAction: function(v2) {
        if (v2 instanceof Receive3) {
          return discard19(put4(initialState3(v2.value0)))(function() {
            return discard19(tell1(slot8)(unit)(AmendBoardSizeSlider.create(v2.value0.boardSize)))(function() {
              if (v2.value0.completionStatus instanceof FailedValidation) {
                return for_5(v2.value0.completionStatus.value0.locations)(function(loc) {
                  return headShake3(selector(location3)(loc));
                });
              }
              ;
              return pure33(unit);
        ...
        ;
        throw new Error("Failed pattern match at Component.Sidebar (line 49, column 21 - line 67, column 31): " + [v2.constructor.name]);
      },
      handleQuery: function(v2) {
        ...
        if (v2 instanceof TestCaseResponse) {
          return discard19(tell22(slot10)(unit)(TestCaseOutcome.create(v2.value0)))(function() {
            return pure33(new Just(v2.value1));
          });
        }
        ;
        throw new Error("Failed pattern match at Component.Sidebar (line 68, column 20 - line 75, column 27): " + [v2.constructor.name]);
      },
      initialize: Nothing.value,
      receive: function($50) {
        return Just.create(Receive3.create($50));
      }
    });
    return mkComponent({
      "eval": $$eval3,
  ...
  var slot13 = /* @__PURE__ */ slot12(boardIsSymbol)(ordUnit);
  var sidebarIsSymbol = {
    reflectSymbol: function() {
      return "sidebar";
    }
  };
  var slot23 = /* @__PURE__ */ slot12(sidebarIsSymbol)(ordUnit);
  var slot32 = /* @__PURE__ */ slot12({
    reflectSymbol: function() {
      return "selector";
    }
  })(ordUnit);
  ...
  var liftEffect12 = /* @__PURE__ */ liftEffect(/* @__PURE__ */ monadEffectHalogenM(monadEffectAppM));
  ...
  var component12 = /* @__PURE__ */ function() {
    var render5 = function(v2) {
      ...
      return div5([id2("puzzle-component")])([slot13(slot)(unit)(component6)({
        board: standardBoard
      })(BoardOutput.create), slot23(slot9)(unit)(component11)(sidebarInput)(SidebarOutput.create), slot32(slot7)(unit)(component8)({
        availablePieces: v2.level.availablePieces
      })(SelectorOutput.create), fromMaybe(text(""))(map59(slot_2(slot6)(unit)(component1))(v2.level.demonstration))]);
    };
    var initialState5 = function(v2) {
      return {
        levelId: v2.levelId,
    ...
    var handleAction = function($copy_v) {
      ...
      function $tco_loop(v2) {
        ...
        if (v2 instanceof BoardOutput) {
          if (v2.value0 instanceof NewBoardState) {
            ...
            return bind33(gets6(function(v1) {
              ...
              var completionStatus = isReadyForTesting(level2)(v2.value0.value0);
              return modify_9(function(v1) {
                ...
                ;
                $102.completionStatus = isReadyForTesting(level2)(v2.value0.value0);
                $102.boardSize = viewOn(v2.value0.value0)(_size4);
                $102.boardPorts = evalState(getBoardPorts3)(v2.value0.value0);
                return $102;
              });
            });
          }
          ...
          ;
          throw new Error("Failed pattern match at Component.Level (line 154, column 32 - line 166, column 47): " + [v2.value0.constructor.name]);
        }
        ;
        if (v2 instanceof SidebarOutput) {
            ...
            return bind33(request2(slot)(unit)(SetBoardSize.create(v2.value0.value0.value0)))(function(v1) {
              if (v1 instanceof Just && v1.value0 instanceof Right) {
                return modify_9(function(v22) {
                  ...
                  ;
                  $111.boardSize = v2.value0.value0.value0;
                  return $111;
                });
              }
              ;
              if (v1 instanceof Just && v1.value0 instanceof Left) {
                return bind33(gets6(function(v22) {
                  ...
                  return tell32(slot9)(unit)(AmendBoardSizeSlider2.create(size6));
                });
              }
              ;
              if (v1 instanceof Nothing) {
              ...
              ;
              throw new Error("Failed pattern match at Component.Level (line 174, column 62 - line 179, column 31): " + [v1.constructor.name]);
            });
          }
          ;
          if (v2.value0 instanceof ButtonOutput) {
            if (v2.value0.value0 instanceof AddPiece3) {
              $tco_done = true;
              return bind33(request2(slot)(unit)(GetBoard.create))(traverse_8(function(board) {
            ...
            if (v2.value0.value0 instanceof Base) {
              ...
              return modify_9(function(v1) {
                ...
                $128.level = function() {
                  var $125 = {};
                  for (var $126 in v1.level) {
                    if ({}.hasOwnProperty.call(v1.level, $126)) {
                      $125[$126] = v1["level"][$126];
                    }
                    ;
                  }
                  ;
                  $125.options = function() {
                    var $122 = {};
                    for (var $123 in v1.level.options) {
                      if ({}.hasOwnProperty.call(v1.level.options, $123)) {
                        $122[$123] = v1["level"]["options"][$123];
                      }
                      ;
                    }
                    ;
                    $122.base = v2.value0.value0.value0;
                    return $122;
                  }();
                  return $125;
                }();
            ...
            ;
            throw new Error("Failed pattern match at Component.Level (line 180, column 38 - line 197, column 44): " + [v2.value0.value0.constructor.name]);
          }
          ;
          if (v2.value0 instanceof TestRunnerOutput) {
            if (v2.value0.value0 instanceof TestCaseData) {
              $tco_done = true;
              return discard22(bind33(request2(slot)(unit)(RunTestCase.create(v2.value0.value0.value0)))(traverse_8(function(outcome) {
                return tell32(slot9)(unit)(TestCaseResponse.create(outcome));
              })))(function() {
                return pure34(unit);
              });
            }
            ...
            if (v2.value0.value0 instanceof AllTestsPassed) {
              ...
              return modify_9(function(v1) {
                ...
                ;
                $135.completionStatus = Completed2.value;
                return $135;
              });
            }
            ;
            throw new Error("Failed pattern match at Component.Level (line 198, column 42 - line 204, column 65): " + [v2.value0.value0.constructor.name]);
          }
          ;
          throw new Error("Failed pattern match at Component.Level (line 168, column 36 - line 204, column 65): " + [v2.value0.constructor.name]);
        }
        ;
        if (v2 instanceof SelectorOutput) {
          ...
          ;
          throw new Error("Failed pattern match at Component.Level (line 207, column 30 - line 216, column 38): " + [v2.value0.constructor.name]);
        }
        ;
        throw new Error("Failed pattern match at Component.Level (line 131, column 18 - line 216, column 38): " + [v2.constructor.name]);
      }
      ;
      while (!$tco_done) {
        $tco_result = $tco_loop($copy_v);
  ...
  var one5 = /* @__PURE__ */ one(semiringSignal);
  var pure113 = /* @__PURE__ */ pure(applicativeArray);
  var fromFoldable28 = /* @__PURE__ */ fromFoldable2(ordCardinalDirection)(foldableArray);
  var toLevelSuite = function(dictFunctor) {
    var map65 = map(dictFunctor);
    return function(dictFoldable) {
      var $16 = fromFoldable6(dictFoldable);
      var $17 = map65(function(level2) {
        return new Tuple(level2.title, level2);
      });
      return function($18) {
        return $16($17($18));
      };
  ...
  var defaultLevel = /* @__PURE__ */ function() {
    return {
      goal: idPiece,
      title: "default title",
  ...
  var binaryTestInputs = function(directions) {
    return bind34(traverse4(function(v2) {
      ...
      return pure113(fromFoldable28(zip(directions)(inputs)));
    });
  };

  // output/Resources.LevelSuites.IntermediateSuite/index.js
  var fromFoldable29 = /* @__PURE__ */ fromFoldable5(foldableArray)(ordPiece);
  var intermediateSuite = /* @__PURE__ */ function() {
    var xorLevel = {
      demonstration: defaultLevel.demonstration,
      options: defaultLevel.options,
      requiresAutomaticTesting: defaultLevel.requiresAutomaticTesting,
      subtitle: defaultLevel.subtitle,
      validate: defaultLevel.validate,
      goal: xorPiece,
      ...
      availablePieces: fromFoldable29([idPiece, notPiece, orPiece, andPiece, crossPiece])
    };
    var crissCrossLevel = {
      demonstration: defaultLevel.demonstration,
      options: defaultLevel.options,
      ...
      testCases: binaryTestInputs([Left2.value, Up.value]),
      availablePieces: fromFoldable29([xorPiece])
    };
    return toLevelSuite(functorArray)(foldableArray)([crissCrossLevel, xorLevel]);
  }();

  // output/Game.Level.Demonstration/index.js
  var type_20 = /* @__PURE__ */ type_17(isPropMediaType);
  var videoDemonstration = function(v2) {
    var html2 = [video([controls2(false), autoplay2(true), muted2(true), loop2(true)])([source([src9(v2.videoUrl), type_20("video/mp4")])])];
    return {
      title: v2.title,
      html: html2,
  ...
  // output/Game.Level.LevelValidator/index.js
  var lookup25 = /* @__PURE__ */ lookup2(ordLocation);
  var when8 = /* @__PURE__ */ when(applicativeEither);
  var fromFoldable30 = /* @__PURE__ */ fromFoldable3(foldableList);
  var validateLocations = function(description) {
    return function(pred2) {
      return function(v2) {
        var locations = filter(function(loc) {
          return pred2(loc)(lookup25(loc)(v2.pieces));
        })(allLocations(v2));
        return when8(!$$null(locations))(new Left({
          description,
          locations: fromFoldable30(locations)
        }));
      };
    };
  };
  var validatePieces = function(description) {
    return function(pred2) {
      return validateLocations(description)(function(v2) {
        return maybe(true)(function(p2) {
          return pred2(p2.piece);
        });
      });
    };
  };

  // output/Resources.LevelSuites.TutorialSuite/index.js
  var fromFoldable31 = /* @__PURE__ */ fromFoldable5(foldableArray)(ordPiece);
  var elem7 = /* @__PURE__ */ elem2(eqPieceId);
  var tutorialSuite = /* @__PURE__ */ function() {
    ...
    var orLevel = {
      ...
      testCases: binaryTestInputs([Left2.value, Up.value]),
      availablePieces: fromFoldable31([orPiece]),
      options: options2
    };
    var notLevel = {
      requiresAutomaticTesting: defaultLevel.requiresAutomaticTesting,
      ...
      availablePieces: fromFoldable31([notPiece]),
      options: options2
    };
    var leftLevel = {
      demonstration: defaultLevel.demonstration,
      ...
      testCases: binaryTestInputs([Left2.value]),
      availablePieces: fromFoldable31([idPiece, orPiece]),
      validate: validatePieces("You can only use the straight and or pieces!")(function(piece) {
        return elem7(name2(piece))([name2(idPiece), name2(orPiece)]);
      }),
      options: options2
    };
    var identityLevel = {
      ...
      testCases: binaryTestInputs([Left2.value]),
      availablePieces: fromFoldable31([]),
      options: options2
    };
    var fullSendLevel = {
      subtitle: defaultLevel.subtitle,
      demonstration: defaultLevel.demonstration,
      requiresAutomaticTesting: defaultLevel.requiresAutomaticTesting,
      availablePieces: defaultLevel.availablePieces,
      validate: defaultLevel.validate,
      options: defaultLevel.options,
      goal: idPiece,
      title: "No vacancies!",
    ...
    var chickenLevel = {
      ...
      goal: chickenPiece,
      title: "The Chicken",
      subtitle: new Just("It\u2019s electrifyin\u2019!"),
    ...
    var alwaysOnLevel = {
      ...
      requiresAutomaticTesting: defaultLevel.requiresAutomaticTesting,
      validate: defaultLevel.validate,
      goal: constPiece(complement(zero(uintSemiring))),
      title: "Always on",
      subtitle: new Just("A Hanukkah miracle"),
      description: "Regardless of the input on the left, the output on the right should always be on. Don't let the flame go out!",
      testCases: binaryTestInputs([Left2.value]),
      availablePieces: fromFoldable31([notPiece, orPiece, andPiece]),
      options: options2
    };
    return toLevelSuite(functorArray)(foldableArray)([identityLevel, notLevel, orLevel, leftLevel, chickenLevel, alwaysOnLevel]);
  }();

  // output/Resources.LevelSuites/index.js
  var join7 = /* @__PURE__ */ join(bindArray);
  ...
  var fromFoldable34 = /* @__PURE__ */ fromFoldable2(ordRecord2)(foldableArray);
  var catMaybes6 = /* @__PURE__ */ catMaybes2(ordRecord2);
  var toUnfoldable9 = /* @__PURE__ */ toUnfoldable5(unfoldableArray);
  var allLevelSuites = /* @__PURE__ */ fromHomogeneous()({
  ...
  var getAllLevelProgress = function(dictMonadEffect) {
    ...
    return map65(function($37) {
      return catMaybes6(fromFoldable34(join7($37)));
  ...
  var fromFoldable35 = /* @__PURE__ */ fromFoldable3(foldableObject);
  ...
  var component13 = function(dictMonadAff) {
    ...
    var liftEffect11 = liftEffect(monadEffectHalogenM3);
    var log6 = log4(monadEffectHalogenM3);
    var saveLevelProgress2 = saveLevelProgress(monadEffectHalogenM3);
    var navigateTo3 = navigateTo(monadEffectHalogenM3);
    var render5 = function(state3) {
      ...
      return defaultLayout(div5([id2("puzzle-select-component")])([h1_([text("Level Select")]), div5([id2("level-suites")])(fromFoldable35(mapWithIndex5(renderLevelSuite)(allLevelSuites)))]));
    };
    var initialState5 = function(v2) {
      return {
  ...
  var notEq8 = /* @__PURE__ */ notEq(eqRoute);
    ...
    var $$eval3 = mkEval({
      ...
      handleQuery: function(v2) {
        return bind114(get3)(function(v1) {
          return discard23(when9(notEq8(v1.route)(v2.value0))(discard23(lift11(debug5(empty2)("Navigated to " + show43(v2.value0))))(function() {
            ...
            return pure114(new Just(v2.value1));
          });
        });
      },
      initialize: Nothing.value,
  ...
  var runHalogenAff = /* @__PURE__ */ runAff_(/* @__PURE__ */ either(throwException)(/* @__PURE__ */ $$const(/* @__PURE__ */ pure115(unit))));
  ...
  var renderStateX_ = function(dictApplicative) {
    var traverse_15 = traverse_(dictApplicative)(foldableMaybe);
    return function(f) {
      return unDriverStateX(function(st) {
        return traverse_15(f)(st.rendering);
      });
    };
  };
  ...
  var unsubscribe3 = function(sid) {
    return function(ref3) {
      return function __do5() {
        ...
        return traverse_9(unsubscribe)(bindFlipped10(lookup27(sid))(subs))();
      };
    };
  };
      ...
      return discard110(liftEffect7(write2({
        ...
        return bind115(liftEffect7(f))(function(result) {
          return bind115(liftEffect7(read2(lchs)))(function(v2) {
            return discard110(traverse_22(fork3)(v2.finalizers))(function() {
  ...
  var evalQ = function(render5) {
    return function(ref3) {
      return function(q3) {
        return bind115(liftEffect7(read2(ref3)))(function(v2) {
          return evalM(render5)(ref3)(v2["component"]["eval"](new Query(map61(Just.create)(liftCoyoneda(q3)), $$const(Nothing.value))));
        });
      };
    };
  };
              ...
              return bind115(liftEffect7(read2(ref3)))(function(v22) {
                ...
                if (otherwise) {
                  return discard110(liftEffect7(write2({
                    ...
                    return discard110(handleLifecycle(v22.lifecycleHandlers)(render5(v22.lifecycleHandlers)(ref3)))(function() {
                      return pure38(v3.value0);
                    });
                  });
                }
  ...
  var voidLeft7 = /* @__PURE__ */ voidLeft(functorEffect);
  ...
  var cleanupSubscriptionsAndForks = function(v2) {
    return function __do5() {
      bindFlipped11(traverse_23(traverse_33(unsubscribe)))(read2(v2.subscriptions))();
          ...
          return function(handler3) {
            return function(childrenInRef) {
              return function(childrenOutRef) {
                return unComponentSlot(function(slot14) {
                  return function __do5() {
                    var childrenIn = map62(slot14.pop)(read2(childrenInRef))();
                    var $$var2 = function() {
                        ...
                        unDriverStateX(function(st) {
                          return function __do6() {
                            flip(write2)(st.handlerRef)(function() {
                              var $65 = maybe(pure116(unit))(handler3);
                              return function($66) {
                                return $65(slot14.output($66));
                              };
                            }())();
                            return handleAff(evalM(render5)(st.selfRef)(st["component"]["eval"](new Receive(slot14.input, unit))))();
                          };
                        })(dsx)();
                      ...
                      if (childrenIn instanceof Nothing) {
                        return runComponent(lchs)(function() {
                          var $67 = maybe(pure116(unit))(handler3);
                          return function($68) {
                            return $67(slot14.output($68));
                          };
                        }())(slot14.input)(slot14.component)();
                      }
                      ;
                      throw new Error("Failed pattern match at Halogen.Aff.Driver (line 213, column 14 - line 222, column 98): " + [childrenIn.constructor.name]);
                    }();
                    var isDuplicate = map62(function($69) {
                      return isJust(slot14.get($69));
                    ...
                    modify_(slot14.set($$var2))(childrenOutRef)();
          ...
          return function($$var2) {
            return function __do5() {
              ...
              var handler3 = function() {
                ...
                var $71 = evalF(render5)(v2.selfRef);
                return function($72) {
              ...
              return when10(shouldProcessHandlers)(flip(tailRecM4)(unit)(function(v1) {
                return function __do6() {
                  ...
                  if ($52) {
                    return voidLeft7(write2(Nothing.value)(v2.pendingHandlers))(new Done(unit))();
                  }
                  ;
      ...
      return function(document3) {
        ...
        var buildWidget2 = function(spec) {
          ...
          var $lazy_patch = $runtime_lazy13("patch", "Halogen.VDom.Driver", function() {
            return function(st, slot14) {
              if (st instanceof Just) {
                if (slot14 instanceof ComponentSlot) {
                  halt(st.value0);
                  return $lazy_renderComponentSlot(100)(slot14.value0);
                }
                ;
                if (slot14 instanceof ThunkSlot) {
                  var step$prime = step(st.value0, slot14.value0);
                  return mkStep(new Step2(extract2(step$prime), new Just(step$prime), $lazy_patch(103), done));
                }
                ;
                throw new Error("Failed pattern match at Halogen.VDom.Driver (line 97, column 22 - line 103, column 79): " + [slot14.constructor.name]);
              }
              ;
              return $lazy_render(104)(slot14);
            };
          });
          var $lazy_render = $runtime_lazy13("render", "Halogen.VDom.Driver", function() {
            return function(slot14) {
              if (slot14 instanceof ComponentSlot) {
                return $lazy_renderComponentSlot(86)(slot14.value0);
              }
              ;
              if (slot14 instanceof ThunkSlot) {
                var step5 = buildThunk2(slot14.value0);
                return mkStep(new Step2(extract2(step5), new Just(step5), $lazy_patch(89), done));
              }
              ;
              throw new Error("Failed pattern match at Halogen.VDom.Driver (line 84, column 7 - line 89, column 75): " + [slot14.constructor.name]);
            };
          });
            ...
            return function(v1) {
              ...
              if (v1 instanceof Just) {
                return function __do5() {
                  ...
                  when11(not4(unsafeRefEq)(v1.value0.node)(newNode))(substInParent(newNode)(nextSib)(parent2))();
                  return {
  ...
  var initialiseRouting = function(onNewRoute) {
    return $$void12(matchesWith2(parse2(routeCodec))(function(old) {
      return function($$new2) {
        return when12(notEq9(old)(new Just($$new2)))(onNewRoute($$new2));
      };
    }));
  };
