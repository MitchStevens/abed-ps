...
(() => {
            ...
            return function(array) {
              function go2(bot, top3) {
                switch (top3 - bot) {
                  ...
                  case 2:
                    return apply7(map65(array2)(f(array[bot])))(f(array[bot + 1]));
                  case 3:
                    return apply7(apply7(map65(array3)(f(array[bot])))(f(array[bot + 1])))(f(array[bot + 2]));
                  default:
                    var pivot = bot + Math.floor((top3 - bot) / 4) * 2;
                    return apply7(map65(concat2)(go2(bot, pivot)))(go2(pivot, top3));
                }
              }
  ...
  var monadTellMaybeT = function(dictMonadTell) {
    ...
    return {
      tell: function() {
        var $172 = lift3(Monad1);
        var $173 = tell(dictMonadTell);
        return function($174) {
          return $172($173($174));
        };
      }(),
  ...
  var altMaybeT = function(dictMonad) {
    ...
    return {
      alt: function(v2) {
        return function(v1) {
          return bind40(v2)(function(m2) {
            if (m2 instanceof Nothing) {
              return v1;
            }
            ;
            return pure41(m2);
    ...
    traverse: function(dictApplicative) {
      ...
      return function(f) {
        var go2 = function(v2) {
          ...
          ;
          if (v2 instanceof Node) {
            return apply7(apply7(map123(function(l$prime) {
  ...
  var sortByImpl = function() {
    function mergeFromTo(compare9, fromOrdering, xs1, xs2, from4, to3) {
      var mid;
      var i2;
      var j;
      var k;
  ...
  var traverse1Impl = function() {
    ...
    return function(apply7, map65, f) {
      var buildFrom = function(x2, ys) {
        return apply7(map65(consList)(f(x2)))(ys);
      };
  ...
  var prettyFormatter = function(dictMonadEffect) {
    ...
    return function(message2) {
      return apply7(map214(append7)(showMainLine1(message2)))(showTags1(message2.tags));
    };
  };
  ...
  var bitraversableTuple = {
    bitraverse: function(dictApplicative) {
      ...
      return function(f) {
        return function(g2) {
          return function(v2) {
            return apply7(map65(Tuple.create)(f(v2.value0)))(g2(v2.value1));
          };
        };
      };
    },
    bisequence: function(dictApplicative) {
      ...
      var map65 = map(Apply0.Functor0());
      return function(v2) {
        return apply7(map65(Tuple.create)(v2.value0))(v2.value1);
      };
    },
    Bifunctor0: function() {
  ...
  var _size = function(dictStrong) {
    var $178 = _Newtype3(dictStrong.Profunctor0());
    var $179 = prop6($$Proxy.value)(dictStrong);
    return function($180) {
      return $178($179($180));
    };
  };
  ...
  var _pieces = function(dictStrong) {
    var $181 = _Newtype3(dictStrong.Profunctor0());
    var $182 = prop13($$Proxy.value)(dictStrong);
    return function($183) {
      return $181($182($183));
    };
  };
  var allOccupiedLocations = /* @__PURE__ */ view(/* @__PURE__ */ function() {
    var $184 = _pieces(strongForget);
    var $185 = to2(keys2);
    return function($186) {
      return $184($185($186));
    };
  ...
  // output/Game.Board.Edge/index.js
  ...
  var showRelativeEdge = {
    show: function(v2) {
      return "RelativeEdge " + (show14(v2.loc) + (" " + show15(v2.dir)));
    }
  };
  var eqRelativeEdge = {
    eq: function(x2) {
  ...
  var toAbsoluteEdge = function(dict) {
    return dict.toAbsoluteEdge;
  };
  ...
  var getPortOnEdge = function(dict) {
    return dict.getPortOnEdge;
  };
  var fromAbsoluteEdge = function(dict) {
    return dict.fromAbsoluteEdge;
  };
  var edgeLocation = function() {
    return function(dictEdge) {
      return function($156) {
        return function(v2) {
          return v2.loc;
        }(coerce6($156));
  ...
  var compareBaseEdge = function(e1) {
    return function(e2) {
      return append12(compare7(e1.loc)(e2.loc))(compare15(e1.dir)(e2.dir));
    };
  };
  var ordRelativeEdge = {
    compare: /* @__PURE__ */ on(compareBaseEdge)(coerce6),
    Eq0: function() {
  ...
  var adjacentAbsoluteEdge = function(v2) {
    return absolute(followDirection(v2.loc)(v2.dir))(oppositeDirection(v2.dir));
  };
  var adjacent = function(dictEdge) {
    var toAbsoluteEdge1 = toAbsoluteEdge(dictEdge);
    return function(dictEdge1) {
      var fromAbsoluteEdge22 = fromAbsoluteEdge(dictEdge1);
      return function(dictMonadState) {
        return composeKleisli(bindMaybeT(dictMonadState.Monad0()))(toAbsoluteEdge1(dictMonadState))(function() {
          var $158 = fromAbsoluteEdge22(dictMonadState);
          return function($159) {
            return $158(adjacentAbsoluteEdge($159));
          };
        }());
      };
    };
  };
  var connected = function(dictEdge) {
    var adjacent1 = adjacent(dictEdge);
    var getPortOnEdge22 = getPortOnEdge(dictEdge);
    return function(dictEdge1) {
      var adjacent22 = adjacent1(dictEdge1);
      var getPortOnEdge32 = getPortOnEdge(dictEdge1);
      return function(dictMonadState) {
        var Monad0 = dictMonadState.Monad0();
        var bindMaybeT2 = bindMaybeT(Monad0);
        var bind40 = bind(bindMaybeT2);
        var adjacent3 = adjacent22(dictMonadState);
        var discard111 = discard3(bindMaybeT2);
        var apply7 = apply(applyMaybeT(Monad0));
        var map65 = map(functorMaybeT(Monad0.Bind1().Apply0().Functor0()));
        var getPortOnEdge4 = getPortOnEdge22(dictMonadState);
        var getPortOnEdge5 = getPortOnEdge32(dictMonadState);
        var guard8 = guard(alternativeMaybeT(Monad0));
        var pure41 = pure(applicativeMaybeT(Monad0));
        return function(edge) {
          return bind40(adjacent3(edge))(function(adj) {
            return discard111(bind40(apply7(map65(portMatches)(getPortOnEdge4(edge)))(getPortOnEdge5(adj)))(guard8))(function() {
              return pure41(adj);
            });
          });
        };
  ...
  var edgeRelativeEdge = {
    toAbsoluteEdge: function(dictMonadState) {
      var Monad0 = dictMonadState.Monad0();
      var bind40 = bind(bindMaybeT(Monad0));
      var use3 = use(dictMonadState);
      var pure41 = pure(applicativeMaybeT(Monad0));
      return function(v2) {
        return bind40(use3(function() {
          var $160 = at2(v2.loc)(strongForget);
          return function($161) {
            return _pieces2($160($161));
          };
        }()))(function(v1) {
          return pure41(absolute(v2.loc)(rotateDirection(v2.dir)(v1.rotation)));
        });
      };
    },
    fromAbsoluteEdge: function(dictMonadState) {
      var Monad0 = dictMonadState.Monad0();
      var bind40 = bind(bindMaybeT(Monad0));
      var use3 = use(dictMonadState);
      var pure41 = pure(applicativeMaybeT(Monad0));
      return function(v2) {
        return bind40(use3(function() {
          var $162 = at2(v2.loc)(strongForget);
          return function($163) {
            return _pieces2($162($163));
          };
        }()))(function(v1) {
          return pure41(relative(v2.loc)(rotateDirection(v2.dir)(ginverse2(v1.rotation))));
        });
      };
    },
    getPortOnEdge: function(dictMonadState) {
      var Monad0 = dictMonadState.Monad0();
      var bind40 = bind(bindMaybeT(Monad0));
      var use3 = use(dictMonadState);
      var pure41 = pure(Monad0.Applicative0());
      return function(v2) {
        return bind40(use3(function() {
          var $164 = at2(v2.loc)(strongForget);
          return function($165) {
            return _pieces2($164($165));
          };
        }()))(function(v1) {
          return pure41(getPort(v1.piece)(v2.dir));
        });
      };
    }
  };
  var fromAbsoluteEdge1 = /* @__PURE__ */ fromAbsoluteEdge(edgeRelativeEdge);
  var getPortOnEdge1 = /* @__PURE__ */ getPortOnEdge(edgeRelativeEdge);
  var edgeAbsoluteEdge = {
    toAbsoluteEdge: function(dictMonadState) {
      return pure(applicativeMaybeT(dictMonadState.Monad0()));
    },
    fromAbsoluteEdge: function(dictMonadState) {
      return pure(applicativeMaybeT(dictMonadState.Monad0()));
    },
    getPortOnEdge: function(dictMonadState) {
      var bind40 = bind(bindMaybeT(dictMonadState.Monad0()));
      var fromAbsoluteEdge22 = fromAbsoluteEdge1(dictMonadState);
      var getPortOnEdge22 = getPortOnEdge1(dictMonadState);
      return function(absEdge) {
        return bind40(fromAbsoluteEdge22(absEdge))(function(v2) {
          return getPortOnEdge22(v2);
        });
      };
    }
  };
  ...
  var isPseudoInput = function(v2) {
    return eq6(v2.name)("psuedo-input");
  };
  ...
  var compactableMap = function(dictOrd) {
    ...
    return {
      compact: function() {
        var select6 = function(v2) {
          return function(m2) {
            return alter3($$const(v2.value1))(v2.value0)(m2);
          };
        };
        var $104 = foldr6(select6)(empty2);
        return function($105) {
      ...
      separate: function() {
        var select6 = function(v2) {
          return function(v1) {
            if (v2.value1 instanceof Left) {
              return {
                left: insert17(v2.value0)(v2.value1.value0)(v1.left),
                right: v1.right
              };
            }
            ;
            if (v2.value1 instanceof Right) {
              return {
                left: v1.left,
                right: insert17(v2.value0)(v2.value1.value0)(v1.right)
              };
            }
            ;
            throw new Error("Failed pattern match at Data.Compactable (line 142, column 44 - line 144, column 63): " + [v2.value1.constructor.name]);
          };
        };
        var $106 = foldr6(select6)({
          left: empty2,
          right: empty2
        });
        return function($107) {
  ...
  var compact2 = /* @__PURE__ */ compact(/* @__PURE__ */ compactableMap(ordCardinalDirection));
  var getPortOnEdge2 = /* @__PURE__ */ getPortOnEdge(edgeAbsoluteEdge);
  var applicativeWriterT2 = /* @__PURE__ */ applicativeWriterT(monoidList);
  var monadWriterT2 = /* @__PURE__ */ monadWriterT(monoidList);
  var connected2 = /* @__PURE__ */ connected(edgeRelativeEdge)(edgeRelativeEdge);
  var monadStateWriterT2 = /* @__PURE__ */ monadStateWriterT(monoidList);
  var getPortOnEdge12 = /* @__PURE__ */ getPortOnEdge(edgeRelativeEdge);
  ...
  var edgeLocation2 = /* @__PURE__ */ edgeLocation()(edgeRelativeEdge);
  ...
  var edgeDirection2 = /* @__PURE__ */ edgeDirection()(edgeRelativeEdge);
  ...
  var fromFoldable32 = /* @__PURE__ */ fromFoldable(foldableArray);
  ...
  var getBoardEdges = function(dictMonadState) {
    var Monad0 = dictMonadState.Monad0();
    var pure41 = pure(Monad0.Applicative0());
    return bind(Monad0.Bind1())(use(dictMonadState)(_size2))(function(n) {
      return pure41(fromFoldable5([new Tuple(Up.value, location(div6(n)(2))(0)), new Tuple(Right2.value, location(n - 1 | 0)(div6(n)(2))), new Tuple(Down.value, location(div6(n)(2))(n - 1 | 0)), new Tuple(Left2.value, location(0)(div6(n)(2)))]));
    });
  };
  var getBoardPorts = function(dictMonadState) {
    ...
    var getPortOnEdge22 = getPortOnEdge2(dictMonadState);
    return map(Bind1.Apply0().Functor0())(compact2)(bind(Bind1)(getBoardEdges(dictMonadState))(function(boardEdges) {
      return forWithIndex2(boardEdges)(function(dir2) {
        return function(loc) {
          return runMaybeT(getPortOnEdge22(absolute(loc)(dir2)));
        };
      });
    }));
  };
    ...
    return function(dir2) {
      return bind118(use3(_size2))(function(n) {
        return pure41(function() {
          ...
          ;
          throw new Error("Failed pattern match at Game.Board.Query (line 78, column 10 - line 82, column 52): " + [dir2.constructor.name]);
        }());
      });
    };
  };
  ...
  var buildConnectionMapAt = function(dictMonadState) {
    var Monad0 = dictMonadState.Monad0();
    var for_7 = for_(applicativeWriterT2(Monad0.Applicative0()))(foldableArray);
    var bind118 = bind(bindMaybeT(monadWriterT2(Monad0)));
    var monadStateWriterT1 = monadStateWriterT2(dictMonadState);
    var connected1 = connected2(monadStateWriterT1);
    var getPortOnEdge22 = getPortOnEdge12(monadStateWriterT1);
    var tell7 = tell(monadTellMaybeT(monadTellWriterT2(Monad0)));
    return function(loc) {
      return for_7(allDirections)(function(dir2) {
        return runMaybeT(function() {
          var relEdge = relative(loc)(dir2);
          return bind118(connected1(relEdge))(function(adjRelEdge) {
            return bind118(getPortOnEdge22(relEdge))(function(port2) {
              var v2 = portType(port2);
              if (v2 instanceof Input) {
              ...
              ;
              throw new Error("Failed pattern match at Game.Board.Query (line 121, column 5 - line 125, column 56): " + [v2.constructor.name]);
            });
          });
        }());
      });
  ...
  var buildConnectionMap = function(dictMonadState) {
    ...
    return bind(Bind1)(use(dictMonadState)(_pieces3))(function(pieceInfos) {
      return map38(map311(fromFoldable1))(execWriterT2)(traverse_16(buildConnectionMapAt1)(fromFoldable22(keys2(pieceInfos))));
    });
  };
  var allConnectedRelativeEdges = function(dictMonadState) {
    var wither1 = wither2(dictMonadState.Monad0().Applicative0());
    var connected1 = connected2(dictMonadState);
    return function(loc) {
      return wither1(function($153) {
        return runMaybeT(connected1($153));
      })(map116(relative(loc))(allDirections));
    };
  };
    ...
    return function(capacity) {
      return function(vars) {
        ...
        if (vars.openSet instanceof Cons) {
          var loc = edgeLocation2(vars.openSet.value0);
          var closedSet = insert8(loc)(vars.closedSet);
          return bind118(map311(map211(function(v2) {
            return v2.piece;
          }))(use3(function() {
            var $154 = at3(loc)(strongForget);
            return function($155) {
              return _pieces3($154($155));
            };
          }())))(function(maybePiece) {
            var v2 = bind13(maybePiece)(updateCapacity(edgeDirection2(vars.openSet.value0))(capacity));
            if (v2 instanceof Just) {
              return bind118(allConnectedRelativeEdges1(loc))(function(connected1) {
                return discard111(modifying4(function() {
                  var $156 = ix2(loc)(strongFn)(choiceFn);
                  return function($157) {
                    return _pieces1($156($157));
                  };
                }())(function(v1) {
                  var $146 = {};
                  for (var $147 in v1) {
                  ...
                  var $149 = shouldRipple(v2.value0);
                  if ($149) {
                    var notInClosedSet = function(r) {
                      return !member4(edgeLocation2(r))(vars.closedSet);
                    };
                    var openSet = append14(fromFoldable32(filter6(notInClosedSet)(connected1)))(vars.openSet.value1);
            ...
            ;
            throw new Error("Failed pattern match at Game.Board.Query (line 143, column 5 - line 155, column 70): " + [v2.constructor.name]);
          });
        }
        ;
        throw new Error("Failed pattern match at Game.Board.Query (line 136, column 35 - line 155, column 70): " + [vars.openSet.constructor.name]);
      };
    };
  };
  ...
  var filter7 = /* @__PURE__ */ filter2(ordRelativeEdge);
  var notEq3 = /* @__PURE__ */ notEq(eqLocation);
  var edgeLocation3 = /* @__PURE__ */ edgeLocation()(edgeRelativeEdge);
  var map39 = /* @__PURE__ */ map(functorMaybe);
  var edgeDirection3 = /* @__PURE__ */ edgeDirection()(edgeRelativeEdge);
  ...
  var filter1 = /* @__PURE__ */ filter2(ordCardinalDirection);
  ...
  var topologicalSort = function(v2) {
    return function(v1) {
      ...
      var doesntAcceptOutput = function(loc) {
        return isEmpty(submap2(new Just(relative(loc)(Up.value)))(new Just(relative(loc)(Left2.value)))(v1));
      };
      return bind14(find3(doesntAcceptOutput)(v2))(function(r) {
        var nodes$prime = $$delete6(r)(v2);
        var edges$prime = filter7(function(v22) {
          return notEq3(edgeLocation3(v22))(r);
        })(v1);
  ...
  var toLocalInputs = function(loc) {
    var $286 = unsafeMapKey(edgeDirection3);
    var $287 = submap2(new Just(relative(loc)(Up.value)))(new Just(relative(loc)(Left2.value)));
    return function($288) {
      return $286($287($288));
    };
  };
      ...
      return function(dir2) {
        return function(signal) {
          return $$void12(runMaybeT(bind118(asks2(function() {
            var $289 = lookup10(dir2);
            return function($290) {
              return $289(function(v2) {
                return v2.psuedoPieceLocations;
              }(unwrap11($290)));
            };
          }()))(function(loc) {
            return bind118(asks2(function() {
              var $291 = lookup12(loc);
              return function($292) {
                return $291(function(v2) {
                  return v2.pieces;
                }(unwrap11($292)));
              };
            }()))(function(piece) {
              return when12(isPseudoInput(piece))(bind118(pure41(getPsuedoPiecePort(piece)))(function(port2) {
  ...
  var injectInputs = function(dictMonadReader) {
    ...
    return function(dictMonadState) {
      ...
      return function(inputs) {
        return bind118(asks2(function($293) {
          return function(v2) {
            return v2.psuedoPieceLocations;
          }(unwrap11($293));
          ...
          return forWithIndex_3(psuedoPieceLocations)(function(dir2) {
            return function(loc) {
              return for_7(lookup10(dir2)(inputs))(function(signal) {
  ...
  var getOuterPort = function(dictMonadReader) {
    ...
    return function(dictMonadState) {
      ...
      return function(dir2) {
        return bind118(asks2(function() {
          var $298 = lookup10(dir2);
          return function($299) {
            return $298(function(v2) {
              return v2.psuedoPieceLocations;
            }(unwrap11($299)));
          };
        }()))(function(maybeLoc) {
          return $$for3(maybeLoc)(function(loc) {
            return map214(maybe(zero3)(function(v2) {
              return v2.signal;
  ...
  var getInputOnEdge = function(dictMonadReader) {
    ...
    return function(dictMonadState) {
      ...
      return function(inRelEdge) {
        return function(capacity) {
          return bind118(asks2(function($300) {
            return function(v2) {
            ...
            if (v2 instanceof Just) {
              return bind118(bind118(use3(at4(v2.value0)(strongForget)))(traverse12(function(v1) {
                ...
                return pure41(fromMaybe(zero3)(maybeSignal));
              });
            }
            ;
            if (v2 instanceof Nothing) {
              return bind118(map214(maybe(zero3)(function(v1) {
                return v1.signal;
            ...
            ;
            throw new Error("Failed pattern match at Game.Board.EvaluableBoard (line 190, column 3 - line 201, column 18): " + [v2.constructor.name]);
          });
        };
      };
    };
  ...
  var extractOutputs = function(dictMonadReader) {
    ...
    return function(dictMonadState) {
      ...
      return map214(catMaybes4)(bind118(map214(filter1(isOutput))(getPorts22))(function(outputPorts) {
      ...
      return function(loc) {
        return bind118(asks2(function($301) {
          ...
          return for_7(lookup12(loc)(pieces))(function(v2) {
            var inputPorts = filter1(isInput)(v2.ports);
            return bind118(map214(fromFoldable6)(forWithIndex2(inputPorts)(function(dir2) {
              ...
              return unless4(isPseudoPiece(v2))(function() {
                ...
                var outputPorts = filter1(isOutput)(v2.ports);
                return forWithIndex_3(outputPorts)(function(dir2) {
                  return function(port2) {
                    var signal = fold5(lookup10(dir2)(outputs));
  ...
  var evaluableBoardPiece = function(evaluable) {
    return mkPieceNoGlob({
      name: "evaluable",
      "eval": function(m2) {
        return evalState(runReaderT(evalWithPortInfo1(m2))(evaluable))(empty2);
      },
      ports: getPorts1(evaluable),
      complexity: space(0),
      shouldRipple: false,
      updateCapacity: function(v2) {
        return function(v1) {
  ...
  var buildEvaluableBoard = function(dictMonadError) {
    ...
    var discard111 = discard6(bindStateT2);
        ...
        return function(port2) {
          return bind118(getBoardEdgePseudoLocation2(dir2))(function(loc) {
            ...
            return assign4(function() {
              var $303 = at1(loc)(strongFn);
              return function($304) {
                return _pieces4($303($304));
              };
            }())(new Just({
  ...
  var lookup11 = /* @__PURE__ */ lookup2(ordRelativeEdge);
  ...
  var _wireLocations = function(dictWander) {
    ...
    var $59 = prop7($$Proxy.value)(Strong0);
  ...
  var pieceInput = function(state3) {
    return function(location4) {
      return bind15(viewOn(state3)(function() {
        var $69 = at5(location4)(strongForget);
        return function($70) {
          return _board1(_pieces5($69($70)));
        };
      }()))(function(v2) {
  ...
  var isReadyForTesting = function(problem) {
    return function(board) {
      return fromLeft(ReadyForTesting.value)(bind16(checkEvaluable(board))(function(evaluable) {
        return discard7(lmap3(PortMismatch.create)(checkPortMismatch(problem)(evaluableBoardPiece(evaluable))))(function() {
  ...
  var eq7 = /* @__PURE__ */ eq(/* @__PURE__ */ eqMap(eqCardinalDirection)(eqSignal));
    ...
    eq: function(x2) {
      return function(y2) {
        ...
        if (x2 instanceof Failed && y2 instanceof Failed) {
          return eq7(x2.value0.received)(y2.value0.received);
        }
        ;
        return false;
      };
  ...
  var testCaseOutcome = function(v2) {
    return function(received) {
      var $34 = eq7(v2.expected)(received);
      if ($34) {
        return Passed.value;
      }
      ;
  ...
  var outputPath = function(connected3) {
    if (connected3) {
      return stubPath;
    }
    ;
  ...
  var wirePath = function(ports) {
    ...
    var path3 = execWriter(for_3(uncons2(toUnfoldable8(ports)))(function(v2) {
      var v1 = initialLocation(fst(v2.head));
      return discard8(tell3([m(Rel.value)(v1.value0)(v1.value1)]))(function() {
        var sides = zip(toUnfoldable8(ports))(map44(fst)(append15(v2.tail)([v2.head])));
  ...
  var eq9 = /* @__PURE__ */ eq(eqPortType);
  var append16 = /* @__PURE__ */ append(semigroupArray);
  var portPath = function(info4) {
    var v2 = function() {
      var $5 = eq9(portType(info4.port))(Input.value);
      if ($5) {
  ...
  var eq10 = /* @__PURE__ */ eq(eqCardinalDirection);
          ...
          return {
            ...
            updateCapacity: function(dir2) {
              return function(capacity$prime) {
                var $52 = eq10(dir2)(Left2.value) || elem5(dir2)(v2.outputs);
                if ($52) {
            ...
            glob: function(dir2) {
              return function(portType2) {
                ...
                if (portType2 instanceof Just && portType2.value0 instanceof Input) {
                  ...
                  return discard9(guard5(notEq5(v2.outputs)(newOutputs)))(function() {
                ...
                if (portType2 instanceof Nothing) {
                  ...
                  return discard9(guard5(notEq5(v2.outputs)(newOutputs) && notEq5(newOutputs)(empty3)))(function() {
                    var globbed = force(go2({
                      capacity: v2.capacity,
                      outputs: newOutputs
                    })(unglob2));
                    return discard9(guard5(isSubmap2(getPorts(force(unglob2)))(getPorts(globbed))))(function() {
  ...
  var renderPiece = function(state3) {
    var render6 = function() {
      ...
      ;
      if (eq11(name2(state3.piece))(name2(crossPiece))) {
        return renderCrossOver(state3.portStates);
      }
      ;
      if (eq11(name2(state3.piece))(name2(cornerCutPiece))) {
        return renderCornerCut(state3.portStates);
      }
      ;
      if (eq11(name2(state3.piece))(name2(chickenPiece))) {
  ...
  var eq18 = /* @__PURE__ */ eq(/* @__PURE__ */ eqRec3(/* @__PURE__ */ eqRowCons(/* @__PURE__ */ eqRowCons(/* @__PURE__ */ eqRowCons(/* @__PURE__ */ eqRowCons(/* @__PURE__ */ eqRowCons(/* @__PURE__ */ eqRowCons2({
    reflectSymbol: function() {
      return "rotation";
    }
  })(eqRotation))()({
  ...
  var component4 = function(dictMonadEffect) {
    ...
    var render6 = memoized(eq18)(function(state3) {
    ...
    var $$eval3 = mkEval({
      ...
      handleAction: function(v1) {
        ...
        if (v1 instanceof OnDrop) {
          return discard10(modify_3(function(v2) {
            var $140 = {};
            for (var $141 in v2) {
          ...
          return bind19(gets2(function(v2) {
            ...
            return bind19(gets2(function(v3) {
              ...
              return bind19(gets2(function(v3) {
                ...
                return discard10(modify_3(function(v3) {
                  var $169 = {};
                  for (var $170 in v3) {
        ...
        if (v1 instanceof OnKeyDown) {
          return discard10(when3(key(v1.value0) === "r")(bind19(gets2(function(v2) {
            return v2.location;
          }))(function(loc) {
  ...
  var fromAbsoluteEdge2 = /* @__PURE__ */ fromAbsoluteEdge(edgeRelativeEdge);
      ...
      return function(n) {
        return bind40(get4)(function(v2) {
          return bind40(validBoardSize1(n))(function(newSize) {
            ...
            var firstPieceOusideSquare = find5(function($233) {
              return !insideSquare(shiftLocation($233));
            })(keys2(v2.pieces));
            ...
            ;
            throw new Error("Failed pattern match at Game.Board.Operation (line 191, column 3 - line 195, column 52): " + [firstPieceOusideSquare.constructor.name]);
          });
        });
      };
    };
  ...
  var globRelEdge = function(dictMonadState) {
    var bind40 = bind(bindMaybeT(dictMonadState.Monad0()));
    var fromAbsoluteEdge12 = fromAbsoluteEdge2(dictMonadState);
    var use3 = use(dictMonadState);
    var assign4 = assign(monadStateMaybeT(dictMonadState));
    return function(absEdge) {
      return function(portType2) {
        return bind40(fromAbsoluteEdge12(absEdge))(function(v2) {
          return bind40(use3(function() {
            var $234 = at6(v2.loc)(strongForget);
            return function($235) {
              return _pieces6($234($235));
            };
          }()))(function(v1) {
            return assign4(function() {
              var $236 = ix3(v2.loc)(strongFn)(choiceFn);
              var $237 = prop9($$Proxy.value)(strongFn);
              return function($238) {
                return _pieces13($236($237($238)));
              };
            }())(glob(v2.dir)(portType2)(v1.piece));
          });
        });
      };
    };
  ...
  var globPortsAround = function(dictMonadState) {
    ...
    var Bind1 = Monad0.Bind1();
    var bind40 = bind(Bind1);
    var getPortOnEdge13 = getPortOnEdge3(dictMonadState);
    var $$void12 = $$void(Bind1.Apply0().Functor0());
    var globRelEdge1 = globRelEdge(dictMonadState);
    return function(loc) {
      return for_7(allDirections)(function(dir2) {
        var edge = absolute(loc)(dir2);
        var adj = adjacentAbsoluteEdge(edge);
        return bind40(runMaybeT(getPortOnEdge13(edge)))(function(maybePort) {
          return $$void12(runMaybeT(globRelEdge1(adj)(map47(portType)(maybePort))));
        });
      });
    };
  };
      ...
      return function(src10) {
        return function(dst) {
          return bind40(use3(function() {
            ...
            ;
            throw new Error("Failed pattern match at Game.Board.Operation (line 122, column 32 - line 133, column 43): " + [v2.constructor.name]);
          });
        };
      };
    };
  ...
  var getPieceInfo = function(dictMonadState) {
    ...
    return function(dictMonadError) {
      ...
      return function(loc) {
        return bind40(use3(function() {
          var $247 = at6(loc)(strongForget);
          return function($248) {
            return _pieces6($247($248));
          };
    ...
    return function(dictMonadState) {
      ...
      return function(loc) {
        return discard111(checkInsideBoard2(loc))(function() {
          return bind40(use3(function() {
            var $249 = at6(loc)(strongForget);
            return function($250) {
              return _pieces6($249($250));
            };
            ...
            ;
            throw new Error("Failed pattern match at Game.Board.Operation (line 106, column 3 - line 110, column 21): " + [maybePieceInfo.constructor.name]);
          });
        });
      };
    };
    ...
    return function(dictMonadError) {
      ...
      return function(src10) {
        return function(maybeDst) {
          ...
          ;
          throw new Error("Failed pattern match at Game.Board.Operation (line 139, column 3 - line 143, column 31): " + [maybeDst.constructor.name]);
        };
      };
    };
  };
          ...
          return discard111(checkInsideBoard2(loc))(function() {
            return bind40(getPiece1(loc))(function() {
              return discard111(appendModifying3(function() {
                var $253 = ix3(loc)(strongFn)(choiceFn);
                return function($254) {
                  return _pieces13($253(_rotation2($254)));
                };
              }())(rot))(function() {
      ...
      return function(loc) {
        return function(piece) {
          return function(rotation3) {
            return discard111(checkInsideBoard2(loc))(function() {
              return bind40(use3(function() {
                var $255 = at6(loc)(strongForget);
                return function($256) {
                  return _pieces6($255($256));
                };
              }()))(function(pieceInfo) {
                if (pieceInfo instanceof Nothing) {
                  return assign4(function() {
                    var $257 = at6(loc)(strongFn);
                    return function($258) {
                      return _pieces13($257($258));
                    };
                  }())(new Just({
                    piece,
                    rotation: rotation3
                ...
                ;
                throw new Error("Failed pattern match at Game.Board.Operation (line 93, column 3 - line 95, column 48): " + [pieceInfo.constructor.name]);
              });
            });
          };
        };
  ...
  var fromPiece = function(v2) {
    ...
    if (v1 instanceof Just && v1.value0 instanceof Connection) {
      return pathSegment(fromFoldable14(map48(f)(toUnfoldable9(v1.value0.value0))));
    }
    ;
  ...
  var combine = function(v2) {
    return function(v1) {
      ...
      return discard12(when4(isSubmap3(conn3)(v2) || isSubmap3(conn3)(v1))(throwError4(new CantCombinePathSegments(v2, v1))))(function() {
  ...
  var adjacent2 = /* @__PURE__ */ adjacent(edgeAbsoluteEdge)(edgeAbsoluteEdge);
  ...
  var at7 = /* @__PURE__ */ at(/* @__PURE__ */ atMap(ordLocation));
  ...
  var genericPathError_ = {
    to: function(x2) {
      ...
      ;
      throw new Error("Failed pattern match at Game.Board.Path (line 60, column 1 - line 60, column 36): " + [x2.constructor.name]);
    },
    from: function(x2) {
  ...
  var updateEndPoints = function(dictMonadState) {
    ...
    var $$void12 = $$void(Monad0.Bind1().Apply0().Functor0());
    var bind118 = bind(bindMaybeT(Monad0));
    var adjacent1 = adjacent2(dictMonadState);
    var globRelEdge2 = globRelEdge(dictMonadState);
    return function(path3) {
      return $$void12(runMaybeT(bind118(adjacent1(absolute(path3.start)(path3.initial)))(function(headAdj) {
  ...
  var partitionPath = function(v2) {
    ...
    ;
    throw new Error("Failed pattern match at Game.Board.Path (line 88, column 3 - line 97, column 53): " + [v1.constructor.name]);
  };
  var liftBoardError = function(dictMonadError) {
    var $165 = liftEither(dictMonadError.MonadThrow0());
    var $166 = lmap4(function($168) {
      return Other.create(show29($168));
    });
    return function($167) {
      return $165($166($167));
    };
          ...
          return forWithIndex_3(pathSegments)(function(loc) {
            return function(segment2) {
              return bind118(use3(function() {
                var $169 = at7(loc)(strongForget);
                return function($170) {
                  return _pieces7($169($170));
                };
              }()))(function(extant) {
  ...
  var at8 = /* @__PURE__ */ at(/* @__PURE__ */ atMap(ordCardinalDirection));
  ...
  var _pieces8 = /* @__PURE__ */ _pieces(strongForget);
        ...
        function $tco_loop(v2) {
          ...
          if (v2 instanceof AddPath) {
            ...
            return bind111(liftBoardM(addPath2(v2.value0)(v2.value1)(v2.value2)))(function(result) {
              return discard14(when5(isRight(result))(raise(new BoardEvent2(new AddPathEvent(v2.value0, v2.value1, v2.value2)))))(function() {
          ...
          if (v2 instanceof SetGoalPorts) {
            $tco_done = true;
            return discard14(lift9(debug3(tag("boardPorts")(show31(v2.value0)))("Set goal ports on board")))(function() {
              return discard14(modify_4(function(v1) {
                var $216 = {};
                for (var $217 in v1) {
          ...
          if (v2 instanceof Clear) {
            $tco_done = true;
            return bind111(liftBoardM(bind26(use1(_pieces8))(function(pieces) {
      ...
      var handleAction = function(v2) {
        if (v2 instanceof Initialise) {
          return bind111(liftEffect4(globalKeyDownEventEmitter))(function(emitter) {
            return discard14($$void8(subscribe2(map310(GlobalOnKeyDown.create)(emitter))))(function() {
              return discard14(bindFlipped8(raise)(map51(NewBoardState.create)(use2(_board2))))(function() {
          ...
          return discard14(lift9(debug3(empty2)("Piece dropped at " + show110(v2.value0.value0))))(function() {
            return bind111(gets3(function(v12) {
              ...
              return bind111(liftBoardM(pieceDropped2(v2.value0.value0)(maybeDst)))(function(result) {
                return when5(isLeft(result))(discard14(lift9(warn3(empty2)(show210(result))))(function() {
        ...
        if (v2 instanceof MultimeterOutput) {
          return discard14($$void8(liftBoardM(capacityRipple2(v2.value0.value0)(v2.value0.value1))))(function() {
            return bind111(gets3(function(v12) {
        ...
        if (v2 instanceof IncrementInput) {
          return discard14(bind111(gets3(function() {
            ...
            return modifying2(function() {
              ...
              var $253 = eq19(signal)(maxValue(portCapacity(port2)));
              if ($253) {
                return ff2;
              }
              ;
        ...
        if (v2 instanceof SetOutputs) {
          return discard14(modify_4(function(v12) {
            var $257 = {};
            for (var $258 in v12) {
        ...
        if (v2 instanceof SetBoard) {
          return discard14(lift9(debug3(empty2)("Updating board")))(function() {
            return discard14(modify_4(function(s2) {
              var $277 = {};
              for (var $278 in s2) {
            ...
            return bind111(gets3(function(v12) {
              ...
              return bind111(map51(buildEvaluableBoard2(boardPorts))(use2(_board2)))(function(eitherEvaluable) {
                ...
                if (eitherEvaluable instanceof Right) {
                  ...
                  return discard14(lift9(debug3(union6(tag("inputs")(show42(inputs)))(tag("outputs")(show42(v12.value0))))("Evaluating board")))(function() {
                    return discard14(lift9(debug3(foldrWithIndex2(function(relEdge) {
                      ...
                      return discard14(modify_4(function(v22) {
                        var $284 = {};
                        for (var $285 in v22) {
    ...
    var $$eval3 = mkEval({
      ...
      handleQuery: function(v1) {
        if (v1 instanceof OpenDemonstration) {
          return discard15(modify_5(function(v2) {
            var $14 = {};
            for (var $15 in v2) {
        ...
        if (v2 instanceof InputRangeMouseUp) {
          return bind28(liftEffect11(getValue))(function(sliderValue) {
            return bind28(gets4(function(v1) {
              ...
              return when6(sliderValue !== boardSize)(discard16(liftEffect11(setValue12(boardSize)))(function() {
  ...
  var component10 = function(dictMonadAff) {
    ...
    var handleAction = function(v2) {
      ...
      if (v2 instanceof RunAllTests) {
        return discard17(whenM2(gets5(function(v1) {
          ...
          return discard17(function() {
            if (v2.value0 instanceof Passed) {
              return bind30(gets5(function(v1) {
                ...
                return when7(!testSuiteFailed)(discard17(modify_7(function(s2) {
                  var $38 = {};
                  for (var $39 in s2) {
    ...
    var $$eval3 = mkEval({
      ...
      handleAction: function(v2) {
        if (v2 instanceof Initialise3) {
          return discard20(put4(initialState3(v2.value0)))(function() {
      ...
      handleQuery: function(v2) {
        if (v2 instanceof AmendBoardSizeSlider2) {
          return discard20(modify_8(function(v1) {
            var $34 = {};
            for (var $35 in v1) {
        ...
        if (v2 instanceof TestCaseResponse) {
          return discard20(tell22(slot11)(unit)(TestCaseOutcome.create(v2.value0)))(function() {
            return pure33(new Just(v2.value1));
          });
        }
        ;
  ...
  var ordUUIDv4 = {
    compare: function(v2) {
      return function(v1) {
        return compare8(v2.value0)(v1.value0);
      };
    },
    Eq0: function() {
      return eqUUIDv4;
  ...
  var getAllLevelProgress = function(dictMonadEffect) {
    ...
    return map65(function($37) {
      return catMaybes5(fromFoldable28(join6($37)));
    })($$for3(toUnfoldable10(allLevelSuites))(function(v2) {
      return $$for3(toUnfoldable10(v2.value1))(function(v1) {
    ...
    var render6 = function(state3) {
      ...
      var renderLevelSuite = function(suiteName) {
        return function(levelSuite) {
          ...
          return div5([class_("level-suite")])([h2_([text(suiteName), renderLevelProgress(maybeTotalProgress)]), ul_(bind35(toUnfoldable11(levelSuite))(function(v2) {
      ...
      handleAction: function(v1) {
        if (v1 instanceof Initialise5) {
          return bind113(liftEffect11(getAllLevelProgress2))(function(progress3) {
            return discard23(log6(show40(progress3)))(function() {
    ...
    var $$eval3 = mkEval({
      ...
      handleQuery: function(v2) {
        return bind114(get3)(function(v1) {
          return discard24(when8(notEq9(v1.route)(v2.value0))(discard24(lift11(debug5(empty2)("Navigated to " + show41(v2.value0))))(function() {
