(() => {
  ...
  var component = function(dictMonadAff) {
    ...
    var pad2 = function(dictBoundedEnum) {
      ...
      return function(n) {
        ...
        return power2("0")(2 - length3(s) | 0) + s;
      };
    };
    ...
    var renderMessage = function(v) {
      return tr_([td([class_("timestamp")])([text(intercalate3(":")([pad21(hour(v.time)), pad22(minute(v.time)), pad23(second(v.time))]))]), td([classes(["username", "user-" + v.user])])([div_([text(v.user)])]), td([class_("message")])([text(v.text)])]);
    };
  ...
  var component2 = function(dictMonadEffect) {
    ...
    var render = function(state3) {
      ...
      var ports2 = mapFlipped2(enumFromTo2(Up.value)(Left2.value))(function(dir2) {
        return div3([class_(show4(dir2)), draggable(false)])([img([src(portIconSrc(dir2)), classes(["port-icon"]), draggable(false)])]);
      });
      ...
      return div3([class_("piece-component"), draggable(isDraggable), style("transform: rotate(" + (show1(rotation2) + "rad);")), ref2("piece"), onDragEnd(OnDrop.create(state3.location)), onDrag(OnDrag.create), onMouseDown(OnMouseDown.create), onMouseMove(OnMouseMove.create), onMouseUp(OnMouseUp.create(state3.location))])(append14([pieceTitle])(ports2));
    };
    var initialState = function(v) {
      return {
        piece: v.piece,
      ...
      handleAction: function(v) {
        ...
        if (v instanceof OnMouseDown) {
          return bind12(getHTMLElementRef("piece"))(traverse_4(function(he) {
            return bind12(liftEffect9(map17(mul2(0.5))(clientWidth(toElement(he)))))(function(r) {
              return bind12(liftEffect9(elementCenterClient(toElement(he))))(function(c) {
                ...
                ;
                return discard3(liftEffect9(setDraggable(false)(he)))(function() {
                  return modify_4(function(v2) {
                    var $66 = {};
                    for (var $67 in v2) {
        ...
        if (v instanceof OnMouseUp) {
          return discard3(bind12(gets3(function(v1) {
            return v1.isRotating;
          }))(traverse_4(function(v1) {
          ...
          function $tco_loop(state3, stack) {
            ...
            if (v1 instanceof Just && v1.value0.value0 instanceof Visit) {
              if (member3(v1.value0.value0.value0)(state3.unvisited)) {
                ...
                $copy_stack = append5(fromFoldable6(map18(Visit.create)(next)))(cons3(new Emit(v1.value0.value0.value0))(v1.value0.value1));
                return;
              }
              ;
              if (otherwise) {
  ...
  var prism = function(to2) {
    return function(fro) {
      return function(dictChoice) {
        ...
        return function(pab) {
          return dimap2(fro)(either(identity14)(identity14))(right2(rmap3(to2)(pab)));
        };
      };
    };
  };
    ...
    return unfoldGraph2(toUnfoldable5(keys3(v.pieces)))(function(v1) {
      ...
      return bind13(toListOf(function() {
        ...
        return bind13(fromFoldable7(getOutputDirs2(p2.piece)))(function(dir2) {
          return pure6(relativeEdgeLocation(matchingRelativeEdge(v)(relative(loc)(dir2))));
        });
      });
    });
  };
        ...
        return fromFoldable22(catMaybes(mapFlipped3(absEdgePorts)(function(absEdge) {
          ...
          return bind22(getPortOnEdge(v)(relEdge))(function(port2) {
            return discard4(guard1(!isInput(port2)))(function() {
              return map19(Tuple.create(edgeDirection(absEdge)))(lookup12(relEdge)(signals));
            });
          });
        })));
      };
  ...
  var GlobalKeyDown = /* @__PURE__ */ function() {
    function GlobalKeyDown3(value0, value1) {
      this.value0 = value0;
      this.value1 = value1;
    }
    ;
    GlobalKeyDown3.create = function(value0) {
      return function(value1) {
        return new GlobalKeyDown3(value0, value1);
      };
    };
    return GlobalKeyDown3;
  }();
  ...
  var component3 = function(dictMonadEffect) {
    ...
    var render = function(state3) {
      ...
      var n = viewOn(head3(state3.boardHistory))(_size2);
      var emptyPieceHTML = function(loc) {
        return text(show5(loc));
      };
      return div3([id2("board-component"), style(intercalate5(";")(["grid-template-columns: " + power3("1fr ")(n), "grid-template-rows: " + power3("1fr ")(n)])), tabIndex(-1 | 0)])(bind7(range2(0)(n - 1 | 0))(function(j) {
        return bind7(range2(0)(n - 1 | 0))(function(i2) {
          var loc = location(i2)(j);
          var eitherPieceInfo = getPieceInfo(head3(state3.boardHistory))(loc);
          var v = either(function(v1) {
            return rotation(0);
          })(function(v1) {
            return v1.rotation;
          })(eitherPieceInfo);
          return pure7(div3([class_("piece"), style("transform: rotate(" + (show12(v * 90 | 0) + "deg)")), onDragEnter(LocationOnDragEnter.create(loc)), onDragOver(LocationOnDragOver.create(loc)), onDragLeave(LocationOnDragLeave.create), onDrop(LocationOnDrop.create(loc))])(either(function(v1) {
            return [emptyPieceHTML(loc)];
          })(function() {
            var $98 = pieceHTML(loc);
            return function($99) {
              return pure7($98(function(v1) {
                return v1.piece;
              }($99)));
            };
          }())(eitherPieceInfo)));
    ...
    var handleAction = function(v) {
      ...
      if (v instanceof PieceOutput && v.value0 instanceof Rotated) {
        return bind14(map21(rotatePieceBy(v.value0.value0)(v.value0.value1))(_board1))(traverse_5(function(board$prime) {
      ...
      if (v instanceof PieceOutput && v.value0 instanceof Dropped) {
        return discard5(log4("BOARD: received drop"))(function() {
          return bind14(_board1)(function(board) {
            return bind14(gets4(function(v1) {
      ...
      if (v instanceof RevertBoard) {
        return bind14(gets4(function($101) {
          return tail(function(v1) {
            return v1.boardHistory;
          }($101));
        }))(function(tail3) {
          return for_22(fromList(tail3))(function(neList) {
            return discard5(modify_5(function(s) {
              ...
              return discard5(raise(new NewBoardState(head3(neList))))(function() {
      ...
      if (v instanceof SetBoard) {
        return discard5(modify_5(function(s) {
          ...
          ;
          $68.boardHistory = cons2(v.value0)(s.boardHistory);
          return $68;
        }))(function() {
          return discard5(raise(new NewBoardState(v.value0)))(function() {
    ...
    var $$eval4 = mkEval({
      ...
      handleQuery: function(v) {
        ...
        if (v instanceof AddPiece) {
          return bind14(map21(addPiece2(v.value0)(v.value1))(_board1))(function(eitherBoard) {
            return discard5(for_1(eitherBoard)(function(b2) {
              return handleAction(new SetBoard(b2));
            }))(function() {
              return pure13(map110(v.value2)(blush(eitherBoard)));
            });
          });
        }
        ;
        if (v instanceof RemovePiece) {
          return bind14(map21(removePiece(v.value0))(_board1))(function(eitherBoard) {
            return discard5(for_1(eitherBoard)(function(b2) {
              return handleAction(new SetBoard(b2));
            }))(function() {
              return pure13(map110(v.value1)(blush(eitherBoard)));
            });
          });
        }
        ;
        if (v instanceof GetMouseOverLocation) {
          return bind14(gets4(function(v1) {
            ...
            return pure13(map110(v.value0)(maybeLoc));
          });
        }
        ;
        if (v instanceof GlobalKeyDown) {
          return discard5(when2(key(v.value0) === "z" && ctrlKey2(v.value0))(handleAction(RevertBoard.value)))(function() {
      ...
      receive: map110(SetBoard.create)
    });
    return mkComponent({
      "eval": $$eval4,
      initialState,
  ...
  var component4 = function(dictMonadAff) {
    ...
    var renderDirection = function(dir2) {
      return span2([class_("direction")])([text(show14(dir2))]);
    };
    ...
    var $$eval4 = mkEval({
      ...
      handleQuery: function(v) {
        return bind8(gets5(function(v1) {
          ...
          return bind8(liftAff2(runExceptT(solvedBy(problemDescription)(v.value0))))(function(isSolved) {
            return discard7(modify_6(function(v1) {
              ...
              return pure9(new Just(v.value1(isSolved)));
            });
          });
        });
      },
  ...
  var GlobalKeyDown2 = /* @__PURE__ */ function() {
    function GlobalKeyDown3(value0, value1) {
      this.value0 = value0;
      this.value1 = value1;
    }
  ...
  var component5 = function(dictMonadAff) {
    var component1 = component3(dictMonadAff.MonadEffect0());
    ...
    var $$eval4 = mkEval({
      ...
      handleAction: function(v) {
        if (v instanceof Initialise4) {
          return bind9(gets6(function(v1) {
            ...
            return discard8(tell1(_chat)(unit)(function(v1) {
              ...
              return bind9(request1(_board)(unit)(GetBoard.create))(function(maybeBoard) {
        ...
        if (v instanceof SidebarOutput && v.value0 instanceof PieceDropped) {
          return bind9(request1(_board)(unit)(GetMouseOverLocation.create))(function(maybeLocation) {
        ...
        ;
        throw new Error("Failed pattern match at Component.Puzzle (line 62, column 21 - line 79, column 61): " + [v.constructor.name]);
      },
      handleQuery: function(v) {
  ...
  var selectElement = function(query4) {
    return bind10(liftEffect4(bindFlipped6(composeKleisliFlipped2(function() {
  ...
  var awaitLoad = /* @__PURE__ */ makeAff(function(callback) {
    return function __do2() {
      ...
      if (rs instanceof Loading) {
        var et = map23(toEventTarget2)(windowImpl)();
  ...
  var unsubscribe3 = function(sid) {
    return function(ref4) {
      return function __do2() {
        ...
        return traverse_6(unsubscribe)(bindFlipped7(lookup9(sid))(subs))();
      };
    };
  };
  var queueOrRun = function(ref4) {
    return function(au) {
      return bind15(liftEffect5(read(ref4)))(function(v) {
        if (v instanceof Nothing) {
          return au;
        }
        ;
    ...
    return function(initRef) {
      return function(v) {
        var evalChildQuery = function(ref4) {
          return function(cqb) {
            return bind15(liftEffect5(read(ref4)))(function(v1) {
              return unChildQueryBox(function(v2) {
                var evalChild = function(v3) {
                  return parallel2(bind15(liftEffect5(read(v3)))(function(dsx) {
        ...
        var go2 = function(ref4) {
          return function(v1) {
            if (v1 instanceof State) {
              return bind15(liftEffect5(read(ref4)))(function(v2) {
            ...
            if (v1 instanceof Subscribe) {
              return bind15(fresh(SubscriptionId)(ref4))(function(sid) {
                return bind15(liftEffect5(subscribe(v1.value0(sid))(function(act) {
                  return handleAff(evalF(render)(ref4)(new Action(act)));
                })))(function(finalize) {
                  return bind15(liftEffect5(read(ref4)))(function(v2) {
                    return discard1(liftEffect5(modify_(map25(insert7(sid)(finalize)))(v2.subscriptions)))(function() {
            ...
            if (v1 instanceof Fork) {
              return bind15(fresh(ForkId)(ref4))(function(fid) {
                return bind15(liftEffect5(read(ref4)))(function(v2) {
                  return bind15(liftEffect5($$new(false)))(function(doneRef) {
                    return bind15(fork3($$finally(liftEffect5(function __do2() {
      ...
      return function(i2) {
              ...
              return function(childrenOutRef) {
                return unComponentSlot(function(slot4) {
                  return function __do2() {
                    ...
                    var isDuplicate = map26(function($68) {
        ...
        return bind16(liftEffect6(newLifecycleHandlers))(function(lchs) {
          return bind16(liftEffect6($$new(false)))(function(disposed) {
            return handleLifecycle(lchs)(function __do2() {
              var sio = create();
              var dsx = bindFlipped8(read)(runComponent2(lchs)(function() {
  ...
  var runUI2 = function(component6) {
    return function(i2) {
      return function(element3) {
        return bind17(liftEffect7(map28(toDocument)(bindFlipped9(document)(windowImpl))))(function(document2) {
  ...
  var append6 = /* @__PURE__ */ append(semigroupSeconds);
  var timeToRead = function(str) {
    return append6(2)(toNumber(length3(str)) * 0.065);
  };
    ...
    return function(component6) {
      return discard11(awaitLoad)(function() {
        return bind18(bind18(selectElement("#abed"))(function() {
          var $40 = maybe($$throw("Could not find element #abed"))(pure18);
          return function($41) {
            return liftEffect8($40($41));
          };
        }()))(function(v) {
  ...
  var problem2 = function(dictHeytingAlgebra) {
  ...
  var testPuzzleComponent = /* @__PURE__ */ runHalogenAff(/* @__PURE__ */ bind18(/* @__PURE__ */ runComponent({
    problemDescription: /* @__PURE__ */ problem2(heytingAlgebraSignal),
    conversation: conversation2
  })(/* @__PURE__ */ component5(monadAffAff)))(function(v) {
    return discard11(liftEffect8(function __do2() {
      var htmlDocument = bind19(windowImpl)(document)();
      var target6 = toEventTarget(htmlDocument);
      var listener = eventListener(function(event) {
        return for_6(fromEvent(event))(function(ke) {
          return runAff_(function(v1) {
            return pure18(unit);
          })(v.query(new GlobalKeyDown2(ke, unit)));
        });
      })();
      return addEventListener2(keydown)(listener)(true)(target6)();
    }))(function() {
      return pure19(unit);
    });
  }));
